...
|----|-----------|----------|--------|
|Controller {#SNMPINDEX} has an Error Status|<p>-</p>|<p>**Expression**: last(/SNMP Tape Library Oracle StorageTek SL150/slControllerStatusEnum[{#SNMPINDEX}])=1</p><p>**Recovery expression**: </p>|high|
|Controller {#SNMPINDEX} has an Info Status|<p>-</p>|<p>**Expression**: last(/SNMP Tape Library Oracle StorageTek SL150/slControllerStatusEnum[{#SNMPINDEX}])=3</p><p>**Recovery expression**: </p>|information|
|Controller {#SNMPINDEX} has an Warning Status|<p>-</p>|<p>**Expression**: last(/SNMP Tape Library Oracle StorageTek SL150/slControllerStatusEnum[{#SNMPINDEX}])=2</p><p>**Recovery expression**: </p>|warning|
|Controller {#SNMPINDEX} Fault Led is On|<p>-</p>|<p>**Expression**: last(/SNMP Tape Library Oracle StorageTek SL150/slControllerFaultLED[{#SNMPINDEX}])=1</p><p>**Recovery expression**: </p>|high|
|Drive {#SNMPINDEX} Needs Cleaning|<p>-</p>|<p>**Expression**: find(/SNMP Tape Library Oracle StorageTek SL150/slDriveState[{#SNMPINDEX}],,"like","needs cleaning")=1</p><p>**Recovery expression**: </p>|high|
|Fan {#SNMPINDEX} has an Error Status|<p>-</p>|<p>**Expression**: last(/SNMP Tape Library Oracle StorageTek SL150/slFanOperational[{#SNMPINDEX}])=1</p><p>**Recovery expression**: </p>|high|
|The cartridge {#SNMPINDEX} has been used to clean is over than 40 times|<p>-</p>|<p>**Expression**: last(/SNMP Tape Library Oracle StorageTek SL150/slLibCleanCartUsageCount[{#SNMPINDEX}])>=40</p><p>**Recovery expression**: </p>|high|
|Robot {#SNMPINDEX} Fault Led is On|<p>-</p>|<p>**Expression**: last(/SNMP Tape Library Oracle StorageTek SL150/slRobotFaultLED[{#SNMPINDEX}])=1</p><p>**Recovery expression**: </p>|high|
|Error Operational Status by Robot {#SNMPINDEX}|<p>-</p>|<p>**Expression**: last(/SNMP Tape Library Oracle StorageTek SL150/slRobotStatusEnum[{#SNMPINDEX}])=1</p><p>**Recovery expression**: </p>|high|
|Warning Operational Status by Robot {#SNMPINDEX}|<p>-</p>|<p>**Expression**: last(/SNMP Tape Library Oracle StorageTek SL150/slRobotStatusEnum[{#SNMPINDEX}])=2</p><p>**Recovery expression**: </p>|average|
|Tape Library is Going to Shutdown Soon|<p>-</p>|<p>**Expression**: last(/SNMP Tape Library Oracle StorageTek SL150/slTempSensorCurrentTemp[{#SNMPINDEX}])>=67</p><p>**Recovery expression**: </p>|disaster|
|The Current Temperature of Drive [{#SNMPINDEX}] is Very High|<p>-</p>|<p>**Expression**: last(/SNMP Tape Library Oracle StorageTek SL150/slTempSensorCurrentTemp[{#SNMPINDEX}])>=63</p><p>**Recovery expression**: </p>|high|
|Controller {#SNMPINDEX} Fault Led is On (LLD)|<p>-</p>|<p>**Expression**: last(/SNMP Tape Library Oracle StorageTek SL150/slControllerFaultLED[{#SNMPINDEX}])=1</p><p>**Recovery expression**: </p>|high|
|Controller {#SNMPINDEX} has an Error Status (LLD)|<p>-</p>|<p>**Expression**: last(/SNMP Tape Library Oracle StorageTek SL150/slControllerStatusEnum[{#SNMPINDEX}])=1</p><p>**Recovery expression**: </p>|high|
|Controller {#SNMPINDEX} has an Info Status (LLD)|<p>-</p>|<p>**Expression**: last(/SNMP Tape Library Oracle StorageTek SL150/slControllerStatusEnum[{#SNMPINDEX}])=3</p><p>**Recovery expression**: </p>|information|
|Controller {#SNMPINDEX} has an Warning Status (LLD)|<p>-</p>|<p>**Expression**: last(/SNMP Tape Library Oracle StorageTek SL150/slControllerStatusEnum[{#SNMPINDEX}])=2</p><p>**Recovery expression**: </p>|warning|
|Robot {#SNMPINDEX} Fault Led is On (LLD)|<p>-</p>|<p>**Expression**: last(/SNMP Tape Library Oracle StorageTek SL150/slRobotFaultLED[{#SNMPINDEX}])=1</p><p>**Recovery expression**: </p>|high|
|Error Operational Status by Robot {#SNMPINDEX} (LLD)|<p>-</p>|<p>**Expression**: last(/SNMP Tape Library Oracle StorageTek SL150/slRobotStatusEnum[{#SNMPINDEX}])=1</p><p>**Recovery expression**: </p>|high|
|Warning Operational Status by Robot {#SNMPINDEX} (LLD)|<p>-</p>|<p>**Expression**: last(/SNMP Tape Library Oracle StorageTek SL150/slRobotStatusEnum[{#SNMPINDEX}])=2</p><p>**Recovery expression**: </p>|average|
|Tape Library is Going to Shutdown Soon (LLD)|<p>-</p>|<p>**Expression**: last(/SNMP Tape Library Oracle StorageTek SL150/slTempSensorCurrentTemp[{#SNMPINDEX}])>=67</p><p>**Recovery expression**: </p>|disaster|
|The Current Temperature of Drive [{#SNMPINDEX}] is Very High (LLD)|<p>-</p>|<p>**Expression**: last(/SNMP Tape Library Oracle StorageTek SL150/slTempSensorCurrentTemp[{#SNMPINDEX}])>=63</p><p>**Recovery expression**: </p>|high|
|The cartridge {#SNMPINDEX} has been used to clean is over than 40 times (LLD)|<p>-</p>|<p>**Expression**: last(/SNMP Tape Library Oracle StorageTek SL150/slLibCleanCartUsageCount[{#SNMPINDEX}])>=40</p><p>**Recovery expression**: </p>|high|
|Drive {#SNMPINDEX} Needs Cleaning (LLD)|<p>-</p>|<p>**Expression**: find(/SNMP Tape Library Oracle StorageTek SL150/slDriveState[{#SNMPINDEX}],,"like","needs cleaning")=1</p><p>**Recovery expression**: </p>|high|
|Fan {#SNMPINDEX} has an Error Status (LLD)|<p>-</p>|<p>**Expression**: last(/SNMP Tape Library Oracle StorageTek SL150/slFanOperational[{#SNMPINDEX}])=1</p><p>**Recovery expression**: </p>|high|
