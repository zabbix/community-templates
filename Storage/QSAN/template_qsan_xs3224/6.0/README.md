...
|----|-----------|----------|--------|
|SAN Disk {#SNMPVALUE} on {HOST.NAME} is NOT Good|<p>-</p>|<p>**Expression**: find(/SNMP QSAN XS3224 Storage/sanDiskState[{#SNMPINDEX}],,"iregexp","^Good$")=0</p><p>**Recovery expression**: </p>|high|
|SAN Disk {#SNMPVALUE} on {HOST.NAME} is NOT Online|<p>-</p>|<p>**Expression**: find(/SNMP QSAN XS3224 Storage/sanDiskStatus[{#SNMPINDEX}],,"iregexp","^Online$")=0</p><p>**Recovery expression**: </p>|high|
|SAN Pool {#SNMPVALUE} on {HOST.NAME} is NOT Good|<p>-</p>|<p>**Expression**: find(/SNMP QSAN XS3224 Storage/sanPoolState[{#SNMPVALUE}],,"iregexp","^Good$")=0</p><p>**Recovery expression**: </p>|high|
|SAN Pool {#SNMPVALUE} on {HOST.NAME} is NOT Online|<p>-</p>|<p>**Expression**: find(/SNMP QSAN XS3224 Storage/sanPoolStatus[{#SNMPVALUE}],,"iregexp","^Online$")=0</p><p>**Recovery expression**: </p>|high|
|SAN Volume {#SNMPVALUE} on {HOST.NAME} is NOT Online|<p>-</p>|<p>**Expression**: find(/SNMP QSAN XS3224 Storage/sanVolumeStatus[{#SNMPVALUE}],,"iregexp","^Online$")=0</p><p>**Recovery expression**: </p>|high|
|SAN Volume {#SNMPVALUE} on {HOST.NAME} is NOT Optimal|<p>-</p>|<p>**Expression**: find(/SNMP QSAN XS3224 Storage/sanVolumeState[{#SNMPVALUE}],,"iregexp","^Optimal$")=0</p><p>**Recovery expression**: </p>|high|
|SAN Volume {#SNMPVALUE} on {HOST.NAME} is NOT Online (LLD)|<p>-</p>|<p>**Expression**: find(/SNMP QSAN XS3224 Storage/sanVolumeStatus[{#SNMPVALUE}],,"iregexp","^Online$")=0</p><p>**Recovery expression**: </p>|high|
|SAN Volume {#SNMPVALUE} on {HOST.NAME} is NOT Optimal (LLD)|<p>-</p>|<p>**Expression**: find(/SNMP QSAN XS3224 Storage/sanVolumeState[{#SNMPVALUE}],,"iregexp","^Optimal$")=0</p><p>**Recovery expression**: </p>|high|
|SAN Pool {#SNMPVALUE} on {HOST.NAME} is NOT Good (LLD)|<p>-</p>|<p>**Expression**: find(/SNMP QSAN XS3224 Storage/sanPoolState[{#SNMPVALUE}],,"iregexp","^Good$")=0</p><p>**Recovery expression**: </p>|high|
|SAN Pool {#SNMPVALUE} on {HOST.NAME} is NOT Online (LLD)|<p>-</p>|<p>**Expression**: find(/SNMP QSAN XS3224 Storage/sanPoolStatus[{#SNMPVALUE}],,"iregexp","^Online$")=0</p><p>**Recovery expression**: </p>|high|
|SAN Disk {#SNMPVALUE} on {HOST.NAME} is NOT Good (LLD)|<p>-</p>|<p>**Expression**: find(/SNMP QSAN XS3224 Storage/sanDiskState[{#SNMPINDEX}],,"iregexp","^Good$")=0</p><p>**Recovery expression**: </p>|high|
|SAN Disk {#SNMPVALUE} on {HOST.NAME} is NOT Online (LLD)|<p>-</p>|<p>**Expression**: find(/SNMP QSAN XS3224 Storage/sanDiskStatus[{#SNMPINDEX}],,"iregexp","^Online$")=0</p><p>**Recovery expression**: </p>|high|
