...
|----|-----------|----------|--------|
|{#SNMPVALUE} status require attention: {ITEM.LASTVALUE}|<p>-</p>|<p>**Expression**: find(/Storage Lenovo ix4-300d/diskStatus[{#SNMPVALUE}],,"like","NORMAL")=0</p><p>**Recovery expression**: </p>|high|
|Free disk space is less than 2% on volume {#SNMPVALUE}|<p>Used: {ITEM.LASTVALUE} Total: {ITEM.LASTVALUE2}</p>|<p>**Expression**: last(/Storage Lenovo ix4-300d/hrStorageUsedInBytes[{#SNMPVALUE}])/last(/Storage Lenovo ix4-300d/hrStorageSizeInBytes[{#SNMPVALUE}]) > 0.98</p><p>**Recovery expression**: </p>|high|
|Free disk space is less than 10% on volume {#SNMPVALUE}|<p>Used: {ITEM.LASTVALUE} Total: {ITEM.LASTVALUE2}</p>|<p>**Expression**: last(/Storage Lenovo ix4-300d/hrStorageUsedInBytes[{#SNMPVALUE}])/last(/Storage Lenovo ix4-300d/hrStorageSizeInBytes[{#SNMPVALUE}]) > 0.9</p><p>**Recovery expression**: </p>|warning|
|Operational status was changed on {HOST.NAME} interface {#SNMPVALUE}|<p>-</p>|<p>**Expression**: (last(/Storage Lenovo ix4-300d/ifOperStatus[{#SNMPVALUE}],#1)<>last(/Storage Lenovo ix4-300d/ifOperStatus[{#SNMPVALUE}],#2))=1</p><p>**Recovery expression**: </p>|information|
|Temperature of {#SNMPVALUE} is to high: {ITEM.LASTVALUE}|<p>-</p>|<p>**Expression**: last(/Storage Lenovo ix4-300d/tempValue[{#SNMPVALUE}])>65</p><p>**Recovery expression**: </p>|average|
|Temperature of {#SNMPVALUE} is to very high: {ITEM.LASTVALUE}|<p>-</p>|<p>**Expression**: last(/Storage Lenovo ix4-300d/tempValue[{#SNMPVALUE}])>70</p><p>**Recovery expression**: </p>|high|
|Temperature of {#SNMPVALUE} is to high: {ITEM.LASTVALUE} (LLD)|<p>-</p>|<p>**Expression**: last(/Storage Lenovo ix4-300d/tempValue[{#SNMPVALUE}])>65</p><p>**Recovery expression**: </p>|average|
|Temperature of {#SNMPVALUE} is to very high: {ITEM.LASTVALUE} (LLD)|<p>-</p>|<p>**Expression**: last(/Storage Lenovo ix4-300d/tempValue[{#SNMPVALUE}])>70</p><p>**Recovery expression**: </p>|high|
|Free disk space is less than 2% on volume {#SNMPVALUE} (LLD)|<p>Used: {ITEM.LASTVALUE} Total: {ITEM.LASTVALUE2}</p>|<p>**Expression**: last(/Storage Lenovo ix4-300d/hrStorageUsedInBytes[{#SNMPVALUE}])/last(/Storage Lenovo ix4-300d/hrStorageSizeInBytes[{#SNMPVALUE}]) > 0.98</p><p>**Recovery expression**: </p>|high|
|Free disk space is less than 10% on volume {#SNMPVALUE} (LLD)|<p>Used: {ITEM.LASTVALUE} Total: {ITEM.LASTVALUE2}</p>|<p>**Expression**: last(/Storage Lenovo ix4-300d/hrStorageUsedInBytes[{#SNMPVALUE}])/last(/Storage Lenovo ix4-300d/hrStorageSizeInBytes[{#SNMPVALUE}]) > 0.9</p><p>**Recovery expression**: </p>|warning|
|{#SNMPVALUE} status require attention: {ITEM.LASTVALUE} (LLD)|<p>-</p>|<p>**Expression**: find(/Storage Lenovo ix4-300d/diskStatus[{#SNMPVALUE}],,"like","NORMAL")=0</p><p>**Recovery expression**: </p>|high|
|Operational status was changed on {HOST.NAME} interface {#SNMPVALUE} (LLD)|<p>-</p>|<p>**Expression**: (last(/Storage Lenovo ix4-300d/ifOperStatus[{#SNMPVALUE}],#1)<>last(/Storage Lenovo ix4-300d/ifOperStatus[{#SNMPVALUE}],#2))=1</p><p>**Recovery expression**: </p>|information|
