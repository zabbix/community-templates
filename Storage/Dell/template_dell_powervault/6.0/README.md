...
|----|-----------|----------|--------|
|Erro de gravação Hard em TL2000|<p>-</p>|<p>**Expression**: last(/DELL POWERVAULT TL2000/driveHardWrtErrors[{#SNMPVALUE}])>0</p><p>**Recovery expression**: </p>|average|
|Erro de gravação Soft (leve) no TL2000|<p>-</p>|<p>**Expression**: last(/DELL POWERVAULT TL2000/driveSoftWrtErrors[{#SNMPVALUE}])>0</p><p>**Recovery expression**: </p>|warning|
|Erro de leitura Hard no TL2000|<p>-</p>|<p>**Expression**: last(/DELL POWERVAULT TL2000/driveHardReadErrors[{#SNMPVALUE}])>0</p><p>**Recovery expression**: </p>|average|
|Erro de leitura Soft (leve)  no TL2000|<p>-</p>|<p>**Expression**: last(/DELL POWERVAULT TL2000/driveSoftReadErrors[{#SNMPVALUE}])>0</p><p>**Recovery expression**: </p>|warning|
|Erro em Dispositivo de Fita (TL2000)|<p>-</p>|<p>**Expression**: last(/DELL POWERVAULT TL2000/libraryFaultSev[{#SNMPVALUE}])>0</p><p>**Recovery expression**: </p>|warning|
|Erro em Dispositivo de Fita (TL2000) (LLD)|<p>-</p>|<p>**Expression**: last(/DELL POWERVAULT TL2000/libraryFaultSev[{#SNMPVALUE}])>0</p><p>**Recovery expression**: </p>|warning|
|Erro de gravação Hard em TL2000 (LLD)|<p>-</p>|<p>**Expression**: last(/DELL POWERVAULT TL2000/driveHardWrtErrors[{#SNMPVALUE}])>0</p><p>**Recovery expression**: </p>|average|
|Erro de gravação Soft (leve) no TL2000 (LLD)|<p>-</p>|<p>**Expression**: last(/DELL POWERVAULT TL2000/driveSoftWrtErrors[{#SNMPVALUE}])>0</p><p>**Recovery expression**: </p>|warning|
|Erro de leitura Hard no TL2000 (LLD)|<p>-</p>|<p>**Expression**: last(/DELL POWERVAULT TL2000/driveHardReadErrors[{#SNMPVALUE}])>0</p><p>**Recovery expression**: </p>|average|
|Erro de leitura Soft (leve)  no TL2000 (LLD)|<p>-</p>|<p>**Expression**: last(/DELL POWERVAULT TL2000/driveSoftReadErrors[{#SNMPVALUE}])>0</p><p>**Recovery expression**: </p>|warning|
