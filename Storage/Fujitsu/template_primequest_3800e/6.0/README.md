...
|----|-----------|----------|--------|
|{#SNMPVALUE} Error|<p>-</p>|<p>**Expression**: last(/Fujitsu Primequest 3800E/cpus.4.[{#SNMPINDEX}])=6</p><p>**Recovery expression**: </p>|high|
|{#SNMPVALUE} Warning|<p>-</p>|<p>**Expression**: last(/Fujitsu Primequest 3800E/cpus.4.[{#SNMPINDEX}])=4 or last(/Fujitsu Primequest 3800E/cpus.4.[{#SNMPINDEX}])=8</p><p>**Recovery expression**: </p>|average|
|{#SNMPVALUE} Error|<p>-</p>|<p>**Expression**: last(/Fujitsu Primequest 3800E/fans.5.[{#SNMPINDEX}])=5 or last(/Fujitsu Primequest 3800E/fans.5.[{#SNMPINDEX}])=4</p><p>**Recovery expression**: </p>|high|
|{#SNMPVALUE} Error|<p>-</p>|<p>**Expression**: last(/Fujitsu Primequest 3800E/memoryModules.4.[{#SNMPINDEX}])=5 or last(/Fujitsu Primequest 3800E/memoryModules.4.[{#SNMPINDEX}])=9</p><p>**Recovery expression**: </p>|high|
|{#SNMPVALUE} Warning|<p>-</p>|<p>**Expression**: last(/Fujitsu Primequest 3800E/memoryModules.4.[{#SNMPINDEX}])=4 or last(/Fujitsu Primequest 3800E/memoryModules.4.[{#SNMPINDEX}])=7</p><p>**Recovery expression**: </p>|average|
|{#SNMPVALUE} Status Error|<p>-</p>|<p>**Expression**: last(/Fujitsu Primequest 3800E/powerSupply.5.[{#SNMPINDEX}])=4 or last(/Fujitsu Primequest 3800E/powerSupply.5.[{#SNMPINDEX}])=8</p><p>**Recovery expression**: </p>|high|
|{#SNMPVALUE} Status Warning|<p>-</p>|<p>**Expression**: last(/Fujitsu Primequest 3800E/powerSupply.5.[{#SNMPINDEX}])=5 or last(/Fujitsu Primequest 3800E/powerSupply.5.[{#SNMPINDEX}])=9</p><p>**Recovery expression**: </p>|average|
|{#SNMPVALUE} Critical Temperature Level|<p>-</p>|<p>**Expression**: last(/Fujitsu Primequest 3800E/temperatureSensors.6.[{#SNMPINDEX}])=last(/Fujitsu Primequest 3800E/temperatureSensors.8.[{#SNMPINDEX}])</p><p>**Recovery expression**: </p>|high|
|{#SNMPVALUE} Status Error|<p>-</p>|<p>**Expression**: last(/Fujitsu Primequest 3800E/temperatureSensors.5.[{#SNMPINDEX}])=7 or last(/Fujitsu Primequest 3800E/temperatureSensors.5.[{#SNMPINDEX}])=5</p><p>**Recovery expression**: </p>|high|
|{#SNMPVALUE} Status Warning|<p>-</p>|<p>**Expression**: last(/Fujitsu Primequest 3800E/temperatureSensors.5.[{#SNMPINDEX}])=6</p><p>**Recovery expression**: </p>|average|
|{#SNMPVALUE} Warning Temperature Level|<p>-</p>|<p>**Expression**: last(/Fujitsu Primequest 3800E/temperatureSensors.6.[{#SNMPINDEX}])=last(/Fujitsu Primequest 3800E/temperatureSensors.7.[{#SNMPINDEX}])</p><p>**Recovery expression**: </p>|average|
|{#SNMPVALUE} Error|<p>-</p>|<p>**Expression**: last(/Fujitsu Primequest 3800E/voltages.4.[{#SNMPINDEX}])=4 or last(/Fujitsu Primequest 3800E/voltages.4.[{#SNMPINDEX}])=5</p><p>**Recovery expression**: </p>|high|
