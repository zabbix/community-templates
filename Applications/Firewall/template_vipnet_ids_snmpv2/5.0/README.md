...
|----|-----------|----------|--------|
|{HOST.NAME} {#SNMPVALUE} detection interface state changed to down|<p>-</p>|<p>**Expression**: {ViPNet IDS SNMPv2:detection.interface.state.[{#SNMPVALUE}].change()}>0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} {#SNMPVALUE} detection interface state changed to down (LLD)|<p>-</p>|<p>**Expression**: {ViPNet IDS SNMPv2:detection.interface.state.[{#SNMPVALUE}].change()}>0</p><p>**Recovery expression**: </p>|high|
