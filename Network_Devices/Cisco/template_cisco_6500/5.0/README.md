...
|SNMP traps for "{#SNMPVALUE}" sensor|<p>-</p>|`SNMP trap`|snmptrap["ciscoEnvMonTemperatureState\.{#SNMPINDEX}[[:space:]](warning|critical|shutdown|normal)"]<p>Update: 0</p><p>LLD</p>|
|Status of Temperature Sensor "$1"|<p>CISCO-ENVMON-MIB::ciscoEnvMonTemperatureState The current state of the testpoint being instrumented.</p>|`SNMP agent`|ciscoEnvMonTemperatureState["{#SNMPVALUE}"]<p>Update: 60</p><p>LLD</p>|
|Temperature on Sensor "$1"|<p>CISCO-ENVMON-MIB::ciscoEnvMonTemperatureStatusValue The current measurement of the testpoint being instrumented.</p>|`SNMP agent`|ciscoEnvMonTemperatureStatusValue["{#SNMPVALUE}"]<p>Update: 60</p><p>LLD</p>|
|Threshold Temperature on Sensor "$1"|<p>CISCO-ENVMON-MIB::ciscoEnvMonTemperatureThreshold The highest value that the associated instance of the object ciscoEnvMonTemperatureStatusValue may obtain before an emergency shutdown of the managed device is initiated.</p>|`SNMP agent`|ciscoEnvMonTemperatureThreshold["{#SNMPVALUE}"]<p>Update: 1800</p><p>LLD</p>|
...
|CPU Usage 1min Rev ({#SNMPINDEX})|<p>CISCO-PROCESS-MIB::cpmCPUTotal1minRev The overall CPU busy percentage in the last 1 minute period. This object deprecates the object cpmCPUTotal1min and increases the value range to (0..100).</p>|`SNMP agent`|cpmCPUTotal1minRev[{#SNMPINDEX}]<p>Update: 60</p><p>LLD</p>|
|CPU Usage 5min Rev ({#SNMPINDEX})|<p>CISCO-PROCESS-MIB::cpmCPUTotal5minRev The overall CPU busy percentage in the last 5 minute period. This object deprecates the object cpmCPUTotal5min and increases the value range to (0..100).</p>|`SNMP agent`|cpmCPUTotal5minRev[{#SNMPINDEX}]<p>Update: 300</p><p>LLD</p>|
...
|Status of $2 Sensor "$1"|<p>CISCO-ENTITY-SENSOR-MIB::entSensorStatus This variable indicates the present operational status of the sensor.</p>|`SNMP agent`|entSensorStatus["{#SNMPVALUE}",Power]<p>Update: 60</p><p>LLD</p>|
|Value of $2 Sensor "$1"|<p>CISCO-ENTITY-SENSOR-MIB::entSensorValue This variable reports the most recent measurement seen by the sensor.</p>|`SNMP agent`|entSensorValue["{#SNMPVALUE}",Power]<p>Update: 60</p><p>LLD</p>|
...
|Name|Description|Expression|Priority|
|----|-----------|----------|--------|
|BGP Peer "{#SNMPINDEX}"->"{#SNMPVALUE}" State changed|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:snmptrap["(bgpEstablished|bgpBackwardTransition|cbgpFsmStateChange).*bgpPeerState .{#SNMPINDEX}[[:space:]][a-zA-Z]+[[:space:]]"].nodata(10m)}=0</p><p>**Recovery expression**: </p>|average|
|BGP Peer "{#SNMPINDEX}"->"{#SNMPVALUE}" State changed|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:snmptrap["(bgpBackwardTransition|cbgpFsmStateChange).*bgpPeerState .{#SNMPINDEX}[[:space:]][a-zA-Z]+[[:space:]]"].nodata(10m)}=0</p><p>**Recovery expression**: </p>|average|
|OSPF Interface "{#SNMPVALUE}" State has been changed|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:snmptrap["ospfIfStateChange.+ospfIfIpAddress[[:space:]]{#SNMPVALUE}[[:space:]].+ospfIfState[[:space:]][a-zA-Z]+"].nodata(10m)}=0</p><p>**Recovery expression**: </p>|average|
|OSPF Neighbor {#SNMPVALUE} has been changed|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:snmptrap["(ospfNbrStateChange).*ospfNbrIpAddr[[:space:]]{#SNMPVALUE}[[:space:]].*[[:space:]][a-zA-Z]+[[:space:]]$"].nodata(10m)}=0</p><p>**Recovery expression**: </p>|average|
|Power Sensor "{#SNMPVALUE}" is nonoperational|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:entSensorStatus["{#SNMPVALUE}",Power].last()}=3</p><p>**Recovery expression**: </p>|high|
|Power Sensor "{#SNMPVALUE}" is unavailable|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:entSensorStatus["{#SNMPVALUE}",Power].last()}=2</p><p>**Recovery expression**: </p>|average|
|Amperage Sensor "{#SNMPVALUE}" is nonoperational|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:entSensorStatus["{#SNMPVALUE}",Amperage].last()}=3</p><p>**Recovery expression**: </p>|high|
|Amperage Sensor "{#SNMPVALUE}" is unavailable|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:entSensorStatus["{#SNMPVALUE}",Amperage].last()}=2</p><p>**Recovery expression**: </p>|average|
|Module "{#SNMPVALUE}" is inoperable|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:entStateOper["{#SNMPVALUE}","Module"].last()}=2</p><p>**Recovery expression**: </p>|disaster|
|Voltage Sensor "{#SNMPVALUE}" is nonoperational|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:entSensorStatus["{#SNMPVALUE}",Voltage].last()}=3</p><p>**Recovery expression**: </p>|high|
|Voltage Sensor "{#SNMPVALUE}" is unavailable|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:entSensorStatus["{#SNMPVALUE}",Voltage].last()}=2</p><p>**Recovery expression**: </p>|average|
|Status of Fan Tray "{#SNMPVALUE}" is in partial failure|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:cefcFanTrayOperStatus["{#SNMPVALUE}","Fan Tray"].last()}=4</p><p>**Recovery expression**: </p>|warning|
|Status of Fan Tray "{#SNMPVALUE}" is powered down|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:cefcFanTrayOperStatus["{#SNMPVALUE}","Fan Tray"].last()}=3</p><p>**Recovery expression**: </p>|high|
|High CPU #{#SNMPINDEX} Usage|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:cpmCPUTotal5minRev[{#SNMPINDEX}].last()}>95</p><p>**Recovery expression**: </p>|high|
|Status of FAN "{#SNMPVALUE}" is critical|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:ciscoEnvMonFanState["{#SNMPVALUE}"].last()}=3</p><p>**Recovery expression**: </p>|average|
|Status of FAN "{#SNMPVALUE}" is non-operable|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:ciscoEnvMonFanState["{#SNMPVALUE}"].last()}=2</p><p>**Recovery expression**: </p>|warning|
|Status of FAN "{#SNMPVALUE}" is not functioning|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:ciscoEnvMonFanState["{#SNMPVALUE}"].last()}=6</p><p>**Recovery expression**: </p>|average|
|Status of FAN "{#SNMPVALUE}" is shutdown|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:ciscoEnvMonFanState["{#SNMPVALUE}"].last()}=4</p><p>**Recovery expression**: </p>|high|
|High utilization of Memory Pool "{#SNMPVALUE}"|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:ciscoMemoryPoolUsed["{#SNMPVALUE}"].last()}>{Template_Cisco_6500:ciscoMemoryPoolTotal["{#SNMPVALUE}"].last()}*0.9</p><p>**Recovery expression**: </p>|average|
|Status of Power Supply "{#SNMPVALUE}" is critical|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:ciscoEnvMonSupplyState["{#SNMPVALUE}"].last()}=3</p><p>**Recovery expression**: </p>|average|
|Status of Power Supply "{#SNMPVALUE}" is non-operable|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:ciscoEnvMonSupplyState["{#SNMPVALUE}"].last()}=2</p><p>**Recovery expression**: </p>|warning|
|Status of Power Supply "{#SNMPVALUE}" is not functioning|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:ciscoEnvMonSupplyState["{#SNMPVALUE}"].last()}=6</p><p>**Recovery expression**: </p>|average|
|Status of Power Supply "{#SNMPVALUE}" is shutdown|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:ciscoEnvMonSupplyState["{#SNMPVALUE}"].last()}=4</p><p>**Recovery expression**: </p>|high|
|Temperature Sensor "{#SNMPVALUE}" is abnormal|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:ciscoEnvMonTemperatureState["{#SNMPVALUE}"].last()}=2</p><p>**Recovery expression**: </p>|warning|
|Temperature Sensor "{#SNMPVALUE}" is abnormal|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:ciscoEnvMonTemperatureState["{#SNMPVALUE}"].last()}=3</p><p>**Recovery expression**: </p>|high|
|Temperature Sensor "{#SNMPVALUE}" is not functioning|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:ciscoEnvMonTemperatureState["{#SNMPVALUE}"].last()}=6</p><p>**Recovery expression**: </p>|information|
|Temperature Sensor "{#SNMPVALUE}" is shutdown|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:ciscoEnvMonTemperatureState["{#SNMPVALUE}"].last()}=4</p><p>**Recovery expression**: </p>|disaster|
|BGP Peer "{#SNMPINDEX}"->"{#SNMPVALUE}" State changed (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:snmptrap["(bgpEstablished|bgpBackwardTransition|cbgpFsmStateChange).*bgpPeerState .{#SNMPINDEX}[[:space:]][a-zA-Z]+[[:space:]]"].nodata(10m)}=0</p><p>**Recovery expression**: </p>|average|
|BGP Peer "{#SNMPINDEX}"->"{#SNMPVALUE}" State changed (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:snmptrap["(bgpBackwardTransition|cbgpFsmStateChange).*bgpPeerState .{#SNMPINDEX}[[:space:]][a-zA-Z]+[[:space:]]"].nodata(10m)}=0</p><p>**Recovery expression**: </p>|average|
|Status of FAN "{#SNMPVALUE}" is critical (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:ciscoEnvMonFanState["{#SNMPVALUE}"].last()}=3</p><p>**Recovery expression**: </p>|average|
|Status of FAN "{#SNMPVALUE}" is non-operable (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:ciscoEnvMonFanState["{#SNMPVALUE}"].last()}=2</p><p>**Recovery expression**: </p>|warning|
|Status of FAN "{#SNMPVALUE}" is not functioning (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:ciscoEnvMonFanState["{#SNMPVALUE}"].last()}=6</p><p>**Recovery expression**: </p>|average|
|Status of FAN "{#SNMPVALUE}" is shutdown (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:ciscoEnvMonFanState["{#SNMPVALUE}"].last()}=4</p><p>**Recovery expression**: </p>|high|
|Status of Power Supply "{#SNMPVALUE}" is critical (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:ciscoEnvMonSupplyState["{#SNMPVALUE}"].last()}=3</p><p>**Recovery expression**: </p>|average|
|Status of Power Supply "{#SNMPVALUE}" is non-operable (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:ciscoEnvMonSupplyState["{#SNMPVALUE}"].last()}=2</p><p>**Recovery expression**: </p>|warning|
|Status of Power Supply "{#SNMPVALUE}" is not functioning (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:ciscoEnvMonSupplyState["{#SNMPVALUE}"].last()}=6</p><p>**Recovery expression**: </p>|average|
|Status of Power Supply "{#SNMPVALUE}" is shutdown (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:ciscoEnvMonSupplyState["{#SNMPVALUE}"].last()}=4</p><p>**Recovery expression**: </p>|high|
|Temperature Sensor "{#SNMPVALUE}" is abnormal (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:ciscoEnvMonTemperatureState["{#SNMPVALUE}"].last()}=2</p><p>**Recovery expression**: </p>|warning|
|Temperature Sensor "{#SNMPVALUE}" is abnormal (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:ciscoEnvMonTemperatureState["{#SNMPVALUE}"].last()}=3</p><p>**Recovery expression**: </p>|high|
|Temperature Sensor "{#SNMPVALUE}" is not functioning (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:ciscoEnvMonTemperatureState["{#SNMPVALUE}"].last()}=6</p><p>**Recovery expression**: </p>|information|
|Temperature Sensor "{#SNMPVALUE}" is shutdown (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:ciscoEnvMonTemperatureState["{#SNMPVALUE}"].last()}=4</p><p>**Recovery expression**: </p>|disaster|
|High utilization of Memory Pool "{#SNMPVALUE}" (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:ciscoMemoryPoolUsed["{#SNMPVALUE}"].last()}>{Template_Cisco_6500:ciscoMemoryPoolTotal["{#SNMPVALUE}"].last()}*0.9</p><p>**Recovery expression**: </p>|average|
|High CPU #{#SNMPINDEX} Usage (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:cpmCPUTotal5minRev[{#SNMPINDEX}].last()}>95</p><p>**Recovery expression**: </p>|high|
|Amperage Sensor "{#SNMPVALUE}" is nonoperational (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:entSensorStatus["{#SNMPVALUE}",Amperage].last()}=3</p><p>**Recovery expression**: </p>|high|
|Amperage Sensor "{#SNMPVALUE}" is unavailable (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:entSensorStatus["{#SNMPVALUE}",Amperage].last()}=2</p><p>**Recovery expression**: </p>|average|
|Status of Fan Tray "{#SNMPVALUE}" is in partial failure (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:cefcFanTrayOperStatus["{#SNMPVALUE}","Fan Tray"].last()}=4</p><p>**Recovery expression**: </p>|warning|
|Status of Fan Tray "{#SNMPVALUE}" is powered down (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:cefcFanTrayOperStatus["{#SNMPVALUE}","Fan Tray"].last()}=3</p><p>**Recovery expression**: </p>|high|
|Module "{#SNMPVALUE}" is inoperable (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:entStateOper["{#SNMPVALUE}","Module"].last()}=2</p><p>**Recovery expression**: </p>|disaster|
|Power Sensor "{#SNMPVALUE}" is nonoperational (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:entSensorStatus["{#SNMPVALUE}",Power].last()}=3</p><p>**Recovery expression**: </p>|high|
|Power Sensor "{#SNMPVALUE}" is unavailable (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:entSensorStatus["{#SNMPVALUE}",Power].last()}=2</p><p>**Recovery expression**: </p>|average|
|Voltage Sensor "{#SNMPVALUE}" is nonoperational (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:entSensorStatus["{#SNMPVALUE}",Voltage].last()}=3</p><p>**Recovery expression**: </p>|high|
|Voltage Sensor "{#SNMPVALUE}" is unavailable (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:entSensorStatus["{#SNMPVALUE}",Voltage].last()}=2</p><p>**Recovery expression**: </p>|average|
|OSPF Interface "{#SNMPVALUE}" State has been changed (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:snmptrap["ospfIfStateChange.+ospfIfIpAddress[[:space:]]{#SNMPVALUE}[[:space:]].+ospfIfState[[:space:]][a-zA-Z]+"].nodata(10m)}=0</p><p>**Recovery expression**: </p>|average|
|OSPF Neighbor {#SNMPVALUE} has been changed (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_6500:snmptrap["(ospfNbrStateChange).*ospfNbrIpAddr[[:space:]]{#SNMPVALUE}[[:space:]].*[[:space:]][a-zA-Z]+[[:space:]]$"].nodata(10m)}=0</p><p>**Recovery expression**: </p>|average|
