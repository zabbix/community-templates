...
|Name|Description|Expression|Priority|
|----|-----------|----------|--------|
|BGP Peer "{#SNMPINDEX}"->"{#SNMPVALUE}" State changed|<p>-</p>|<p>**Expression**: nodata(/Cisco_6500/snmptrap["(bgpEstablished|bgpBackwardTransition|cbgpFsmStateChange).*bgpPeerState .{#SNMPINDEX}[[:space:]][a-zA-Z]+[[:space:]]"],10m)=0</p><p>**Recovery expression**: </p>|average|
|BGP Peer "{#SNMPINDEX}"->"{#SNMPVALUE}" State changed|<p>-</p>|<p>**Expression**: nodata(/Cisco_6500/snmptrap["(bgpBackwardTransition|cbgpFsmStateChange).*bgpPeerState .{#SNMPINDEX}[[:space:]][a-zA-Z]+[[:space:]]"],10m)=0</p><p>**Recovery expression**: </p>|average|
|OSPF Interface "{#SNMPVALUE}" State has been changed|<p>-</p>|<p>**Expression**: nodata(/Cisco_6500/snmptrap["ospfIfStateChange.+ospfIfIpAddress[[:space:]]{#SNMPVALUE}[[:space:]].+ospfIfState[[:space:]][a-zA-Z]+"],10m)=0</p><p>**Recovery expression**: </p>|average|
|OSPF Neighbor {#SNMPVALUE} has been changed|<p>-</p>|<p>**Expression**: nodata(/Cisco_6500/snmptrap["(ospfNbrStateChange).*ospfNbrIpAddr[[:space:]]{#SNMPVALUE}[[:space:]].*[[:space:]][a-zA-Z]+[[:space:]]$"],10m)=0</p><p>**Recovery expression**: </p>|average|
|Power Sensor "{#SNMPVALUE}" is nonoperational|<p>-</p>|<p>**Expression**: last(/Cisco_6500/entSensorStatus["{#SNMPVALUE}",Power])=3</p><p>**Recovery expression**: </p>|high|
|Power Sensor "{#SNMPVALUE}" is unavailable|<p>-</p>|<p>**Expression**: last(/Cisco_6500/entSensorStatus["{#SNMPVALUE}",Power])=2</p><p>**Recovery expression**: </p>|average|
|Amperage Sensor "{#SNMPVALUE}" is nonoperational|<p>-</p>|<p>**Expression**: last(/Cisco_6500/entSensorStatus["{#SNMPVALUE}",Amperage])=3</p><p>**Recovery expression**: </p>|high|
|Amperage Sensor "{#SNMPVALUE}" is unavailable|<p>-</p>|<p>**Expression**: last(/Cisco_6500/entSensorStatus["{#SNMPVALUE}",Amperage])=2</p><p>**Recovery expression**: </p>|average|
|Module "{#SNMPVALUE}" is inoperable|<p>-</p>|<p>**Expression**: last(/Cisco_6500/entStateOper["{#SNMPVALUE}","Module"])=2</p><p>**Recovery expression**: </p>|disaster|
|Voltage Sensor "{#SNMPVALUE}" is nonoperational|<p>-</p>|<p>**Expression**: last(/Cisco_6500/entSensorStatus["{#SNMPVALUE}",Voltage])=3</p><p>**Recovery expression**: </p>|high|
|Voltage Sensor "{#SNMPVALUE}" is unavailable|<p>-</p>|<p>**Expression**: last(/Cisco_6500/entSensorStatus["{#SNMPVALUE}",Voltage])=2</p><p>**Recovery expression**: </p>|average|
|Status of Fan Tray "{#SNMPVALUE}" is in partial failure|<p>-</p>|<p>**Expression**: last(/Cisco_6500/cefcFanTrayOperStatus["{#SNMPVALUE}","Fan Tray"])=4</p><p>**Recovery expression**: </p>|warning|
|Status of Fan Tray "{#SNMPVALUE}" is powered down|<p>-</p>|<p>**Expression**: last(/Cisco_6500/cefcFanTrayOperStatus["{#SNMPVALUE}","Fan Tray"])=3</p><p>**Recovery expression**: </p>|high|
|High CPU #{#SNMPINDEX} Usage|<p>-</p>|<p>**Expression**: last(/Cisco_6500/cpmCPUTotal5minRev[{#SNMPINDEX}])>95</p><p>**Recovery expression**: </p>|high|
|Status of FAN "{#SNMPVALUE}" is critical|<p>-</p>|<p>**Expression**: last(/Cisco_6500/ciscoEnvMonFanState["{#SNMPVALUE}"])=3</p><p>**Recovery expression**: </p>|average|
|Status of FAN "{#SNMPVALUE}" is non-operable|<p>-</p>|<p>**Expression**: last(/Cisco_6500/ciscoEnvMonFanState["{#SNMPVALUE}"])=2</p><p>**Recovery expression**: </p>|warning|
|Status of FAN "{#SNMPVALUE}" is not functioning|<p>-</p>|<p>**Expression**: last(/Cisco_6500/ciscoEnvMonFanState["{#SNMPVALUE}"])=6</p><p>**Recovery expression**: </p>|average|
|Status of FAN "{#SNMPVALUE}" is shutdown|<p>-</p>|<p>**Expression**: last(/Cisco_6500/ciscoEnvMonFanState["{#SNMPVALUE}"])=4</p><p>**Recovery expression**: </p>|high|
|High utilization of Memory Pool "{#SNMPVALUE}"|<p>-</p>|<p>**Expression**: last(/Cisco_6500/ciscoMemoryPoolUsed["{#SNMPVALUE}"])>last(/Cisco_6500/ciscoMemoryPoolTotal["{#SNMPVALUE}"])*0.9</p><p>**Recovery expression**: </p>|average|
|Status of Power Supply "{#SNMPVALUE}" is critical|<p>-</p>|<p>**Expression**: last(/Cisco_6500/ciscoEnvMonSupplyState["{#SNMPVALUE}"])=3</p><p>**Recovery expression**: </p>|average|
|Status of Power Supply "{#SNMPVALUE}" is non-operable|<p>-</p>|<p>**Expression**: last(/Cisco_6500/ciscoEnvMonSupplyState["{#SNMPVALUE}"])=2</p><p>**Recovery expression**: </p>|warning|
|Status of Power Supply "{#SNMPVALUE}" is not functioning|<p>-</p>|<p>**Expression**: last(/Cisco_6500/ciscoEnvMonSupplyState["{#SNMPVALUE}"])=6</p><p>**Recovery expression**: </p>|average|
|Status of Power Supply "{#SNMPVALUE}" is shutdown|<p>-</p>|<p>**Expression**: last(/Cisco_6500/ciscoEnvMonSupplyState["{#SNMPVALUE}"])=4</p><p>**Recovery expression**: </p>|high|
|Temperature Sensor "{#SNMPVALUE}" is abnormal|<p>-</p>|<p>**Expression**: last(/Cisco_6500/ciscoEnvMonTemperatureState["{#SNMPVALUE}"])=2</p><p>**Recovery expression**: </p>|warning|
|Temperature Sensor "{#SNMPVALUE}" is abnormal|<p>-</p>|<p>**Expression**: last(/Cisco_6500/ciscoEnvMonTemperatureState["{#SNMPVALUE}"])=3</p><p>**Recovery expression**: </p>|high|
|Temperature Sensor "{#SNMPVALUE}" is not functioning|<p>-</p>|<p>**Expression**: last(/Cisco_6500/ciscoEnvMonTemperatureState["{#SNMPVALUE}"])=6</p><p>**Recovery expression**: </p>|information|
|Temperature Sensor "{#SNMPVALUE}" is shutdown|<p>-</p>|<p>**Expression**: last(/Cisco_6500/ciscoEnvMonTemperatureState["{#SNMPVALUE}"])=4</p><p>**Recovery expression**: </p>|disaster|
|High CPU #{#SNMPINDEX} Usage (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_6500/cpmCPUTotal5minRev[{#SNMPINDEX}])>95</p><p>**Recovery expression**: </p>|high|
|Voltage Sensor "{#SNMPVALUE}" is nonoperational (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_6500/entSensorStatus["{#SNMPVALUE}",Voltage])=3</p><p>**Recovery expression**: </p>|high|
|Voltage Sensor "{#SNMPVALUE}" is unavailable (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_6500/entSensorStatus["{#SNMPVALUE}",Voltage])=2</p><p>**Recovery expression**: </p>|average|
|Status of Fan Tray "{#SNMPVALUE}" is in partial failure (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_6500/cefcFanTrayOperStatus["{#SNMPVALUE}","Fan Tray"])=4</p><p>**Recovery expression**: </p>|warning|
|Status of Fan Tray "{#SNMPVALUE}" is powered down (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_6500/cefcFanTrayOperStatus["{#SNMPVALUE}","Fan Tray"])=3</p><p>**Recovery expression**: </p>|high|
|Temperature Sensor "{#SNMPVALUE}" is abnormal (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_6500/ciscoEnvMonTemperatureState["{#SNMPVALUE}"])=2</p><p>**Recovery expression**: </p>|warning|
|Temperature Sensor "{#SNMPVALUE}" is abnormal (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_6500/ciscoEnvMonTemperatureState["{#SNMPVALUE}"])=3</p><p>**Recovery expression**: </p>|high|
|Temperature Sensor "{#SNMPVALUE}" is not functioning (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_6500/ciscoEnvMonTemperatureState["{#SNMPVALUE}"])=6</p><p>**Recovery expression**: </p>|information|
|Temperature Sensor "{#SNMPVALUE}" is shutdown (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_6500/ciscoEnvMonTemperatureState["{#SNMPVALUE}"])=4</p><p>**Recovery expression**: </p>|disaster|
|OSPF Neighbor {#SNMPVALUE} has been changed (LLD)|<p>-</p>|<p>**Expression**: nodata(/Cisco_6500/snmptrap["(ospfNbrStateChange).*ospfNbrIpAddr[[:space:]]{#SNMPVALUE}[[:space:]].*[[:space:]][a-zA-Z]+[[:space:]]$"],10m)=0</p><p>**Recovery expression**: </p>|average|
|Power Sensor "{#SNMPVALUE}" is nonoperational (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_6500/entSensorStatus["{#SNMPVALUE}",Power])=3</p><p>**Recovery expression**: </p>|high|
|Power Sensor "{#SNMPVALUE}" is unavailable (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_6500/entSensorStatus["{#SNMPVALUE}",Power])=2</p><p>**Recovery expression**: </p>|average|
|OSPF Interface "{#SNMPVALUE}" State has been changed (LLD)|<p>-</p>|<p>**Expression**: nodata(/Cisco_6500/snmptrap["ospfIfStateChange.+ospfIfIpAddress[[:space:]]{#SNMPVALUE}[[:space:]].+ospfIfState[[:space:]][a-zA-Z]+"],10m)=0</p><p>**Recovery expression**: </p>|average|
|BGP Peer "{#SNMPINDEX}"->"{#SNMPVALUE}" State changed (LLD)|<p>-</p>|<p>**Expression**: nodata(/Cisco_6500/snmptrap["(bgpEstablished|bgpBackwardTransition|cbgpFsmStateChange).*bgpPeerState .{#SNMPINDEX}[[:space:]][a-zA-Z]+[[:space:]]"],10m)=0</p><p>**Recovery expression**: </p>|average|
|BGP Peer "{#SNMPINDEX}"->"{#SNMPVALUE}" State changed (LLD)|<p>-</p>|<p>**Expression**: nodata(/Cisco_6500/snmptrap["(bgpBackwardTransition|cbgpFsmStateChange).*bgpPeerState .{#SNMPINDEX}[[:space:]][a-zA-Z]+[[:space:]]"],10m)=0</p><p>**Recovery expression**: </p>|average|
|High utilization of Memory Pool "{#SNMPVALUE}" (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_6500/ciscoMemoryPoolUsed["{#SNMPVALUE}"])>last(/Cisco_6500/ciscoMemoryPoolTotal["{#SNMPVALUE}"])*0.9</p><p>**Recovery expression**: </p>|average|
|Status of FAN "{#SNMPVALUE}" is critical (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_6500/ciscoEnvMonFanState["{#SNMPVALUE}"])=3</p><p>**Recovery expression**: </p>|average|
|Status of FAN "{#SNMPVALUE}" is non-operable (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_6500/ciscoEnvMonFanState["{#SNMPVALUE}"])=2</p><p>**Recovery expression**: </p>|warning|
|Status of FAN "{#SNMPVALUE}" is not functioning (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_6500/ciscoEnvMonFanState["{#SNMPVALUE}"])=6</p><p>**Recovery expression**: </p>|average|
|Status of FAN "{#SNMPVALUE}" is shutdown (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_6500/ciscoEnvMonFanState["{#SNMPVALUE}"])=4</p><p>**Recovery expression**: </p>|high|
|Module "{#SNMPVALUE}" is inoperable (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_6500/entStateOper["{#SNMPVALUE}","Module"])=2</p><p>**Recovery expression**: </p>|disaster|
|Status of Power Supply "{#SNMPVALUE}" is critical (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_6500/ciscoEnvMonSupplyState["{#SNMPVALUE}"])=3</p><p>**Recovery expression**: </p>|average|
|Status of Power Supply "{#SNMPVALUE}" is non-operable (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_6500/ciscoEnvMonSupplyState["{#SNMPVALUE}"])=2</p><p>**Recovery expression**: </p>|warning|
|Status of Power Supply "{#SNMPVALUE}" is not functioning (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_6500/ciscoEnvMonSupplyState["{#SNMPVALUE}"])=6</p><p>**Recovery expression**: </p>|average|
|Status of Power Supply "{#SNMPVALUE}" is shutdown (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_6500/ciscoEnvMonSupplyState["{#SNMPVALUE}"])=4</p><p>**Recovery expression**: </p>|high|
|Amperage Sensor "{#SNMPVALUE}" is nonoperational (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_6500/entSensorStatus["{#SNMPVALUE}",Amperage])=3</p><p>**Recovery expression**: </p>|high|
|Amperage Sensor "{#SNMPVALUE}" is unavailable (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_6500/entSensorStatus["{#SNMPVALUE}",Amperage])=2</p><p>**Recovery expression**: </p>|average|
