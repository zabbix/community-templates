...
|Name|Description|Expression|Priority|
|----|-----------|----------|--------|
|BGP Peer "{#SNMPINDEX}"->"{#SNMPVALUE}" State changed|<p>-</p>|<p>**Expression**: nodata(/Cisco_ASR_9K/snmptrap["(bgpEstablished|bgpBackwardTransition|cbgpFsmStateChange).*bgpPeerState .{#SNMPINDEX}[[:space:]][a-zA-Z]+[[:space:]]"],10m)=0</p><p>**Recovery expression**: </p>|average|
|BGP Peer "{#SNMPINDEX}"->"{#SNMPVALUE}" State changed|<p>-</p>|<p>**Expression**: nodata(/Cisco_ASR_9K/snmptrap["(bgpBackwardTransition|cbgpFsmStateChange).*bgpPeerState .{#SNMPINDEX}[[:space:]][a-zA-Z]+[[:space:]]"],10m)=0</p><p>**Recovery expression**: </p>|average|
|OSPF Interface "{#SNMPVALUE}" State has been changed|<p>-</p>|<p>**Expression**: nodata(/Cisco_ASR_9K/snmptrap["ospfIfStateChange.+ospfIfIpAddress[[:space:]]{#SNMPVALUE}[[:space:]].+ospfIfState[[:space:]][a-zA-Z]+"],10m)=0</p><p>**Recovery expression**: </p>|average|
|OSPF Neighbor {#SNMPVALUE} has been changed|<p>-</p>|<p>**Expression**: nodata(/Cisco_ASR_9K/snmptrap["(ospfNbrStateChange).*ospfNbrIpAddr[[:space:]]{#SNMPVALUE}[[:space:]].*[[:space:]][a-zA-Z]+[[:space:]]$"],10m)=0</p><p>**Recovery expression**: </p>|average|
|Load Sensor "{#SNMPVALUE}" is nonoperational|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/entSensorStatus["{#SNMPVALUE}",Load])=3</p><p>**Recovery expression**: </p>|high|
|Load Sensor "{#SNMPVALUE}" is unavailable|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/entSensorStatus["{#SNMPVALUE}",Load])=2</p><p>**Recovery expression**: </p>|average|
|Module "{#SNMPVALUE}" is disabled|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/entStateOper["{#SNMPVALUE}","Module"])=2</p><p>**Recovery expression**: </p>|warning|
|Temperature Sensor "{#SNMPVALUE}" is nonoperational|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/entSensorStatus["{#SNMPVALUE}",Temperature,{#SNMPINDEX}])=3</p><p>**Recovery expression**: </p>|high|
|Temperature Sensor "{#SNMPVALUE}" is unavailable|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/entSensorStatus["{#SNMPVALUE}",Temperature,{#SNMPINDEX}])=2</p><p>**Recovery expression**: </p>|average|
|Voltage Sensor "{#SNMPVALUE}" is nonoperational|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/entSensorStatus["{#SNMPVALUE}",Voltage,{#SNMPINDEX}])=3</p><p>**Recovery expression**: </p>|high|
|FAN Sensor "{#SNMPVALUE}" is nonoperational|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/entSensorStatus["{#SNMPVALUE}",FAN,{#SNMPINDEX}])=3</p><p>**Recovery expression**: </p>|high|
|FAN Sensor "{#SNMPVALUE}" is unavailable|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/entSensorStatus["{#SNMPVALUE}",FAN,{#SNMPINDEX}])=2</p><p>**Recovery expression**: </p>|average|
|Amperage Sensor "{#SNMPVALUE}" is nonoperational|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/entSensorStatus["{#SNMPVALUE}",Amperage])=3</p><p>**Recovery expression**: </p>|high|
|Amperage Sensor "{#SNMPVALUE}" is unavailable|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/entSensorStatus["{#SNMPVALUE}",Amperage])=2</p><p>**Recovery expression**: </p>|average|
|Connector rating exceeded on Power Supply "{#SNMPVALUE}"|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/cefcFRUPowerOperStatus["{#SNMPVALUE}","Power Supply"])=11</p><p>**Recovery expression**: </p>|average|
|Cooling capacity is insufficient on Power Supply "{#SNMPVALUE}"|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/cefcFRUPowerOperStatus["{#SNMPVALUE}","Power Supply"])=10</p><p>**Recovery expression**: </p>|high|
|FAN failed on Power Supply "{#SNMPVALUE}"|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/cefcFRUPowerOperStatus["{#SNMPVALUE}","Power Supply"])=9</p><p>**Recovery expression**: </p>|warning|
|FAN problem on Power Supply "{#SNMPVALUE}"|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/cefcFRUPowerOperStatus["{#SNMPVALUE}","Power Supply"])=7</p><p>**Recovery expression**: </p>|average|
|Power problem on Power Supply "{#SNMPVALUE}"|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/cefcFRUPowerOperStatus["{#SNMPVALUE}","Power Supply"])=5</p><p>**Recovery expression**: </p>|average|
|Power Supply "{#SNMPVALUE}" is failed|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/cefcFRUPowerOperStatus["{#SNMPVALUE}","Power Supply"])=8 and last(/Cisco_ASR_9K/cefcFRUPowerOperStatus["{#SNMPVALUE}","Power Supply"])=12</p><p>**Recovery expression**: </p>|high|
|Power Supply "{#SNMPVALUE}" is powered off|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/cefcFRUPowerOperStatus["{#SNMPVALUE}","Power Supply"])=1</p><p>**Recovery expression**: </p>|warning|
|System power is insufficient on Power Supply "{#SNMPVALUE}"|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/cefcFRUPowerOperStatus["{#SNMPVALUE}","Power Supply"])=4</p><p>**Recovery expression**: </p>|high|
|Temperature problem on Power Supply "{#SNMPVALUE}"|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/cefcFRUPowerOperStatus["{#SNMPVALUE}","Power Supply"])=6</p><p>**Recovery expression**: </p>|high|
|Status of Fan Tray "{#SNMPVALUE}" is in partial failure|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/cefcFanTrayOperStatus["{#SNMPVALUE}","Fan Tray"])=4</p><p>**Recovery expression**: </p>|warning|
|Status of Fan Tray "{#SNMPVALUE}" is powered down|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/cefcFanTrayOperStatus["{#SNMPVALUE}","Fan Tray"])=3</p><p>**Recovery expression**: </p>|high|
|High CPU #{#SNMPINDEX} Usage|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/cpmCPUTotal5minRev[{#SNMPINDEX}])>95</p><p>**Recovery expression**: </p>|high|
|High utilization of Memory Pool "{#SNMPVALUE}"|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/ciscoMemoryPoolUtilization5Min["{#SNMPVALUE}"])>95 and find(/Cisco_ASR_9K/ciscoMemoryPoolName["{#SNMPVALUE}"],,"like","image")=0</p><p>**Recovery expression**: </p>|average|
|BGP Peer "{#SNMPINDEX}"->"{#SNMPVALUE}" State changed (LLD)|<p>-</p>|<p>**Expression**: nodata(/Cisco_ASR_9K/snmptrap["(bgpEstablished|bgpBackwardTransition|cbgpFsmStateChange).*bgpPeerState .{#SNMPINDEX}[[:space:]][a-zA-Z]+[[:space:]]"],10m)=0</p><p>**Recovery expression**: </p>|average|
|BGP Peer "{#SNMPINDEX}"->"{#SNMPVALUE}" State changed (LLD)|<p>-</p>|<p>**Expression**: nodata(/Cisco_ASR_9K/snmptrap["(bgpBackwardTransition|cbgpFsmStateChange).*bgpPeerState .{#SNMPINDEX}[[:space:]][a-zA-Z]+[[:space:]]"],10m)=0</p><p>**Recovery expression**: </p>|average|
|Amperage Sensor "{#SNMPVALUE}" is nonoperational (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/entSensorStatus["{#SNMPVALUE}",Amperage])=3</p><p>**Recovery expression**: </p>|high|
|Amperage Sensor "{#SNMPVALUE}" is unavailable (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/entSensorStatus["{#SNMPVALUE}",Amperage])=2</p><p>**Recovery expression**: </p>|average|
|High CPU #{#SNMPINDEX} Usage (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/cpmCPUTotal5minRev[{#SNMPINDEX}])>95</p><p>**Recovery expression**: </p>|high|
|High utilization of Memory Pool "{#SNMPVALUE}" (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/ciscoMemoryPoolUtilization5Min["{#SNMPVALUE}"])>95 and find(/Cisco_ASR_9K/ciscoMemoryPoolName["{#SNMPVALUE}"],,"like","image")=0</p><p>**Recovery expression**: </p>|average|
|FAN Sensor "{#SNMPVALUE}" is nonoperational (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/entSensorStatus["{#SNMPVALUE}",FAN,{#SNMPINDEX}])=3</p><p>**Recovery expression**: </p>|high|
|FAN Sensor "{#SNMPVALUE}" is unavailable (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/entSensorStatus["{#SNMPVALUE}",FAN,{#SNMPINDEX}])=2</p><p>**Recovery expression**: </p>|average|
|Voltage Sensor "{#SNMPVALUE}" is nonoperational (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/entSensorStatus["{#SNMPVALUE}",Voltage,{#SNMPINDEX}])=3</p><p>**Recovery expression**: </p>|high|
|Module "{#SNMPVALUE}" is disabled (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/entStateOper["{#SNMPVALUE}","Module"])=2</p><p>**Recovery expression**: </p>|warning|
|OSPF Interface "{#SNMPVALUE}" State has been changed (LLD)|<p>-</p>|<p>**Expression**: nodata(/Cisco_ASR_9K/snmptrap["ospfIfStateChange.+ospfIfIpAddress[[:space:]]{#SNMPVALUE}[[:space:]].+ospfIfState[[:space:]][a-zA-Z]+"],10m)=0</p><p>**Recovery expression**: </p>|average|
|Status of Fan Tray "{#SNMPVALUE}" is in partial failure (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/cefcFanTrayOperStatus["{#SNMPVALUE}","Fan Tray"])=4</p><p>**Recovery expression**: </p>|warning|
|Status of Fan Tray "{#SNMPVALUE}" is powered down (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/cefcFanTrayOperStatus["{#SNMPVALUE}","Fan Tray"])=3</p><p>**Recovery expression**: </p>|high|
|Temperature Sensor "{#SNMPVALUE}" is nonoperational (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/entSensorStatus["{#SNMPVALUE}",Temperature,{#SNMPINDEX}])=3</p><p>**Recovery expression**: </p>|high|
|Temperature Sensor "{#SNMPVALUE}" is unavailable (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/entSensorStatus["{#SNMPVALUE}",Temperature,{#SNMPINDEX}])=2</p><p>**Recovery expression**: </p>|average|
|Load Sensor "{#SNMPVALUE}" is nonoperational (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/entSensorStatus["{#SNMPVALUE}",Load])=3</p><p>**Recovery expression**: </p>|high|
|Load Sensor "{#SNMPVALUE}" is unavailable (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/entSensorStatus["{#SNMPVALUE}",Load])=2</p><p>**Recovery expression**: </p>|average|
|OSPF Neighbor {#SNMPVALUE} has been changed (LLD)|<p>-</p>|<p>**Expression**: nodata(/Cisco_ASR_9K/snmptrap["(ospfNbrStateChange).*ospfNbrIpAddr[[:space:]]{#SNMPVALUE}[[:space:]].*[[:space:]][a-zA-Z]+[[:space:]]$"],10m)=0</p><p>**Recovery expression**: </p>|average|
|Connector rating exceeded on Power Supply "{#SNMPVALUE}" (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/cefcFRUPowerOperStatus["{#SNMPVALUE}","Power Supply"])=11</p><p>**Recovery expression**: </p>|average|
|Cooling capacity is insufficient on Power Supply "{#SNMPVALUE}" (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/cefcFRUPowerOperStatus["{#SNMPVALUE}","Power Supply"])=10</p><p>**Recovery expression**: </p>|high|
|FAN failed on Power Supply "{#SNMPVALUE}" (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/cefcFRUPowerOperStatus["{#SNMPVALUE}","Power Supply"])=9</p><p>**Recovery expression**: </p>|warning|
|FAN problem on Power Supply "{#SNMPVALUE}" (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/cefcFRUPowerOperStatus["{#SNMPVALUE}","Power Supply"])=7</p><p>**Recovery expression**: </p>|average|
|Power problem on Power Supply "{#SNMPVALUE}" (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/cefcFRUPowerOperStatus["{#SNMPVALUE}","Power Supply"])=5</p><p>**Recovery expression**: </p>|average|
|Power Supply "{#SNMPVALUE}" is failed (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/cefcFRUPowerOperStatus["{#SNMPVALUE}","Power Supply"])=8 and last(/Cisco_ASR_9K/cefcFRUPowerOperStatus["{#SNMPVALUE}","Power Supply"])=12</p><p>**Recovery expression**: </p>|high|
|Power Supply "{#SNMPVALUE}" is powered off (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/cefcFRUPowerOperStatus["{#SNMPVALUE}","Power Supply"])=1</p><p>**Recovery expression**: </p>|warning|
|System power is insufficient on Power Supply "{#SNMPVALUE}" (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/cefcFRUPowerOperStatus["{#SNMPVALUE}","Power Supply"])=4</p><p>**Recovery expression**: </p>|high|
|Temperature problem on Power Supply "{#SNMPVALUE}" (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_9K/cefcFRUPowerOperStatus["{#SNMPVALUE}","Power Supply"])=6</p><p>**Recovery expression**: </p>|high|
