...
|Name|Description|Expression|Priority|
|----|-----------|----------|--------|
|BGP Peer "{#SNMPINDEX}"->"{#SNMPVALUE}" State changed|<p>-</p>|<p>**Expression**: nodata(/Cisco_7200/snmptrap["(bgpEstablished|bgpBackwardTransition|cbgpFsmStateChange).*bgpPeerState .{#SNMPINDEX}[[:space:]][a-zA-Z]+[[:space:]]"],10m)=0</p><p>**Recovery expression**: </p>|average|
|BGP Peer "{#SNMPINDEX}"->"{#SNMPVALUE}" State changed|<p>-</p>|<p>**Expression**: nodata(/Cisco_7200/snmptrap["(bgpBackwardTransition|cbgpFsmStateChange).*bgpPeerState .{#SNMPINDEX}[[:space:]][a-zA-Z]+[[:space:]]"],10m)=0</p><p>**Recovery expression**: </p>|average|
|OSPF Interface "{#SNMPVALUE}" State has been changed|<p>-</p>|<p>**Expression**: nodata(/Cisco_7200/snmptrap["ospfIfStateChange.+ospfIfIpAddress[[:space:]]{#SNMPVALUE}[[:space:]].+ospfIfState[[:space:]][a-zA-Z]+"],10m)=0</p><p>**Recovery expression**: </p>|average|
|OSPF Neighbor {#SNMPVALUE} has been changed|<p>-</p>|<p>**Expression**: nodata(/Cisco_7200/snmptrap["(ospfNbrStateChange).*ospfNbrIpAddr[[:space:]]{#SNMPVALUE}[[:space:]].*[[:space:]][a-zA-Z]+[[:space:]]$"],10m)=0</p><p>**Recovery expression**: </p>|average|
|High CPU #{#SNMPINDEX} Usage|<p>-</p>|<p>**Expression**: last(/Cisco_7200/cpmCPUTotal5minRev[{#SNMPINDEX}])>95</p><p>**Recovery expression**: </p>|high|
|Status of FAN "{#SNMPVALUE}" is critical|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoEnvMonFanState["{#SNMPVALUE}"])=3</p><p>**Recovery expression**: </p>|average|
|Status of FAN "{#SNMPVALUE}" is non-operable|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoEnvMonFanState["{#SNMPVALUE}"])=2</p><p>**Recovery expression**: </p>|warning|
|Status of FAN "{#SNMPVALUE}" is not functioning|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoEnvMonFanState["{#SNMPVALUE}"])=6</p><p>**Recovery expression**: </p>|average|
|Status of FAN "{#SNMPVALUE}" is shutdown|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoEnvMonFanState["{#SNMPVALUE}"])=4</p><p>**Recovery expression**: </p>|high|
|High utilization of Memory Pool "{#SNMPVALUE}"|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoMemoryPoolUsed["{#SNMPVALUE}"])>last(/Cisco_7200/ciscoMemoryPoolTotal["{#SNMPVALUE}"])*0.9</p><p>**Recovery expression**: </p>|average|
|Status of Power Supply "{#SNMPVALUE}" is critical|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoEnvMonSupplyState["{#SNMPVALUE}"])=3</p><p>**Recovery expression**: </p>|average|
|Status of Power Supply "{#SNMPVALUE}" is non-operable|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoEnvMonSupplyState["{#SNMPVALUE}"])=2</p><p>**Recovery expression**: </p>|warning|
|Status of Power Supply "{#SNMPVALUE}" is not functioning|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoEnvMonSupplyState["{#SNMPVALUE}"])=6</p><p>**Recovery expression**: </p>|average|
|Status of Power Supply "{#SNMPVALUE}" is shutdown|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoEnvMonSupplyState["{#SNMPVALUE}"])=4</p><p>**Recovery expression**: </p>|high|
|Status of Temperature "{#SNMPVALUE}" is critical|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoEnvMonTemperatureState["{#SNMPVALUE}"])=3</p><p>**Recovery expression**: </p>|average|
|Status of Temperature "{#SNMPVALUE}" is non-operable|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoEnvMonTemperatureState["{#SNMPVALUE}"])=2</p><p>**Recovery expression**: </p>|warning|
|Status of Temperature "{#SNMPVALUE}" is not functioning|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoEnvMonTemperatureState["{#SNMPVALUE}"])=6</p><p>**Recovery expression**: </p>|average|
|Status of Temperature "{#SNMPVALUE}" is shutdown|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoEnvMonTemperatureState["{#SNMPVALUE}"])=4</p><p>**Recovery expression**: </p>|high|
|Status of Voltage "{#SNMPVALUE}" is critical|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoEnvMonVoltageState["{#SNMPVALUE}"])=3</p><p>**Recovery expression**: </p>|average|
|Status of Voltage "{#SNMPVALUE}" is non-operable|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoEnvMonVoltageState["{#SNMPVALUE}"])=2</p><p>**Recovery expression**: </p>|warning|
|Status of Voltage "{#SNMPVALUE}" is not functioning|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoEnvMonVoltageState["{#SNMPVALUE}"])=6</p><p>**Recovery expression**: </p>|average|
|Status of Voltage "{#SNMPVALUE}" is shutdown|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoEnvMonVoltageState["{#SNMPVALUE}"])=4</p><p>**Recovery expression**: </p>|high|
|Status of Voltage "{#SNMPVALUE}" is critical (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoEnvMonVoltageState["{#SNMPVALUE}"])=3</p><p>**Recovery expression**: </p>|average|
|Status of Voltage "{#SNMPVALUE}" is non-operable (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoEnvMonVoltageState["{#SNMPVALUE}"])=2</p><p>**Recovery expression**: </p>|warning|
|Status of Voltage "{#SNMPVALUE}" is not functioning (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoEnvMonVoltageState["{#SNMPVALUE}"])=6</p><p>**Recovery expression**: </p>|average|
|Status of Voltage "{#SNMPVALUE}" is shutdown (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoEnvMonVoltageState["{#SNMPVALUE}"])=4</p><p>**Recovery expression**: </p>|high|
|OSPF Neighbor {#SNMPVALUE} has been changed (LLD)|<p>-</p>|<p>**Expression**: nodata(/Cisco_7200/snmptrap["(ospfNbrStateChange).*ospfNbrIpAddr[[:space:]]{#SNMPVALUE}[[:space:]].*[[:space:]][a-zA-Z]+[[:space:]]$"],10m)=0</p><p>**Recovery expression**: </p>|average|
|High utilization of Memory Pool "{#SNMPVALUE}" (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoMemoryPoolUsed["{#SNMPVALUE}"])>last(/Cisco_7200/ciscoMemoryPoolTotal["{#SNMPVALUE}"])*0.9</p><p>**Recovery expression**: </p>|average|
|Status of Power Supply "{#SNMPVALUE}" is critical (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoEnvMonSupplyState["{#SNMPVALUE}"])=3</p><p>**Recovery expression**: </p>|average|
|Status of Power Supply "{#SNMPVALUE}" is non-operable (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoEnvMonSupplyState["{#SNMPVALUE}"])=2</p><p>**Recovery expression**: </p>|warning|
|Status of Power Supply "{#SNMPVALUE}" is not functioning (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoEnvMonSupplyState["{#SNMPVALUE}"])=6</p><p>**Recovery expression**: </p>|average|
|Status of Power Supply "{#SNMPVALUE}" is shutdown (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoEnvMonSupplyState["{#SNMPVALUE}"])=4</p><p>**Recovery expression**: </p>|high|
|OSPF Interface "{#SNMPVALUE}" State has been changed (LLD)|<p>-</p>|<p>**Expression**: nodata(/Cisco_7200/snmptrap["ospfIfStateChange.+ospfIfIpAddress[[:space:]]{#SNMPVALUE}[[:space:]].+ospfIfState[[:space:]][a-zA-Z]+"],10m)=0</p><p>**Recovery expression**: </p>|average|
|Status of Temperature "{#SNMPVALUE}" is critical (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoEnvMonTemperatureState["{#SNMPVALUE}"])=3</p><p>**Recovery expression**: </p>|average|
|Status of Temperature "{#SNMPVALUE}" is non-operable (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoEnvMonTemperatureState["{#SNMPVALUE}"])=2</p><p>**Recovery expression**: </p>|warning|
|Status of Temperature "{#SNMPVALUE}" is not functioning (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoEnvMonTemperatureState["{#SNMPVALUE}"])=6</p><p>**Recovery expression**: </p>|average|
|Status of Temperature "{#SNMPVALUE}" is shutdown (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoEnvMonTemperatureState["{#SNMPVALUE}"])=4</p><p>**Recovery expression**: </p>|high|
|BGP Peer "{#SNMPINDEX}"->"{#SNMPVALUE}" State changed (LLD)|<p>-</p>|<p>**Expression**: nodata(/Cisco_7200/snmptrap["(bgpEstablished|bgpBackwardTransition|cbgpFsmStateChange).*bgpPeerState .{#SNMPINDEX}[[:space:]][a-zA-Z]+[[:space:]]"],10m)=0</p><p>**Recovery expression**: </p>|average|
|BGP Peer "{#SNMPINDEX}"->"{#SNMPVALUE}" State changed (LLD)|<p>-</p>|<p>**Expression**: nodata(/Cisco_7200/snmptrap["(bgpBackwardTransition|cbgpFsmStateChange).*bgpPeerState .{#SNMPINDEX}[[:space:]][a-zA-Z]+[[:space:]]"],10m)=0</p><p>**Recovery expression**: </p>|average|
|Status of FAN "{#SNMPVALUE}" is critical (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoEnvMonFanState["{#SNMPVALUE}"])=3</p><p>**Recovery expression**: </p>|average|
|Status of FAN "{#SNMPVALUE}" is non-operable (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoEnvMonFanState["{#SNMPVALUE}"])=2</p><p>**Recovery expression**: </p>|warning|
|Status of FAN "{#SNMPVALUE}" is not functioning (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoEnvMonFanState["{#SNMPVALUE}"])=6</p><p>**Recovery expression**: </p>|average|
|Status of FAN "{#SNMPVALUE}" is shutdown (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_7200/ciscoEnvMonFanState["{#SNMPVALUE}"])=4</p><p>**Recovery expression**: </p>|high|
|High CPU #{#SNMPINDEX} Usage (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_7200/cpmCPUTotal5minRev[{#SNMPINDEX}])>95</p><p>**Recovery expression**: </p>|high|
