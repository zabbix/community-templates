...
|----|-----------|----------|--------|
|BGPv6 peer {#SNMPVALUE} ASN {#SNMPASN} is DOWN|<p>-</p>|<p>**Expression**: last(/Cisco BGP SNMP/cbgp6Peer2State["{#SNMPINDEX}","{#SNMPASN}"],#3)<>6 and last(/Cisco BGP SNMP/cbgp6Peer2AdminStatus["{#SNMPINDEX}","{#SNMPASN}"])=2</p><p>**Recovery expression**: </p>|high|
|BGPv6 peer up time low {#SNMPVALUE} ASN {#SNMPASN}|<p>-</p>|<p>**Expression**: last(/Cisco BGP SNMP/cbgp6Peer2FsmEstablishedTime["{#SNMPINDEX}","{#SNMPASN}"])<14400</p><p>**Recovery expression**: </p>|information|
|BGPv4 peer {#SNMPINDEX} ASN {#SNMPASN} is DOWN|<p>-</p>|<p>**Expression**: last(/Cisco BGP SNMP/cbgpPeer2State[{#SNMPINDEX}],#3)<>6 and last(/Cisco BGP SNMP/cbgpPeer2AdminStatus[{#SNMPINDEX}])=2</p><p>**Recovery expression**: </p>|high|
|BGPv4 Prefix Limit {#SNMPINDEX} ASN {#SNMPASN} near|<p>-</p>|<p>**Expression**: ( last(/Cisco BGP SNMP/cbgpPeerPrefixAccepted[{#SNMPINDEX}]) * 100 / last(/Cisco BGP SNMP/cbgpPeerPrefixLimit[{#SNMPINDEX}]) ) > 80</p><p>**Recovery expression**: </p>|warning|
|BGPv4 peer up time low {#SNMPINDEX} ASN {#SNMPASN}|<p>-</p>|<p>**Expression**: last(/Cisco BGP SNMP/cbgpPeer2FsmEstablishedTime[{#SNMPINDEX}])<14400</p><p>**Recovery expression**: </p>|information|
|BGPv4 peer {#SNMPINDEX} ASN {#SNMPASN} is DOWN (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco BGP SNMP/cbgpPeer2State[{#SNMPINDEX}],#3)<>6 and last(/Cisco BGP SNMP/cbgpPeer2AdminStatus[{#SNMPINDEX}])=2</p><p>**Recovery expression**: </p>|high|
|BGPv4 Prefix Limit {#SNMPINDEX} ASN {#SNMPASN} near (LLD)|<p>-</p>|<p>**Expression**: ( last(/Cisco BGP SNMP/cbgpPeerPrefixAccepted[{#SNMPINDEX}]) * 100 / last(/Cisco BGP SNMP/cbgpPeerPrefixLimit[{#SNMPINDEX}]) ) > 80</p><p>**Recovery expression**: </p>|warning|
|BGPv4 peer up time low {#SNMPINDEX} ASN {#SNMPASN} (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco BGP SNMP/cbgpPeer2FsmEstablishedTime[{#SNMPINDEX}])<14400</p><p>**Recovery expression**: </p>|information|
|BGPv6 peer {#SNMPVALUE} ASN {#SNMPASN} is DOWN (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco BGP SNMP/cbgp6Peer2State["{#SNMPINDEX}","{#SNMPASN}"],#3)<>6 and last(/Cisco BGP SNMP/cbgp6Peer2AdminStatus["{#SNMPINDEX}","{#SNMPASN}"])=2</p><p>**Recovery expression**: </p>|high|
|BGPv6 peer up time low {#SNMPVALUE} ASN {#SNMPASN} (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco BGP SNMP/cbgp6Peer2FsmEstablishedTime["{#SNMPINDEX}","{#SNMPASN}"])<14400</p><p>**Recovery expression**: </p>|information|
