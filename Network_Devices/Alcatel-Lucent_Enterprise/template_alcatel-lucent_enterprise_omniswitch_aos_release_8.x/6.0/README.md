...
|----|-----------|----------|--------|
|Flash freespace on chassis {#SNMPINDEX} < 256 MB|<p>-</p>|<p>**Expression**: last(/Alcatel-Lucent Enterprise OmniSwitch AOS 8.x/freespace.slot.[{#SNMPINDEX}])<268435456</p><p>**Recovery expression**: </p>|warning|
|Temperature on chassis {#SNMPINDEX} > 55 °C|<p>-</p>|<p>**Expression**: last(/Alcatel-Lucent Enterprise OmniSwitch AOS 8.x/temperature.slot.[{#SNMPINDEX}])>55</p><p>**Recovery expression**: </p>|warning|
|CPU usage on chassis [{#SNMPVALUE}] > 80%|<p>-</p>|<p>**Expression**: last(/Alcatel-Lucent Enterprise OmniSwitch AOS 8.x/cpu1minavg.slot.[{#SNMPVALUE}])>80</p><p>**Recovery expression**: </p>|warning|
|Memory usage on chassis [{#SNMPVALUE}] > 80%|<p>-</p>|<p>**Expression**: last(/Alcatel-Lucent Enterprise OmniSwitch AOS 8.x/memory1minavg.slot.[{#SNMPVALUE}])>80</p><p>**Recovery expression**: </p>|warning|
|RXTX load on chassis [{#SNMPVALUE}] > 80 %|<p>-</p>|<p>**Expression**: last(/Alcatel-Lucent Enterprise OmniSwitch AOS 8.x/rxtx1minavg.slot.[{#SNMPVALUE}])>80</p><p>**Recovery expression**: </p>|warning|
|CPU usage on chassis [{#SNMPVALUE}] > 80% (LLD)|<p>-</p>|<p>**Expression**: last(/Alcatel-Lucent Enterprise OmniSwitch AOS 8.x/cpu1minavg.slot.[{#SNMPVALUE}])>80</p><p>**Recovery expression**: </p>|warning|
|Memory usage on chassis [{#SNMPVALUE}] > 80% (LLD)|<p>-</p>|<p>**Expression**: last(/Alcatel-Lucent Enterprise OmniSwitch AOS 8.x/memory1minavg.slot.[{#SNMPVALUE}])>80</p><p>**Recovery expression**: </p>|warning|
|RXTX load on chassis [{#SNMPVALUE}] > 80 % (LLD)|<p>-</p>|<p>**Expression**: last(/Alcatel-Lucent Enterprise OmniSwitch AOS 8.x/rxtx1minavg.slot.[{#SNMPVALUE}])>80</p><p>**Recovery expression**: </p>|warning|
|Flash freespace on chassis {#SNMPINDEX} < 256 MB (LLD)|<p>-</p>|<p>**Expression**: last(/Alcatel-Lucent Enterprise OmniSwitch AOS 8.x/freespace.slot.[{#SNMPINDEX}])<268435456</p><p>**Recovery expression**: </p>|warning|
|Temperature on chassis {#SNMPINDEX} > 55 °C (LLD)|<p>-</p>|<p>**Expression**: last(/Alcatel-Lucent Enterprise OmniSwitch AOS 8.x/temperature.slot.[{#SNMPINDEX}])>55</p><p>**Recovery expression**: </p>|warning|
