...
|----|-----------|----------|--------|
|CPU usage on slot [{#SNMPVALUE}] > 80%|<p>-</p>|<p>**Expression**: last(/Alcatel-Lucent Enterprise OmniSwitch AOS 6.x/cpu1minavg.slot.[{#SNMPVALUE}])>80</p><p>**Recovery expression**: </p>|warning|
|Flash freespace on slot [{#SNMPVALUE}] < 32 MB|<p>-</p>|<p>**Expression**: last(/Alcatel-Lucent Enterprise OmniSwitch AOS 6.x/flashfreespace.slot.[{#SNMPVALUE}])<33554432</p><p>**Recovery expression**: </p>|warning|
|Memory usage on slot [{#SNMPVALUE}] > 80%|<p>-</p>|<p>**Expression**: last(/Alcatel-Lucent Enterprise OmniSwitch AOS 6.x/memory1minavg.slot.[{#SNMPVALUE}])>80</p><p>**Recovery expression**: </p>|warning|
|RXTX load on slot [{#SNMPVALUE}] > 80 %|<p>-</p>|<p>**Expression**: last(/Alcatel-Lucent Enterprise OmniSwitch AOS 6.x/rxtx1minavg.slot.[{#SNMPVALUE}])>80</p><p>**Recovery expression**: </p>|warning|
|Temperature on slot {#SNMPINDEX} > 55 °C|<p>-</p>|<p>**Expression**: last(/Alcatel-Lucent Enterprise OmniSwitch AOS 6.x/temperature.slot.[{#SNMPINDEX}])>55</p><p>**Recovery expression**: </p>|warning|
|Temperature on slot {#SNMPINDEX} > 55 °C (LLD)|<p>-</p>|<p>**Expression**: last(/Alcatel-Lucent Enterprise OmniSwitch AOS 6.x/temperature.slot.[{#SNMPINDEX}])>55</p><p>**Recovery expression**: </p>|warning|
|CPU usage on slot [{#SNMPVALUE}] > 80% (LLD)|<p>-</p>|<p>**Expression**: last(/Alcatel-Lucent Enterprise OmniSwitch AOS 6.x/cpu1minavg.slot.[{#SNMPVALUE}])>80</p><p>**Recovery expression**: </p>|warning|
|Flash freespace on slot [{#SNMPVALUE}] < 32 MB (LLD)|<p>-</p>|<p>**Expression**: last(/Alcatel-Lucent Enterprise OmniSwitch AOS 6.x/flashfreespace.slot.[{#SNMPVALUE}])<33554432</p><p>**Recovery expression**: </p>|warning|
|Memory usage on slot [{#SNMPVALUE}] > 80% (LLD)|<p>-</p>|<p>**Expression**: last(/Alcatel-Lucent Enterprise OmniSwitch AOS 6.x/memory1minavg.slot.[{#SNMPVALUE}])>80</p><p>**Recovery expression**: </p>|warning|
|RXTX load on slot [{#SNMPVALUE}] > 80 % (LLD)|<p>-</p>|<p>**Expression**: last(/Alcatel-Lucent Enterprise OmniSwitch AOS 6.x/rxtx1minavg.slot.[{#SNMPVALUE}])>80</p><p>**Recovery expression**: </p>|warning|
