...
|Name|Description|Expression|Priority|
|----|-----------|----------|--------|
|CARD {#SNMPVALUE} {#SNMPINDEX} CPU too high!|<p>-</p>|<p>**Expression**: {SNMP Device GPON ZTE fw 2.1:cardcpu[{#SNMPINDEX}].avg(10m)}>90</p><p>**Recovery expression**: </p>|high|
|CARD {#SNMPVALUE} {#SNMPINDEX} MEMORY too high!|<p>-</p>|<p>**Expression**: {SNMP Device GPON ZTE fw 2.1:cardmem[{#SNMPINDEX}].avg(10m)}>85</p><p>**Recovery expression**: </p>|high|
|CARD {#SNMPVALUE} operational status changed|<p>-</p>|<p>**Expression**: {SNMP Device GPON ZTE fw 2.1:cardoperstat[{#SNMPINDEX}].last()}<>1</p><p>**Recovery expression**: </p>|high|
|CARD {#SNMPVALUE} standby status changed|<p>-</p>|<p>**Expression**: {SNMP Device GPON ZTE fw 2.1:cardstandby[{#SNMPINDEX}].last()}<>1 and {SNMP Device GPON ZTE fw 2.1:cardstandby[{#SNMPINDEX}].last()}<>2</p><p>**Recovery expression**: </p>|high|
|Interface {#SNMPVALUE} operational status changed|<p>-</p>|<p>**Expression**: {SNMP Device GPON ZTE fw 2.1:ifOperStatus[{#SNMPVALUE}].diff(0)}=1</p><p>**Recovery expression**: </p>|high|
|SIGNAL LOW rx 1310nm {#ONUDESC}|<p>-</p>|<p>**Expression**: {SNMP Device GPON ZTE fw 2.1:rx1310[{#SNMPINDEX}].last()}<=-30 and {SNMP Device GPON ZTE fw 2.1:rx1310[{#SNMPINDEX}].last()}<>-80</p><p>**Recovery expression**: </p>|information|
|SIGNAL LOW rx 1490nm {#ONUDESC}|<p>-</p>|<p>**Expression**: {SNMP Device GPON ZTE fw 2.1:rx1490[{#SNMPINDEX}].last()}<=6 and {SNMP Device GPON ZTE fw 2.1:rx1490[{#SNMPINDEX}].last()}<>131.07</p><p>**Recovery expression**: </p>|information|
|SIGNAL LOW rx 1310nm {#ONUDESC} (LLD)|<p>-</p>|<p>**Expression**: {SNMP Device GPON ZTE fw 2.1:rx1310[{#SNMPINDEX}].last()}<=-30 and {SNMP Device GPON ZTE fw 2.1:rx1310[{#SNMPINDEX}].last()}<>-80</p><p>**Recovery expression**: </p>|information|
|SIGNAL LOW rx 1490nm {#ONUDESC} (LLD)|<p>-</p>|<p>**Expression**: {SNMP Device GPON ZTE fw 2.1:rx1490[{#SNMPINDEX}].last()}<=6 and {SNMP Device GPON ZTE fw 2.1:rx1490[{#SNMPINDEX}].last()}<>131.07</p><p>**Recovery expression**: </p>|information|
|Interface {#SNMPVALUE} operational status changed (LLD)|<p>-</p>|<p>**Expression**: {SNMP Device GPON ZTE fw 2.1:ifOperStatus[{#SNMPVALUE}].diff(0)}=1</p><p>**Recovery expression**: </p>|high|
|CARD {#SNMPVALUE} {#SNMPINDEX} CPU too high! (LLD)|<p>-</p>|<p>**Expression**: {SNMP Device GPON ZTE fw 2.1:cardcpu[{#SNMPINDEX}].avg(10m)}>90</p><p>**Recovery expression**: </p>|high|
|CARD {#SNMPVALUE} {#SNMPINDEX} MEMORY too high! (LLD)|<p>-</p>|<p>**Expression**: {SNMP Device GPON ZTE fw 2.1:cardmem[{#SNMPINDEX}].avg(10m)}>85</p><p>**Recovery expression**: </p>|high|
|CARD {#SNMPVALUE} operational status changed (LLD)|<p>-</p>|<p>**Expression**: {SNMP Device GPON ZTE fw 2.1:cardoperstat[{#SNMPINDEX}].last()}<>1</p><p>**Recovery expression**: </p>|high|
|CARD {#SNMPVALUE} standby status changed (LLD)|<p>-</p>|<p>**Expression**: {SNMP Device GPON ZTE fw 2.1:cardstandby[{#SNMPINDEX}].last()}<>1 and {SNMP Device GPON ZTE fw 2.1:cardstandby[{#SNMPINDEX}].last()}<>2</p><p>**Recovery expression**: </p>|high|
