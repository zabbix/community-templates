...
|----|-----------|----------|--------|
|Stack port {#SNMPVALUE}: Member is in critical state|<p>-</p>|<p>**Expression**: last(/SNMP Extreme EXOS/extremeStackingPortLinkStatus[{#SNMPINDEX}])<>1</p><p>**Recovery expression**: </p>|high|
|Stack {#SNMPVALUE}: Member is in critical state|<p>-</p>|<p>**Expression**: last(/SNMP Extreme EXOS/extremeStackMemberOperStatus[{#SNMPVALUE}])<>1</p><p>**Recovery expression**: </p>|high|
|Fan {#SNMPVALUE}: Fan is in critical state|<p>-</p>|<p>**Expression**: last(/SNMP Extreme EXOS/sensor.fan.status[extremeFanOperational.{#SNMPINDEX}])<>1</p><p>**Recovery expression**: </p>|high|
|#{#SNMPVALUE}: High memory utilization|<p>-</p>|<p>**Expression**: avg(/SNMP Extreme EXOS/vm.memory.pused[{#SNMPVALUE}],5m)>90</p><p>**Recovery expression**: </p>|high|
|PSU {#SNMPVALUE}: Power supply is in critical state|<p>-</p>|<p>**Expression**: last(/SNMP Extreme EXOS/sensor.psu.status[extremePowerSupplyStatus.{#SNMPINDEX}])<>3</p><p>**Recovery expression**: </p>|high|
|PSU {#SNMPVALUE}: Power supply power off|<p>-</p>|<p>**Expression**: last(/SNMP Extreme EXOS/sensor.psu.status[extremePowerSupplyStatus.{#SNMPINDEX}])<>4</p><p>**Recovery expression**: </p>|warning|
|Fan {#SNMPVALUE}: Fan is in critical state (LLD)|<p>-</p>|<p>**Expression**: last(/SNMP Extreme EXOS/sensor.fan.status[extremeFanOperational.{#SNMPINDEX}])<>1</p><p>**Recovery expression**: </p>|high|
|Stack {#SNMPVALUE}: Member is in critical state (LLD)|<p>-</p>|<p>**Expression**: last(/SNMP Extreme EXOS/extremeStackMemberOperStatus[{#SNMPVALUE}])<>1</p><p>**Recovery expression**: </p>|high|
|Stack port {#SNMPVALUE}: Member is in critical state (LLD)|<p>-</p>|<p>**Expression**: last(/SNMP Extreme EXOS/extremeStackingPortLinkStatus[{#SNMPINDEX}])<>1</p><p>**Recovery expression**: </p>|high|
|#{#SNMPVALUE}: High memory utilization (LLD)|<p>-</p>|<p>**Expression**: avg(/SNMP Extreme EXOS/vm.memory.pused[{#SNMPVALUE}],5m)>90</p><p>**Recovery expression**: </p>|high|
|PSU {#SNMPVALUE}: Power supply is in critical state (LLD)|<p>-</p>|<p>**Expression**: last(/SNMP Extreme EXOS/sensor.psu.status[extremePowerSupplyStatus.{#SNMPINDEX}])<>3</p><p>**Recovery expression**: </p>|high|
|PSU {#SNMPVALUE}: Power supply power off (LLD)|<p>-</p>|<p>**Expression**: last(/SNMP Extreme EXOS/sensor.psu.status[extremePowerSupplyStatus.{#SNMPINDEX}])<>4</p><p>**Recovery expression**: </p>|warning|
