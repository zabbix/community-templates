...
|----|-----------|----------|--------|
|HIGH - Host {HOST.NAME} - Interface ethernet {#SNMPVALUE} In overloaded|<p>-</p>|<p>**Expression**: last(/DM DmOS/ifHCInOctets.[{#SNMPINDEX}])>0.90/last(/DM DmOS/ifHighSpeed.[{#SNMPINDEX}])</p><p>**Recovery expression**: </p>|high|
|HIGH - Host {HOST.NAME} - Interface ethernet {#SNMPVALUE} Out overloaded|<p>-</p>|<p>**Expression**: last(/DM DmOS/ifHCOutOctets.[{#SNMPINDEX}])>0.90/last(/DM DmOS/ifHighSpeed.[{#SNMPINDEX}])</p><p>**Recovery expression**: </p>|high|
|WARNING - Host {HOST.NAME} - Interface ethernet {#SNMPVALUE} In discards|<p>-</p>|<p>**Expression**: change(/DM DmOS/ifInDiscards.[{#SNMPINDEX}])>1</p><p>**Recovery expression**: </p>|warning|
|WARNING - Host {HOST.NAME} - Interface ethernet {#SNMPVALUE} In errors|<p>-</p>|<p>**Expression**: change(/DM DmOS/ifInErrors.[{#SNMPINDEX}])>1</p><p>**Recovery expression**: </p>|warning|
|WARNING - Host {HOST.NAME} - Interface ethernet {#SNMPVALUE} In overloaded|<p>-</p>|<p>**Expression**: last(/DM DmOS/ifHCInOctets.[{#SNMPINDEX}])>0.60/last(/DM DmOS/ifHighSpeed.[{#SNMPINDEX}])</p><p>**Recovery expression**: </p>|warning|
|WARNING - Host {HOST.NAME} - Interface ethernet {#SNMPVALUE} Out discards|<p>-</p>|<p>**Expression**: change(/DM DmOS/ifOutDiscards.[{#SNMPINDEX}])>1</p><p>**Recovery expression**: </p>|warning|
|WARNING - Host {HOST.NAME} - Interface ethernet {#SNMPVALUE} Out errors|<p>-</p>|<p>**Expression**: change(/DM DmOS/ifOutErrors.[{#SNMPINDEX}])>1</p><p>**Recovery expression**: </p>|warning|
|WARNING - Host {HOST.NAME} - Interface ethernet {#SNMPVALUE} Out overloaded|<p>-</p>|<p>**Expression**: last(/DM DmOS/ifHCOutOctets.[{#SNMPINDEX}])>0.60/last(/DM DmOS/ifHighSpeed.[{#SNMPINDEX}])</p><p>**Recovery expression**: </p>|warning|
|HIGH - Host {HOST.NAME} - Interface ethernet {#SNMPVALUE} In overloaded (LLD)|<p>-</p>|<p>**Expression**: last(/DM DmOS/ifHCInOctets.[{#SNMPINDEX}])>0.90/last(/DM DmOS/ifHighSpeed.[{#SNMPINDEX}])</p><p>**Recovery expression**: </p>|high|
|HIGH - Host {HOST.NAME} - Interface ethernet {#SNMPVALUE} Out overloaded (LLD)|<p>-</p>|<p>**Expression**: last(/DM DmOS/ifHCOutOctets.[{#SNMPINDEX}])>0.90/last(/DM DmOS/ifHighSpeed.[{#SNMPINDEX}])</p><p>**Recovery expression**: </p>|high|
|WARNING - Host {HOST.NAME} - Interface ethernet {#SNMPVALUE} In discards (LLD)|<p>-</p>|<p>**Expression**: change(/DM DmOS/ifInDiscards.[{#SNMPINDEX}])>1</p><p>**Recovery expression**: </p>|warning|
|WARNING - Host {HOST.NAME} - Interface ethernet {#SNMPVALUE} In errors (LLD)|<p>-</p>|<p>**Expression**: change(/DM DmOS/ifInErrors.[{#SNMPINDEX}])>1</p><p>**Recovery expression**: </p>|warning|
|WARNING - Host {HOST.NAME} - Interface ethernet {#SNMPVALUE} In overloaded (LLD)|<p>-</p>|<p>**Expression**: last(/DM DmOS/ifHCInOctets.[{#SNMPINDEX}])>0.60/last(/DM DmOS/ifHighSpeed.[{#SNMPINDEX}])</p><p>**Recovery expression**: </p>|warning|
|WARNING - Host {HOST.NAME} - Interface ethernet {#SNMPVALUE} Out discards (LLD)|<p>-</p>|<p>**Expression**: change(/DM DmOS/ifOutDiscards.[{#SNMPINDEX}])>1</p><p>**Recovery expression**: </p>|warning|
|WARNING - Host {HOST.NAME} - Interface ethernet {#SNMPVALUE} Out errors (LLD)|<p>-</p>|<p>**Expression**: change(/DM DmOS/ifOutErrors.[{#SNMPINDEX}])>1</p><p>**Recovery expression**: </p>|warning|
|WARNING - Host {HOST.NAME} - Interface ethernet {#SNMPVALUE} Out overloaded (LLD)|<p>-</p>|<p>**Expression**: last(/DM DmOS/ifHCOutOctets.[{#SNMPINDEX}])>0.60/last(/DM DmOS/ifHighSpeed.[{#SNMPINDEX}])</p><p>**Recovery expression**: </p>|warning|
