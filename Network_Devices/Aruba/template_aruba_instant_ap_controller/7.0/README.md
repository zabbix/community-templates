...
|----|-----------|----------|--------|
|Aruba AP Controller: High ICMP ping loss|<p>-</p>|<p>**Expression**: min(/Aruba Instant AP Wireless Controller by SNMP/icmppingloss,5m)>{$ICMP_LOSS_WARN} and min(/Aruba Instant AP Wireless Controller by SNMP/icmppingloss,5m)<100</p><p>**Recovery expression**: </p>|warning|
|Aruba AP Controller: High ICMP ping response time|<p>-</p>|<p>**Expression**: avg(/Aruba Instant AP Wireless Controller by SNMP/icmppingsec,5m)>{$ICMP_RESPONSE_TIME_WARN}</p><p>**Recovery expression**: </p>|warning|
|Aruba AP Controller: No SNMP data collection|<p>-</p>|<p>**Expression**: max(/Aruba Instant AP Wireless Controller by SNMP/zabbix[host,snmp,available],{$SNMP.TIMEOUT})=0</p><p>**Recovery expression**: </p>|warning|
|Aruba AP Controller: Operating system description has changed|<p>-</p>|<p>**Expression**: last(/Aruba Instant AP Wireless Controller by SNMP/system.sw.os[sysDescr.0],#1)<>last(/Aruba Instant AP Wireless Controller by SNMP/system.sw.os[sysDescr.0],#2) and length(last(/Aruba Instant AP Wireless Controller by SNMP/system.sw.os[sysDescr.0]))>0</p><p>**Recovery expression**: </p>|information|
|Aruba AP Controller: System name has changed|<p>-</p>|<p>**Expression**: last(/Aruba Instant AP Wireless Controller by SNMP/system.name,#1)<>last(/Aruba Instant AP Wireless Controller by SNMP/system.name,#2) and length(last(/Aruba Instant AP Wireless Controller by SNMP/system.name))>0</p><p>**Recovery expression**: </p>|information|
|Aruba AP Controller: Unavailable by ICMP ping|<p>-</p>|<p>**Expression**: max(/Aruba Instant AP Wireless Controller by SNMP/icmpping,#3)=0</p><p>**Recovery expression**: </p>|high|
|AP: {#AP.NAME} High CPU utilization|<p>Machine is experiencing high CPU usage. Might be slow to respond.</p>|<p>**Expression**: min(/Aruba Instant AP Wireless Controller by SNMP/aruba.ap[cpu.utilization.{#AP.MAC.ADDR}],5m)>{$CPU.UTIL.CRIT}</p><p>**Recovery expression**: </p>|average|
|AP: {#AP.NAME} High memory utilization|<p>Machine is experiencing high memory usage.</p>|<p>**Expression**: min(/Aruba Instant AP Wireless Controller by SNMP/aruba.ap[memory.util.{#AP.MAC.ADDR}],5m)>{$MEMORY.UTIL.MAX}</p><p>**Recovery expression**: </p>|average|
|AP: {#AP.NAME} status is down|<p>AP controller is reporting the AP as down for 2 minutes. Please check device connectivity with the controller.</p>|<p>**Expression**: last(/Aruba Instant AP Wireless Controller by SNMP/aruba.ap[status.{#AP.MAC.ADDR}],#2)=2</p><p>**Recovery expression**: </p>|high|
|AP: {#AP.NAME} Unavailable by ICMP ping|<p>Last three attempts returned timeout.  Please check device connectivity.</p>|<p>**Expression**: max(/Aruba Instant AP Wireless Controller by SNMP/icmpping[{#AP.IP.ADDR}],#3)=0</p><p>**Recovery expression**: </p>|high|
|Interface {#IFNAME}({#IFALIAS}): Ethernet has changed to lower speed than it was before|<p>This Ethernet connection has transitioned down from its known maximum speed. This might be a sign of autonegotiation issues. Acknowledge to close the problem manually.</p>|<p>**Expression**: change(/Aruba Instant AP Wireless Controller by SNMP/net.if.speed[ifHighSpeed.{#SNMPINDEX}])<0 and last(/Aruba Instant AP Wireless Controller by SNMP/net.if.speed[ifHighSpeed.{#SNMPINDEX}])>0 and (last(/Aruba Instant AP Wireless Controller by SNMP/net.if.type[ifType.{#SNMPINDEX}])=6 or last(/Aruba Instant AP Wireless Controller by SNMP/net.if.type[ifType.{#SNMPINDEX}])=7 or last(/Aruba Instant AP Wireless Controller by SNMP/net.if.type[ifType.{#SNMPINDEX}])=11 or last(/Aruba Instant AP Wireless Controller by SNMP/net.if.type[ifType.{#SNMPINDEX}])=62 or last(/Aruba Instant AP Wireless Controller by SNMP/net.if.type[ifType.{#SNMPINDEX}])=69 or last(/Aruba Instant AP Wireless Controller by SNMP/net.if.type[ifType.{#SNMPINDEX}])=117 ) and (last(/Aruba Instant AP Wireless Controller by SNMP/net.if.status[ifOperStatus.{#SNMPINDEX}])<>2)</p><p>**Recovery expression**: (change(/Aruba Instant AP Wireless Controller by SNMP/net.if.speed[ifHighSpeed.{#SNMPINDEX}])>0 and last(/Aruba Instant AP Wireless Controller by SNMP/net.if.speed[ifHighSpeed.{#SNMPINDEX}],#2)>0) or (last(/Aruba Instant AP Wireless Controller by SNMP/net.if.status[ifOperStatus.{#SNMPINDEX}])=2)</p>|information|
|Interface {#IFNAME}({#IFALIAS}): High bandwidth usage|<p>The utilization of the network interface is close to its estimated maximum bandwidth.</p>|<p>**Expression**: (avg(/Aruba Instant AP Wireless Controller by SNMP/net.if.in[ifHCInOctets.{#SNMPINDEX}],15m)>({$IF.UTIL.MAX:"{#IFNAME}"}/100)*last(/Aruba Instant AP Wireless Controller by SNMP/net.if.speed[ifHighSpeed.{#SNMPINDEX}]) or avg(/Aruba Instant AP Wireless Controller by SNMP/net.if.out[ifHCOutOctets.{#SNMPINDEX}],15m)>({$IF.UTIL.MAX:"{#IFNAME}"}/100)*last(/Aruba Instant AP Wireless Controller by SNMP/net.if.speed[ifHighSpeed.{#SNMPINDEX}])) and last(/Aruba Instant AP Wireless Controller by SNMP/net.if.speed[ifHighSpeed.{#SNMPINDEX}])>0</p><p>**Recovery expression**: avg(/Aruba Instant AP Wireless Controller by SNMP/net.if.in[ifHCInOctets.{#SNMPINDEX}],15m)<(({$IF.UTIL.MAX:"{#IFNAME}"}-3)/100)*last(/Aruba Instant AP Wireless Controller by SNMP/net.if.speed[ifHighSpeed.{#SNMPINDEX}]) and avg(/Aruba Instant AP Wireless Controller by SNMP/net.if.out[ifHCOutOctets.{#SNMPINDEX}],15m)<(({$IF.UTIL.MAX:"{#IFNAME}"}-3)/100)*last(/Aruba Instant AP Wireless Controller by SNMP/net.if.speed[ifHighSpeed.{#SNMPINDEX}])</p>|warning|
|Interface {#IFNAME}({#IFALIAS}): High error rate|<p>It recovers when it is below 80% of the `{$IF.ERRORS.WARN:"{#IFNAME}"}` threshold.</p>|<p>min(/Aruba Instant AP Wireless Controller by SNMP/net.if.in.errors[ifInErrors.{#SNMPINDEX}],5m)>{$IF.ERRORS.WARN:"{#IFNAME}"} or min(/Aruba Instant AP Wireless Controller by SNMP/net.if.out.errors[ifOutErrors.{#SNMPINDEX}],5m)>{$IF.ERRORS.WARN:"{#IFNAME}"}</p><p>**Recovery expression**: max(/Aruba Instant AP Wireless Controller by SNMP/net.if.in.errors[ifInErrors.{#SNMPINDEX}],5m)<{$IF.ERRORS.WARN:"{#IFNAME}"}*0.8 and max(/Aruba Instant AP Wireless Controller by SNMP/net.if.out.errors[ifOutErrors.{#SNMPINDEX}],5m)<{$IF.ERRORS.WARN:"{#IFNAME}"}*0.8</p>|warning|
|Interface {#IFNAME}({#IFALIAS}): Link down|<p>This trigger expression works as follows: 1. It can be triggered if the operations status is down. 2. `{$IFCONTROL:"{#IFNAME}"}=1` - a user can redefine context macro to value - 0. That marks this interface as not important. No new trigger will be fired if this interface is down. 3. `{TEMPLATE_NAME:METRIC.diff()}=1` - the trigger fires only if the operational status was up to (1) sometime before (so, do not fire for the 'eternal off' interfaces.) WARNING: if closed manually - it will not fire again on the next poll, because of .diff.</p>|<p>**Expression**: {$IFCONTROL:"{#IFNAME}"}=1 and last(/Aruba Instant AP Wireless Controller by SNMP/net.if.status[ifOperStatus.{#SNMPINDEX}])=2 and (last(/Aruba Instant AP Wireless Controller by SNMP/net.if.status[ifOperStatus.{#SNMPINDEX}],#1)<>last(/Aruba Instant AP Wireless Controller by SNMP/net.if.status[ifOperStatus.{#SNMPINDEX}],#2))</p><p>**Recovery expression**: last(/Aruba Instant AP Wireless Controller by SNMP/net.if.status[ifOperStatus.{#SNMPINDEX}])<>2 or {$IFCONTROL:"{#IFNAME}"}=0</p>|average|
|SSID: {#SSID.NAME} status has changed|<p>The enabled/disabled status of this SSID has changed. Acknowledge to close the problem manually.</p>|<p>**Expression**: last(/Aruba Instant AP Wireless Controller by SNMP/aruba.ssid[status.{#SSID.NAME}],#1)<>last(/Aruba Instant AP Wireless Controller by SNMP/aruba.ssid[status.{#SSID.NAME}],#2)</p><p>**Recovery expression**: </p>|information|
|SSID: {#SSID.NAME} hide status has changed|<p>Whether this SSID is broadcast or hidden has changed. Acknowledge to close the problem manually.</p>|<p>**Expression**: last(/Aruba Instant AP Wireless Controller by SNMP/aruba.ssid[status.hide.{#SSID.NAME}],#1)<>last(/Aruba Instant AP Wireless Controller by SNMP/aruba.ssid[status.hide.{#SSID.NAME}],#2)</p><p>**Recovery expression**: </p>|information|
