...
|----|-----------|----------|--------|
|Outlet {#SNMPVALUE} State Change|<p>-</p>|<p>**Expression**: (last(/SNMP APC PDU AP79XX/rPDUOutletStatusOutletState[{#SNMPINDEX}],#1)<>last(/SNMP APC PDU AP79XX/rPDUOutletStatusOutletState[{#SNMPINDEX}],#2))=1</p><p>**Recovery expression**: </p>|information|
|Outlet {#SNMPVALUE} State Change (LLD)|<p>-</p>|<p>**Expression**: (last(/SNMP APC PDU AP79XX/rPDUOutletStatusOutletState[{#SNMPINDEX}],#1)<>last(/SNMP APC PDU AP79XX/rPDUOutletStatusOutletState[{#SNMPINDEX}],#2))=1</p><p>**Recovery expression**: </p>|information|
