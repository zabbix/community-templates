...
|----|-----------|----------|--------|
|{#SNMPVALUE} {ITEM.LASTVALUE} :: Active Power > 4.6 kW|<p>The power used currently is more than 4.6 kW.</p>|<p>**Expression**: {Powertek 1 Phase PDU:.1.3.6.1.4.1.42610.1.4.4.1.6.1.2.1.2.[{#SNMPINDEX}].last()}>4.6</p><p>**Recovery expression**: </p>|high|
|{#SNMPVALUE} {ITEM.LASTVALUE}  :: Active Power > 5.8 kW|<p>The power used currently is more than 5.8 kW.</p>|<p>**Expression**: {Powertek 1 Phase PDU:.1.3.6.1.4.1.42610.1.4.4.1.6.1.2.1.2.[{#SNMPINDEX}].last()}>5.8</p><p>**Recovery expression**: </p>|disaster|
|{#SNMPVALUE} {ITEM.LASTVALUE}  :: PDU Reset Date changed|<p>The PDU reset has changed, indicating that the PDU has been switched off and on.</p>|<p>**Expression**: {Powertek 1 Phase PDU:.1.3.6.1.4.1.42610.1.4.4.1.6.1.2.1.3.[{#SNMPINDEX}].diff()}=1</p><p>**Recovery expression**: </p>|warning|
|{#SNMPVALUE} {ITEM.LASTVALUE}  :: Amps > 13A|<p>The PDU is currently using more than 13 Amps.</p>|<p>**Expression**: {Powertek 1 Phase PDU:.1.3.6.1.4.1.42610.1.4.4.1.6.1.2.1.6.[{#SNMPINDEX}].last()}>13</p><p>**Recovery expression**: </p>|high|
|{#SNMPVALUE} {ITEM.LASTVALUE}  :: Amps > 16A|<p>The PDU is currently using more than 16 Amps.</p>|<p>**Expression**: {Powertek 1 Phase PDU:.1.3.6.1.4.1.42610.1.4.4.1.6.1.2.1.6.[{#SNMPINDEX}].last()}>16</p><p>**Recovery expression**: </p>|disaster|
|{#SNMPVALUE} {ITEM.LASTVALUE} :: Voltage > 245V|<p>The voltage of the PDU is currently more than 245V, which is too high.</p>|<p>**Expression**: {Powertek 1 Phase PDU:.1.3.6.1.4.1.42610.1.4.4.1.6.1.2.1.15.[{#SNMPINDEX}].last()}>245</p><p>**Recovery expression**: </p>|high|
|{#SNMPVALUE} {ITEM.LASTVALUE} :: Voltage > 250V|<p>The voltage of the PDU is currently more than 250V, which is too high.</p>|<p>**Expression**: {Powertek 1 Phase PDU:.1.3.6.1.4.1.42610.1.4.4.1.6.1.2.1.15.[{#SNMPINDEX}].last()}>250</p><p>**Recovery expression**: </p>|disaster|
|{#SNMPVALUE} {ITEM.LASTVALUE} :: Power Factor < 90%|<p>The power factor of the PDU is currently less than 90% which indicates power is leaking and not being used.</p>|<p>**Expression**: {Powertek 1 Phase PDU:.1.3.6.1.4.1.42610.1.4.4.1.6.1.2.1.18.[{#SNMPINDEX}].last()}<90</p><p>**Recovery expression**: </p>|disaster|
|{#SNMPVALUE} {ITEM.LASTVALUE} :: Power Factor < 95%|<p>The power factor of the PDU is currently less than 95% which indicates power is leaking and not being used.</p>|<p>**Expression**: {Powertek 1 Phase PDU:.1.3.6.1.4.1.42610.1.4.4.1.6.1.2.1.18.[{#SNMPINDEX}].last()}<95</p><p>**Recovery expression**: </p>|high|
|{#SNMPVALUE} {ITEM.LASTVALUE} :: Active Power > 4.6 kW (LLD)|<p>The power used currently is more than 4.6 kW.</p>|<p>**Expression**: {Powertek 1 Phase PDU:.1.3.6.1.4.1.42610.1.4.4.1.6.1.2.1.2.[{#SNMPINDEX}].last()}>4.6</p><p>**Recovery expression**: </p>|high|
|{#SNMPVALUE} {ITEM.LASTVALUE}  :: Active Power > 5.8 kW (LLD)|<p>The power used currently is more than 5.8 kW.</p>|<p>**Expression**: {Powertek 1 Phase PDU:.1.3.6.1.4.1.42610.1.4.4.1.6.1.2.1.2.[{#SNMPINDEX}].last()}>5.8</p><p>**Recovery expression**: </p>|disaster|
|{#SNMPVALUE} {ITEM.LASTVALUE}  :: PDU Reset Date changed (LLD)|<p>The PDU reset has changed, indicating that the PDU has been switched off and on.</p>|<p>**Expression**: {Powertek 1 Phase PDU:.1.3.6.1.4.1.42610.1.4.4.1.6.1.2.1.3.[{#SNMPINDEX}].diff()}=1</p><p>**Recovery expression**: </p>|warning|
|{#SNMPVALUE} {ITEM.LASTVALUE}  :: Amps > 13A (LLD)|<p>The PDU is currently using more than 13 Amps.</p>|<p>**Expression**: {Powertek 1 Phase PDU:.1.3.6.1.4.1.42610.1.4.4.1.6.1.2.1.6.[{#SNMPINDEX}].last()}>13</p><p>**Recovery expression**: </p>|high|
|{#SNMPVALUE} {ITEM.LASTVALUE}  :: Amps > 16A (LLD)|<p>The PDU is currently using more than 16 Amps.</p>|<p>**Expression**: {Powertek 1 Phase PDU:.1.3.6.1.4.1.42610.1.4.4.1.6.1.2.1.6.[{#SNMPINDEX}].last()}>16</p><p>**Recovery expression**: </p>|disaster|
|{#SNMPVALUE} {ITEM.LASTVALUE} :: Voltage > 245V (LLD)|<p>The voltage of the PDU is currently more than 245V, which is too high.</p>|<p>**Expression**: {Powertek 1 Phase PDU:.1.3.6.1.4.1.42610.1.4.4.1.6.1.2.1.15.[{#SNMPINDEX}].last()}>245</p><p>**Recovery expression**: </p>|high|
|{#SNMPVALUE} {ITEM.LASTVALUE} :: Voltage > 250V (LLD)|<p>The voltage of the PDU is currently more than 250V, which is too high.</p>|<p>**Expression**: {Powertek 1 Phase PDU:.1.3.6.1.4.1.42610.1.4.4.1.6.1.2.1.15.[{#SNMPINDEX}].last()}>250</p><p>**Recovery expression**: </p>|disaster|
|{#SNMPVALUE} {ITEM.LASTVALUE} :: Power Factor < 90% (LLD)|<p>The power factor of the PDU is currently less than 90% which indicates power is leaking and not being used.</p>|<p>**Expression**: {Powertek 1 Phase PDU:.1.3.6.1.4.1.42610.1.4.4.1.6.1.2.1.18.[{#SNMPINDEX}].last()}<90</p><p>**Recovery expression**: </p>|disaster|
|{#SNMPVALUE} {ITEM.LASTVALUE} :: Power Factor < 95% (LLD)|<p>The power factor of the PDU is currently less than 95% which indicates power is leaking and not being used.</p>|<p>**Expression**: {Powertek 1 Phase PDU:.1.3.6.1.4.1.42610.1.4.4.1.6.1.2.1.18.[{#SNMPINDEX}].last()}<95</p><p>**Recovery expression**: </p>|high|
