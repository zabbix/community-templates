...
|----|-----------|----------|--------|
|UPS Bypassed phase {#SNMPINDEX}|<p>-</p>|<p>**Expression**: {HW UPS Legrand CS141:upsBypassCurrent.[{#SNMPINDEX}].last()}<>0 or {HW UPS Legrand CS141:upsBypassPower.[{#SNMPINDEX}].last()}<>0</p><p>**Recovery expression**: </p>|warning|
|UPS Input frequency outside nominal {#SNMPINDEX}|<p>-</p>|<p>**Expression**: {HW UPS Legrand CS141:upsInputFrequency.[{#SNMPINDEX}].last()}>53 or {HW UPS Legrand CS141:upsInputFrequency.[{#SNMPINDEX}].last()}<47</p><p>**Recovery expression**: </p>|warning|
|UPS Overloaded phase {#SNMPINDEX} (>60%)|<p>-</p>|<p>**Expression**: {HW UPS Legrand CS141:upsOutputPercentLoad.[{#SNMPINDEX}].last(#2)}>60</p><p>**Recovery expression**: </p>|high|
|UPS Load Changed phase {#SNMPINDEX} (+/-300W)|<p>On {HOST.NAME} we detect a big load change - the power output differential is over 300W</p>|<p>**Expression**: {HW UPS Legrand CS141:upsOutputPower.[{#SNMPINDEX}].change()}>300</p><p>**Recovery expression**: </p>|information|
|UPS Low output power phase {#SNMPINDEX}  (<10 W)|<p>The output power for {HOST.NAME} is under {ITEM.VALUE}. Take actions to prevent this in future</p>|<p>**Expression**: {HW UPS Legrand CS141:upsOutputPower.[{#SNMPINDEX}].last()}<10</p><p>**Recovery expression**: </p>|warning|
|UPS Power Voltage outside nominal phase {#SNMPINDEX}|<p>-</p>|<p>**Expression**: {HW UPS Legrand CS141:upsOutputVoltage.[{#SNMPINDEX}].last(#3)}<200 or {HW UPS Legrand CS141:upsOutputVoltage.[{#SNMPINDEX}].last(#3)}>250</p><p>**Recovery expression**: </p>|high|
|UPS Bypassed phase {#SNMPINDEX} (LLD)|<p>-</p>|<p>**Expression**: {HW UPS Legrand CS141:upsBypassCurrent.[{#SNMPINDEX}].last()}<>0 or {HW UPS Legrand CS141:upsBypassPower.[{#SNMPINDEX}].last()}<>0</p><p>**Recovery expression**: </p>|warning|
|UPS Overloaded phase {#SNMPINDEX} (>60%) (LLD)|<p>-</p>|<p>**Expression**: {HW UPS Legrand CS141:upsOutputPercentLoad.[{#SNMPINDEX}].last(#2)}>60</p><p>**Recovery expression**: </p>|high|
|UPS Load Changed phase {#SNMPINDEX} (+/-300W) (LLD)|<p>On {HOST.NAME} we detect a big load change - the power output differential is over 300W</p>|<p>**Expression**: {HW UPS Legrand CS141:upsOutputPower.[{#SNMPINDEX}].change()}>300</p><p>**Recovery expression**: </p>|information|
|UPS Low output power phase {#SNMPINDEX}  (<10 W) (LLD)|<p>The output power for {HOST.NAME} is under {ITEM.VALUE}. Take actions to prevent this in future</p>|<p>**Expression**: {HW UPS Legrand CS141:upsOutputPower.[{#SNMPINDEX}].last()}<10</p><p>**Recovery expression**: </p>|warning|
|UPS Power Voltage outside nominal phase {#SNMPINDEX} (LLD)|<p>-</p>|<p>**Expression**: {HW UPS Legrand CS141:upsOutputVoltage.[{#SNMPINDEX}].last(#3)}<200 or {HW UPS Legrand CS141:upsOutputVoltage.[{#SNMPINDEX}].last(#3)}>250</p><p>**Recovery expression**: </p>|high|
|UPS Input frequency outside nominal {#SNMPINDEX} (LLD)|<p>-</p>|<p>**Expression**: {HW UPS Legrand CS141:upsInputFrequency.[{#SNMPINDEX}].last()}>53 or {HW UPS Legrand CS141:upsInputFrequency.[{#SNMPINDEX}].last()}<47</p><p>**Recovery expression**: </p>|warning|
