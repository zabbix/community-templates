...
|----|-----------|----------|--------|
|CPU {#BOARDID}-{#MODULEID} Faulted|<p>-</p>|<p>**Expression**: last(/SNMP XSCF Sun M5000/cpu.status[{#BOARDID}-{#MODULEID}])<>1</p><p>**Recovery expression**: </p>|high|
|Fan #{$BOARDID} Failed|<p>-</p>|<p>**Expression**: last(/SNMP XSCF Sun M5000/fan.status[{#BOARDID}])<>1</p><p>**Recovery expression**: </p>|high|
|Memory unit {#BOARDID} Faulted|<p>-</p>|<p>**Expression**: last(/SNMP XSCF Sun M5000/mem.statsu[{#BOARDID}])<>1</p><p>**Recovery expression**: </p>|high|
|Memory Board #{#ID} Faulted|<p>-</p>|<p>**Expression**: last(/SNMP XSCF Sun M5000/memb.status[{#ID}])<>1</p><p>**Recovery expression**: </p>|high|
