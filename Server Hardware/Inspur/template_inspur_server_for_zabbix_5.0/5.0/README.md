...
|----|-----------|----------|--------|
|INSPUR_SERVER_DISK_STATUS_ALARM|<p>-</p>|<p>**Expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.disk.status.[{#SNMPVALUE}].last()}>1</p><p>**Recovery expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.disk.status.[{#SNMPVALUE}].last()}=1</p>|high|
|INSPUR_SERVER_FAN_STATUS_ALARM|<p>-</p>|<p>**Expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.fan.status.[{#SNMPVALUE}].last()}>1</p><p>**Recovery expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.fan.status.[{#SNMPVALUE}].last()}=1</p>|warning|
|INSPUR_SERVER_MANAGEMENT_SUBSYSTEM_HEALTH_STATUS_ALARM|<p>-</p>|<p>**Expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.management.subsystem.health.status.[{#SNMPVALUE}].last()}>1</p><p>**Recovery expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.management.subsystem.health.status.[{#SNMPVALUE}].last()}=1</p>|average|
|INSPUR_SERVER_MEMORY_STATUS_ALARM|<p>-</p>|<p>**Expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.memory.status.[{#SNMPVALUE}].last()}>1</p><p>**Recovery expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.memory.status.[{#SNMPVALUE}].last()}=1</p>|high|
|INSPUR_SERVER_MICROCONTROLLER_STATUS_ALARM|<p>-</p>|<p>**Expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.microcontroller.status.[{#SNMPVALUE}].last()}>1</p><p>**Recovery expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.microcontroller.status.[{#SNMPVALUE}].last()}=1</p>|average|
|INSPUR_SERVER_PCIE_PRESENT_STATUS_ALARM|<p>-</p>|<p>**Expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.pcie.present.status.[{#SNMPVALUE}].last()}=0</p><p>**Recovery expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.pcie.present.status.[{#SNMPVALUE}].last()}=1</p>|high|
|INSPUR_SERVER_POWER_SUPPLY_STATUS_ALARM|<p>-</p>|<p>**Expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.power.supply.status.[{#SNMPVALUE}].last()}>1</p><p>**Recovery expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.power.supply.status.[{#SNMPVALUE}].last()}=1</p>|high|
|INSPUR_SERVER_PROCESSOR_STATUS_ALARM|<p>-</p>|<p>**Expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.processor.status.[{#SNMPVALUE}].last()}>1</p><p>**Recovery expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.processor.status.[{#SNMPVALUE}].last()}=1</p>|disaster|
|INSPUR_SERVER_TEMPERATURE_STATUS_ALARM|<p>-</p>|<p>**Expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.temperature.status.[{#SNMPVALUE}].last()}>1</p><p>**Recovery expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.temperature.status.[{#SNMPVALUE}].last()}=1</p>|warning|
|INSPUR_SERVER_VOLTAGE_STATUS_ALARM|<p>-</p>|<p>**Expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.voltage.status.[{#SNMPVALUE}].last()}>1</p><p>**Recovery expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.voltage.status.[{#SNMPVALUE}].last()}=1</p>|average|
|INSPUR_SERVER_WATCHDOG_STATUS_ALARM|<p>-</p>|<p>**Expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.watchdog.status.[{#SNMPVALUE}].last()}>1</p><p>**Recovery expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.watchdog.status.[{#SNMPVALUE}].last()}=1</p>|average|
|INSPUR_SERVER_WATCHDOG_STATUS_ALARM (LLD)|<p>-</p>|<p>**Expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.watchdog.status.[{#SNMPVALUE}].last()}>1</p><p>**Recovery expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.watchdog.status.[{#SNMPVALUE}].last()}=1</p>|average|
|INSPUR_SERVER_VOLTAGE_STATUS_ALARM (LLD)|<p>-</p>|<p>**Expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.voltage.status.[{#SNMPVALUE}].last()}>1</p><p>**Recovery expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.voltage.status.[{#SNMPVALUE}].last()}=1</p>|average|
|INSPUR_SERVER_DISK_STATUS_ALARM (LLD)|<p>-</p>|<p>**Expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.disk.status.[{#SNMPVALUE}].last()}>1</p><p>**Recovery expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.disk.status.[{#SNMPVALUE}].last()}=1</p>|high|
|INSPUR_SERVER_MANAGEMENT_SUBSYSTEM_HEALTH_STATUS_ALARM (LLD)|<p>-</p>|<p>**Expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.management.subsystem.health.status.[{#SNMPVALUE}].last()}>1</p><p>**Recovery expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.management.subsystem.health.status.[{#SNMPVALUE}].last()}=1</p>|average|
|INSPUR_SERVER_POWER_SUPPLY_STATUS_ALARM (LLD)|<p>-</p>|<p>**Expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.power.supply.status.[{#SNMPVALUE}].last()}>1</p><p>**Recovery expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.power.supply.status.[{#SNMPVALUE}].last()}=1</p>|high|
|INSPUR_SERVER_PROCESSOR_STATUS_ALARM (LLD)|<p>-</p>|<p>**Expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.processor.status.[{#SNMPVALUE}].last()}>1</p><p>**Recovery expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.processor.status.[{#SNMPVALUE}].last()}=1</p>|disaster|
|INSPUR_SERVER_TEMPERATURE_STATUS_ALARM (LLD)|<p>-</p>|<p>**Expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.temperature.status.[{#SNMPVALUE}].last()}>1</p><p>**Recovery expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.temperature.status.[{#SNMPVALUE}].last()}=1</p>|warning|
|INSPUR_SERVER_FAN_STATUS_ALARM (LLD)|<p>-</p>|<p>**Expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.fan.status.[{#SNMPVALUE}].last()}>1</p><p>**Recovery expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.fan.status.[{#SNMPVALUE}].last()}=1</p>|warning|
|INSPUR_SERVER_MEMORY_STATUS_ALARM (LLD)|<p>-</p>|<p>**Expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.memory.status.[{#SNMPVALUE}].last()}>1</p><p>**Recovery expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.memory.status.[{#SNMPVALUE}].last()}=1</p>|high|
|INSPUR_SERVER_PCIE_PRESENT_STATUS_ALARM (LLD)|<p>-</p>|<p>**Expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.pcie.present.status.[{#SNMPVALUE}].last()}=0</p><p>**Recovery expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.pcie.present.status.[{#SNMPVALUE}].last()}=1</p>|high|
|INSPUR_SERVER_MICROCONTROLLER_STATUS_ALARM (LLD)|<p>-</p>|<p>**Expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.microcontroller.status.[{#SNMPVALUE}].last()}>1</p><p>**Recovery expression**: {Server Inspur BMC All Items 4 Zabbix5.0:inspur.server.microcontroller.status.[{#SNMPVALUE}].last()}=1</p>|average|
