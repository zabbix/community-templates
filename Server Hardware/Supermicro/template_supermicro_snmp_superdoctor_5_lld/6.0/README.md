...
|----|-----------|----------|--------|
|Supermicro physical disc was changed to {ITEM.LASTVALUE} on {HOST.DNS}|<p>-</p>|<p>**Expression**: (last(/Supermicro SNMP Superdoctor 5 LLD/supermicro_disk_sn[{#SNMPINDEX}],#1)<>last(/Supermicro SNMP Superdoctor 5 LLD/supermicro_disk_sn[{#SNMPINDEX}],#2))=1</p><p>**Recovery expression**: </p>|warning|
|Supermicro physical disk status is {ITEM.LASTVALUE} on {HOST.DNS}|<p>-</p>|<p>**Expression**: last(/Supermicro SNMP Superdoctor 5 LLD/supermicro_disk_smart[{#SNMPINDEX}])=2</p><p>**Recovery expression**: </p>|high|
|{#SNMPVALUE} is {ITEM.LASTVALUE} on {HOST.DNS}|<p>-</p>|<p>**Expression**: last(/Supermicro SNMP Superdoctor 5 LLD/supermicro_acinp[{#SNMPVALUE}])<220</p><p>**Recovery expression**: </p>|average|
|Memory bank on {HOST.DNS}  has {ITEM.LASTVALUE} errors|<p>-</p>|<p>**Expression**: last(/Supermicro SNMP Superdoctor 5 LLD/supermicro_memory_errcount[{#SNMPVALUE}])>0</p><p>**Recovery expression**: </p>|warning|
|Memory bank on {HOST.DNS}  was changed|<p>-</p>|<p>**Expression**: (last(/Supermicro SNMP Superdoctor 5 LLD/supermicro_memory_sn[{#SNMPVALUE}],#1)<>last(/Supermicro SNMP Superdoctor 5 LLD/supermicro_memory_sn[{#SNMPVALUE}],#2))=1</p><p>**Recovery expression**: </p>|information|
|{#SNMPVALUE} is {ITEM.LASTVALUE} on {HOST.DNS}|<p>-</p>|<p>**Expression**: last(/Supermicro SNMP Superdoctor 5 LLD/supermicro_psstatus[{#MONITEMNAME}])=1</p><p>**Recovery expression**: </p>|warning|
|{#SNMPVALUE} is {ITEM.LASTVALUE} on {HOST.DNS}|<p>-</p>|<p>**Expression**: last(/Supermicro SNMP Superdoctor 5 LLD/supermicro_psstatus[{#MONITEMNAME}])=2</p><p>**Recovery expression**: </p>|high|
|{#SNMPVALUE} is {ITEM.LASTVALUE} on {HOST.DNS}|<p>-</p>|<p>**Expression**: last(/Supermicro SNMP Superdoctor 5 LLD/supermicro_temp[{#MONITEMNAME}])>70</p><p>**Recovery expression**: </p>|high|
|{#SNMPVALUE} is {ITEM.LASTVALUE} on {HOST.DNS} (LLD)|<p>-</p>|<p>**Expression**: last(/Supermicro SNMP Superdoctor 5 LLD/supermicro_psstatus[{#MONITEMNAME}])=1</p><p>**Recovery expression**: </p>|warning|
|{#SNMPVALUE} is {ITEM.LASTVALUE} on {HOST.DNS} (LLD)|<p>-</p>|<p>**Expression**: last(/Supermicro SNMP Superdoctor 5 LLD/supermicro_psstatus[{#MONITEMNAME}])=2</p><p>**Recovery expression**: </p>|high|
|{#SNMPVALUE} is {ITEM.LASTVALUE} on {HOST.DNS} (LLD)|<p>-</p>|<p>**Expression**: last(/Supermicro SNMP Superdoctor 5 LLD/supermicro_acinp[{#SNMPVALUE}])<220</p><p>**Recovery expression**: </p>|average|
|Memory bank on {HOST.DNS}  has {ITEM.LASTVALUE} errors (LLD)|<p>-</p>|<p>**Expression**: last(/Supermicro SNMP Superdoctor 5 LLD/supermicro_memory_errcount[{#SNMPVALUE}])>0</p><p>**Recovery expression**: </p>|warning|
|Memory bank on {HOST.DNS}  was changed (LLD)|<p>-</p>|<p>**Expression**: (last(/Supermicro SNMP Superdoctor 5 LLD/supermicro_memory_sn[{#SNMPVALUE}],#1)<>last(/Supermicro SNMP Superdoctor 5 LLD/supermicro_memory_sn[{#SNMPVALUE}],#2))=1</p><p>**Recovery expression**: </p>|information|
|Supermicro physical disc was changed to {ITEM.LASTVALUE} on {HOST.DNS} (LLD)|<p>-</p>|<p>**Expression**: (last(/Supermicro SNMP Superdoctor 5 LLD/supermicro_disk_sn[{#SNMPINDEX}],#1)<>last(/Supermicro SNMP Superdoctor 5 LLD/supermicro_disk_sn[{#SNMPINDEX}],#2))=1</p><p>**Recovery expression**: </p>|warning|
|Supermicro physical disk status is {ITEM.LASTVALUE} on {HOST.DNS} (LLD)|<p>-</p>|<p>**Expression**: last(/Supermicro SNMP Superdoctor 5 LLD/supermicro_disk_smart[{#SNMPINDEX}])=2</p><p>**Recovery expression**: </p>|high|
|{#SNMPVALUE} is {ITEM.LASTVALUE} on {HOST.DNS} (LLD)|<p>-</p>|<p>**Expression**: last(/Supermicro SNMP Superdoctor 5 LLD/supermicro_temp[{#MONITEMNAME}])>70</p><p>**Recovery expression**: </p>|high|
