...
|----|-----------|----------|--------|
|{HOST.NAME} -> Disk №{#SNMPINDEX} not ok|<p>-</p>|<p>**Expression**: ({Module Generic SNMPv2 to Fuji Eternus:disk.status.[{#SNMPINDEX}].max(15m)}<1 or {Module Generic SNMPv2 to Fuji Eternus:disk.status.[{#SNMPINDEX}].min(15m)}>1) and ({Module Generic SNMPv2 to Fuji Eternus:disk.status.[{#SNMPINDEX}].max(15m)}<5 or {Module Generic SNMPv2 to Fuji Eternus:disk.status.[{#SNMPINDEX}].min(15m)}>5) and ({Module Generic SNMPv2 to Fuji Eternus:disk.status.[{#SNMPINDEX}].max(15m)}<65 or {Module Generic SNMPv2 to Fuji Eternus:disk.status.[{#SNMPINDEX}].min(15m)}>65)</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} -> RAID №{#RAID_GROUP} is not ok|<p>-</p>|<p>**Expression**: {Module Generic SNMPv2 to Fuji Eternus:raid.group.status.[{#SNMPINDEX}].max(15)}<2 or {Module Generic SNMPv2 to Fuji Eternus:raid.group.status.[{#SNMPINDEX}].min(15)}>2</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} -> Disk №{#SNMPINDEX} not ok (LLD)|<p>-</p>|<p>**Expression**: ({Module Generic SNMPv2 to Fuji Eternus:disk.status.[{#SNMPINDEX}].max(15m)}<1 or {Module Generic SNMPv2 to Fuji Eternus:disk.status.[{#SNMPINDEX}].min(15m)}>1) and ({Module Generic SNMPv2 to Fuji Eternus:disk.status.[{#SNMPINDEX}].max(15m)}<5 or {Module Generic SNMPv2 to Fuji Eternus:disk.status.[{#SNMPINDEX}].min(15m)}>5) and ({Module Generic SNMPv2 to Fuji Eternus:disk.status.[{#SNMPINDEX}].max(15m)}<65 or {Module Generic SNMPv2 to Fuji Eternus:disk.status.[{#SNMPINDEX}].min(15m)}>65)</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} -> RAID №{#RAID_GROUP} is not ok (LLD)|<p>-</p>|<p>**Expression**: {Module Generic SNMPv2 to Fuji Eternus:raid.group.status.[{#SNMPINDEX}].max(15)}<2 or {Module Generic SNMPv2 to Fuji Eternus:raid.group.status.[{#SNMPINDEX}].min(15)}>2</p><p>**Recovery expression**: </p>|high|
