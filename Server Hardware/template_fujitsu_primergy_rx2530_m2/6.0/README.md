...
|----|-----------|----------|--------|
|{HOST.NAME} -> Component {#NAME} Errors: {ITEM.LASTVALUE}|<p>-</p>|<p>**Expression**: min(/Module Generic SNMPv2 to Fuji IRMC/component.errors.[{#SNMPINDEX}],15s)>1</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} -> {#NAME} status is fail|<p>-</p>|<p>**Expression**: last(/Module Generic SNMPv2 to Fuji IRMC/component.status.[{#SNMPINDEX}])<>1 and last(/Module Generic SNMPv2 to Fuji IRMC/component.status.[{#SNMPINDEX}])<>6</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} -> {#FAN} Speed: {ITEM.LASTVALUE}, threshold: {$FAN_SPEED_LIMIT}|<p>-</p>|<p>**Expression**: max(/Module Generic SNMPv2 to Fuji IRMC/fan.speed.[{#SNMPINDEX}],5s)<{$FAN_SPEED_LIMIT}</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} ->{#FAN} Status not ok|<p>-</p>|<p>**Expression**: last(/Module Generic SNMPv2 to Fuji IRMC/fan.status.[{#SNMPINDEX}])<>3</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} -> {#PSU} not ok|<p>-</p>|<p>**Expression**: last(/Module Generic SNMPv2 to Fuji IRMC/psu.status.[{#PSU}])<>3</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} -> Temperature {#SENSOR}: {ITEM.LASTVALUE}, threshold: {#WARN_TEMP}|<p>-</p>|<p>**Expression**: last(/Module Generic SNMPv2 to Fuji IRMC/sensor.temp.[{#SNMPINDEX}])>{#WARN_TEMP}</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} -> {#VSENSOR} status not ok|<p>-</p>|<p>**Expression**: last(/Module Generic SNMPv2 to Fuji IRMC/voltage.sensor.[{#SNMPINDEX}])<>3 and last(/Module Generic SNMPv2 to Fuji IRMC/voltage.sensor.[{#SNMPINDEX}])<>2</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} -> {#FAN} Speed: {ITEM.LASTVALUE}, threshold: {$FAN_SPEED_LIMIT} (LLD)|<p>-</p>|<p>**Expression**: max(/Module Generic SNMPv2 to Fuji IRMC/fan.speed.[{#SNMPINDEX}],5s)<{$FAN_SPEED_LIMIT}</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} ->{#FAN} Status not ok (LLD)|<p>-</p>|<p>**Expression**: last(/Module Generic SNMPv2 to Fuji IRMC/fan.status.[{#SNMPINDEX}])<>3</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} -> {#NAME} status is fail (LLD)|<p>-</p>|<p>**Expression**: last(/Module Generic SNMPv2 to Fuji IRMC/component.status.[{#SNMPINDEX}])<>1 and last(/Module Generic SNMPv2 to Fuji IRMC/component.status.[{#SNMPINDEX}])<>6</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} -> Component {#NAME} Errors: {ITEM.LASTVALUE} (LLD)|<p>-</p>|<p>**Expression**: min(/Module Generic SNMPv2 to Fuji IRMC/component.errors.[{#SNMPINDEX}],15s)>1</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} -> Temperature {#SENSOR}: {ITEM.LASTVALUE}, threshold: {#WARN_TEMP} (LLD)|<p>-</p>|<p>**Expression**: last(/Module Generic SNMPv2 to Fuji IRMC/sensor.temp.[{#SNMPINDEX}])>{#WARN_TEMP}</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} -> {#VSENSOR} status not ok (LLD)|<p>-</p>|<p>**Expression**: last(/Module Generic SNMPv2 to Fuji IRMC/voltage.sensor.[{#SNMPINDEX}])<>3 and last(/Module Generic SNMPv2 to Fuji IRMC/voltage.sensor.[{#SNMPINDEX}])<>2</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} -> {#PSU} not ok (LLD)|<p>-</p>|<p>**Expression**: last(/Module Generic SNMPv2 to Fuji IRMC/psu.status.[{#PSU}])<>3</p><p>**Recovery expression**: </p>|high|
