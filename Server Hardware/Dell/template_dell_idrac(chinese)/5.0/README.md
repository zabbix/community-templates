...
|----|-----------|----------|--------|
|物理机 {HOSTNAME} 风扇 {#FAN} 异常|<p>-</p>|<p>**Expression**: {Dell iDrac SNMPV2:FanStatus.[{#SNMPINDEX}].last(0)}<>3</p><p>**Recovery expression**: </p>|average|
|物理机{HOST.NAME} 内存 {#MEM} 错误|<p>-</p>|<p>**Expression**: {Dell iDrac SNMPV2:MemStatus.[{#SNMPINDEX}].last(0)}<>3</p><p>**Recovery expression**: </p>|high|
|物理机 {#HOSTNAME}  网卡 {#NETIF} 状态变化|<p>-</p>|<p>**Expression**: {Dell iDrac SNMPV2:NetConnStatus.[{#SNMPINDEX}].diff(0)}=1</p><p>**Recovery expression**: </p>|warning|
|物理机{HOST.NAME}  网卡 {#NETIF} 状态异常|<p>-</p>|<p>**Expression**: {Dell iDrac SNMPV2:NetStatus.[{#SNMPINDEX}].last(0)}<>3</p><p>**Recovery expression**: </p>|high|
|物理机 {HOST.NAME} 电源 {#POWER} 状态异常|<p>-</p>|<p>**Expression**: {Dell iDrac SNMPV2:PowerSupplySensorState.[{#SNMPINDEX}].last(0)}<>1</p><p>**Recovery expression**: </p>|high|
|物理机 {HOST.NAME} 处理器 {#SNMPINDEX} 状态异常|<p>-</p>|<p>**Expression**: ({Dell iDrac SNMPV2:ProcStatus.[{#SNMPINDEX}].last(0)}<>3 and {Dell iDrac SNMPV2:ProcStatus.[{#SNMPINDEX}].last(0)}<>2) or ({Dell iDrac SNMPV2:ProcStatus.[{#SNMPINDEX}].last(86400)}<>2 and {Dell iDrac SNMPV2:ProcStatus.[{#SNMPINDEX}].last(0)}=2)</p><p>**Recovery expression**: </p>|high|
|物理机 {HOST.NAME} 温度传感器 {#TEMP} 状态异常|<p>-</p>|<p>**Expression**: {Dell iDrac SNMPV2:TempStatus.[{#SNMPINDEX}].last(0)}<>3</p><p>**Recovery expression**: </p>|high|
|物理机 {HOST.NAME} 电压组件 {#VOLTAGE} 异常|<p>-</p>|<p>**Expression**: {Dell iDrac SNMPV2:VoltageStatus.[{#SNMPINDEX}].last(0)}<>3</p><p>**Recovery expression**: </p>|average|
|物理机{HOST.NAME} 磁盘卷 {#VOLNAME} 错误|<p>-</p>|<p>**Expression**: {Dell iDrac SNMPV2:VolumeDiskState.[{#SNMPINDEX}].last(0)}<>2</p><p>**Recovery expression**: </p>|high|
|物理机 {#HOSTNAME}  网卡 {#NETIF} 状态变化 (LLD)|<p>-</p>|<p>**Expression**: {Dell iDrac SNMPV2:NetConnStatus.[{#SNMPINDEX}].diff(0)}=1</p><p>**Recovery expression**: </p>|warning|
|物理机{HOST.NAME}  网卡 {#NETIF} 状态异常 (LLD)|<p>-</p>|<p>**Expression**: {Dell iDrac SNMPV2:NetStatus.[{#SNMPINDEX}].last(0)}<>3</p><p>**Recovery expression**: </p>|high|
|物理机 {HOSTNAME} 风扇 {#FAN} 异常 (LLD)|<p>-</p>|<p>**Expression**: {Dell iDrac SNMPV2:FanStatus.[{#SNMPINDEX}].last(0)}<>3</p><p>**Recovery expression**: </p>|average|
|物理机{HOST.NAME} 磁盘卷 {#VOLNAME} 错误 (LLD)|<p>-</p>|<p>**Expression**: {Dell iDrac SNMPV2:VolumeDiskState.[{#SNMPINDEX}].last(0)}<>2</p><p>**Recovery expression**: </p>|high|
|物理机 {HOST.NAME} 电压组件 {#VOLTAGE} 异常 (LLD)|<p>-</p>|<p>**Expression**: {Dell iDrac SNMPV2:VoltageStatus.[{#SNMPINDEX}].last(0)}<>3</p><p>**Recovery expression**: </p>|average|
|物理机 {HOST.NAME} 处理器 {#SNMPINDEX} 状态异常 (LLD)|<p>-</p>|<p>**Expression**: ({Dell iDrac SNMPV2:ProcStatus.[{#SNMPINDEX}].last(0)}<>3 and {Dell iDrac SNMPV2:ProcStatus.[{#SNMPINDEX}].last(0)}<>2) or ({Dell iDrac SNMPV2:ProcStatus.[{#SNMPINDEX}].last(86400)}<>2 and {Dell iDrac SNMPV2:ProcStatus.[{#SNMPINDEX}].last(0)}=2)</p><p>**Recovery expression**: </p>|high|
|物理机{HOST.NAME} 内存 {#MEM} 错误 (LLD)|<p>-</p>|<p>**Expression**: {Dell iDrac SNMPV2:MemStatus.[{#SNMPINDEX}].last(0)}<>3</p><p>**Recovery expression**: </p>|high|
|物理机 {HOST.NAME} 温度传感器 {#TEMP} 状态异常 (LLD)|<p>-</p>|<p>**Expression**: {Dell iDrac SNMPV2:TempStatus.[{#SNMPINDEX}].last(0)}<>3</p><p>**Recovery expression**: </p>|high|
|物理机 {HOST.NAME} 电源 {#POWER} 状态异常 (LLD)|<p>-</p>|<p>**Expression**: {Dell iDrac SNMPV2:PowerSupplySensorState.[{#SNMPINDEX}].last(0)}<>1</p><p>**Recovery expression**: </p>|high|
