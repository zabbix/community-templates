...
|----|-----------|----------|--------|
|[{$ORACLE_SID}] Tablespace: High used space on {#ORACLE_TBS}|<p>-</p>|<p>**Expression**: last(/OCI_Dbaas/zabbix-oci-dbaas[{$ORACLE_SID},tb_size,{#ORACLE_TBS}])>95</p><p>**Recovery expression**: </p>|high|
|[{$ORACLE_SID}] Tablespace: Warning used space on {#ORACLE_TBS}|<p>-</p>|<p>**Expression**: last(/OCI_Dbaas/zabbix-oci-dbaas[{$ORACLE_SID},tb_size,{#ORACLE_TBS}])>90 and last(/OCI_Dbaas/zabbix-oci-dbaas[{$ORACLE_SID},tb_size,{#ORACLE_TBS}])<95</p><p>**Recovery expression**: </p>|warning|
|[{$ORACLE_SID}] Tablespace: High used space on {#ORACLE_TBS} (LLD)|<p>-</p>|<p>**Expression**: last(/OCI_Dbaas/zabbix-oci-dbaas[{$ORACLE_SID},tb_size,{#ORACLE_TBS}])>95</p><p>**Recovery expression**: </p>|high|
|[{$ORACLE_SID}] Tablespace: Warning used space on {#ORACLE_TBS} (LLD)|<p>-</p>|<p>**Expression**: last(/OCI_Dbaas/zabbix-oci-dbaas[{$ORACLE_SID},tb_size,{#ORACLE_TBS}])>90 and last(/OCI_Dbaas/zabbix-oci-dbaas[{$ORACLE_SID},tb_size,{#ORACLE_TBS}])<95</p><p>**Recovery expression**: </p>|warning|
