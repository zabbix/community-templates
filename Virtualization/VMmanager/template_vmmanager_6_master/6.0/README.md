...
|Node {#NODE_ID} {#NODE_NAME} bird error|<p>-</p>|<p>**Expression**: last(/Template VMmanager 6 Master/node[{#NODE_ID}, bird_error])<>"" and last(/platform/node[{#NODE_ID}, bird_error])<>"null"</p><p>**Recovery expression**: </p>|warning|
|Node {#NODE_ID} {#NODE_NAME} frr error|<p>-</p>|<p>**Expression**: last(/Template VMmanager 6 Master/node[{#NODE_ID}, frr_error])<>"" and last(/platform/node[{#NODE_ID}, frr_error])<>"null"</p><p>**Recovery expression**: </p>|warning|
