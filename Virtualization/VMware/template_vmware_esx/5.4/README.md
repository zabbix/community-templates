...
|----|-----------|----------|--------|
|Espaço no datastore "{#DATASTORE}" está acima de 70%|<p>-</p>|<p>**Expression**: avg(/Template VM VMware Hypervisor/vmware.hv.datastore.size[{$URL},Template VM VMware Hypervisor,{#DATASTORE},pfree],5m)<=30</p><p>**Recovery expression**: </p>|average|
|Espaço no datastore "{#DATASTORE}" está acima de 75%|<p>-</p>|<p>**Expression**: avg(/Template VM VMware Hypervisor/vmware.hv.datastore.size[{$URL},Template VM VMware Hypervisor,{#DATASTORE},pfree],5m)<=25</p><p>**Recovery expression**: </p>|high|
|Espaço no datastore "{#DATASTORE}" está acima de 80%|<p>-</p>|<p>**Expression**: avg(/Template VM VMware Hypervisor/vmware.hv.datastore.size[{$URL},Template VM VMware Hypervisor,{#DATASTORE},pfree],5m)<=20</p><p>**Recovery expression**: </p>|disaster|
|Espaço no datastore "{#DATASTORE}" está acima de 70% (LLD)|<p>-</p>|<p>**Expression**: avg(/Template VM VMware Hypervisor/vmware.hv.datastore.size[{$URL},Template VM VMware Hypervisor,{#DATASTORE},pfree],5m)<=30</p><p>**Recovery expression**: </p>|average|
|Espaço no datastore "{#DATASTORE}" está acima de 75% (LLD)|<p>-</p>|<p>**Expression**: avg(/Template VM VMware Hypervisor/vmware.hv.datastore.size[{$URL},Template VM VMware Hypervisor,{#DATASTORE},pfree],5m)<=25</p><p>**Recovery expression**: </p>|high|
|Espaço no datastore "{#DATASTORE}" está acima de 80% (LLD)|<p>-</p>|<p>**Expression**: avg(/Template VM VMware Hypervisor/vmware.hv.datastore.size[{$URL},Template VM VMware Hypervisor,{#DATASTORE},pfree],5m)<=20</p><p>**Recovery expression**: </p>|disaster|
