...
|----|-----------|----------|--------|
|{HOST.NAME}: Line {#SNMPINDEX} load is greater than  > 60%|<p>-</p>|<p>**Expression**: {Delta UPS SNMP v1:upsOutputPercentLoad.[{#SNMPVALUE}].avg(5m)}>60</p><p>**Recovery expression**: </p>|average|
|{HOST.NAME}: Line {#SNMPINDEX} load is greater than  > 80%|<p>-</p>|<p>**Expression**: {Delta UPS SNMP v1:upsOutputPercentLoad.[{#SNMPVALUE}].avg(5m)}>80</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME}: Line {#SNMPINDEX} load is greater than  > 60% (LLD)|<p>-</p>|<p>**Expression**: {Delta UPS SNMP v1:upsOutputPercentLoad.[{#SNMPVALUE}].avg(5m)}>60</p><p>**Recovery expression**: </p>|average|
|{HOST.NAME}: Line {#SNMPINDEX} load is greater than  > 80% (LLD)|<p>-</p>|<p>**Expression**: {Delta UPS SNMP v1:upsOutputPercentLoad.[{#SNMPVALUE}].avg(5m)}>80</p><p>**Recovery expression**: </p>|high|
