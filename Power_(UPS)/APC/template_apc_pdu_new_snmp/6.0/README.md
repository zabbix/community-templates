...
|----|-----------|----------|--------|
|Outlet {#SNMPVALUE} State Change|<p>-</p>|<p>**Expression**: (last(/SNMP APC PDU/rPDU2OutletSwitchedStatusState[{#SNMPINDEX}],#1)<>last(/SNMP APC PDU/rPDU2OutletSwitchedStatusState[{#SNMPINDEX}],#2))=1</p><p>**Recovery expression**: </p>|information|
