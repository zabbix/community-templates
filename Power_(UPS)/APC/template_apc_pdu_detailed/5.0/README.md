...
|----|-----------|----------|--------|
|Outlet {#SNMPVALUE} State Change|<p>-</p>|<p>**Expression**: {APC PDU:rPDU2OutletSwitchedStatusState[{#SNMPINDEX}].diff()}=1</p><p>**Recovery expression**: </p>|information|
|Outlet {#SNMPVALUE} State Change (LLD)|<p>-</p>|<p>**Expression**: {APC PDU:rPDU2OutletSwitchedStatusState[{#SNMPINDEX}].diff()}=1</p><p>**Recovery expression**: </p>|information|
