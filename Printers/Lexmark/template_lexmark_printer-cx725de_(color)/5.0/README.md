...
|----|-----------|----|----|
|Color Imaging Kit Level|<p>-</p>|`SNMP agent`|ColorImagingKitLevel<p>Update: 3600</p>|
...
|Color Imaging Kit capacity|<p>-</p>|`SNMP agent`|ColorImagingKitCapacity<p>Update: 3600</p>|
...
|Block Imaging Unit Level|<p>-</p>|`SNMP agent`|BlockImagingUnitLevel<p>Update: 3600</p>|
...
|Printer Error Code|<p>-</p>|`SNMP agent`|PrinterErrorCode<p>Update: 60s</p>|
