...
|----|-----------|----------|--------|
|Interface {#IFNAME}({#IFALIAS}): Ethernet has changed to lower speed than it was before|<p>This Ethernet connection has transitioned down from its known maximum speed. This might be a sign of autonegotiation issues. Ack to close.</p>|<p>**Expression**: change(/Module Interfaces SNMPv3/net.if.speedV3[ifHighSpeed.{#SNMPINDEX}])<0 and last(/Module Interfaces SNMPv3/net.if.speedV3[ifHighSpeed.{#SNMPINDEX}])>0 and ( last(/Module Interfaces SNMPv3/net.if.type[ifTypeV3.{#SNMPINDEX}])=6 or last(/Module Interfaces SNMPv3/net.if.type[ifTypeV3.{#SNMPINDEX}])=7 or last(/Module Interfaces SNMPv3/net.if.type[ifTypeV3.{#SNMPINDEX}])=11 or last(/Module Interfaces SNMPv3/net.if.type[ifTypeV3.{#SNMPINDEX}])=62 or last(/Module Interfaces SNMPv3/net.if.type[ifTypeV3.{#SNMPINDEX}])=69 or last(/Module Interfaces SNMPv3/net.if.type[ifTypeV3.{#SNMPINDEX}])=117 ) and (last(/Module Interfaces SNMPv3/net.if.statusV3[ifOperStatus.{#SNMPINDEX}])<>2)</p><p>**Recovery expression**: (change(/Module Interfaces SNMPv3/net.if.speedV3[ifHighSpeed.{#SNMPINDEX}])>0 and last(/Module Interfaces SNMPv3/net.if.speedV3[ifHighSpeed.{#SNMPINDEX}],#2)>0) or (last(/Module Interfaces SNMPv3/net.if.statusV3[ifOperStatus.{#SNMPINDEX}])=2)</p>|information|
|Interface {#IFNAME}({#IFALIAS}): High bandwidth usage ( > {$IF.UTIL.MAX:"{#IFNAME}"}% )|<p>The network interface utilization is close to its estimated maximum bandwidth.</p>|<p>**Expression**: (avg(/Module Interfaces SNMPv3/net.if.inV3[ifHCInOctets.{#SNMPINDEX}],15m)>(90/100)*last(/Module Interfaces SNMPv3/net.if.speedV3[ifHighSpeed.{#SNMPINDEX}]) or avg(/Module Interfaces SNMPv3/net.if.outV3[ifHCOutOctets.{#SNMPINDEX}],15m)>(90/100)*last(/Module Interfaces SNMPv3/net.if.speedV3[ifHighSpeed.{#SNMPINDEX}])) and last(/Module Interfaces SNMPv3/net.if.speedV3[ifHighSpeed.{#SNMPINDEX}])>0</p><p>**Recovery expression**: avg(/Module Interfaces SNMPv3/net.if.inV3[ifHCInOctets.{#SNMPINDEX}],15m)<((90-3)/100)*last(/Module Interfaces SNMPv3/net.if.speedV3[ifHighSpeed.{#SNMPINDEX}]) and avg(/Module Interfaces SNMPv3/net.if.outV3[ifHCOutOctets.{#SNMPINDEX}],15m)<((90-3)/100)*last(/Module Interfaces SNMPv3/net.if.speedV3[ifHighSpeed.{#SNMPINDEX}])</p>|warning|
|Interface {#IFNAME}({#IFALIAS}): High error rate ( > {$IF.ERRORS.WARN:"{#IFNAME}"} for 5m)|<p>Recovers when below 80% of {$IF.ERRORS.WARN:"{#IFNAME}"} threshold</p>|<p>**Expression**: min(/Module Interfaces SNMPv3/net.if.in.errorsV3[ifInErrors.{#SNMPINDEX}],5m)>2 or min(/Module Interfaces SNMPv3/net.if.out.errorsV3[ifOutErrors.{#SNMPINDEX}],5m)>2</p><p>**Recovery expression**: max(/Module Interfaces SNMPv3/net.if.in.errorsV3[ifInErrors.{#SNMPINDEX}],5m)<2*0.8 and max(/Module Interfaces SNMPv3/net.if.out.errorsV3[ifOutErrors.{#SNMPINDEX}],5m)<2*0.8</p>|warning|
...
|Interface {#IFNAME}({#IFALIAS}): High error rate ( > {$IF.ERRORS.WARN:"{#IFNAME}"} for 5m) (LLD)|<p>Recovers when below 80% of {$IF.ERRORS.WARN:"{#IFNAME}"} threshold</p>|<p>**Expression**: min(/Module Interfaces SNMPv3/net.if.in.errorsV3[ifInErrors.{#SNMPINDEX}],5m)>2 or min(/Module Interfaces SNMPv3/net.if.out.errorsV3[ifOutErrors.{#SNMPINDEX}],5m)>2</p><p>**Recovery expression**: max(/Module Interfaces SNMPv3/net.if.in.errorsV3[ifInErrors.{#SNMPINDEX}],5m)<2*0.8 and max(/Module Interfaces SNMPv3/net.if.out.errorsV3[ifOutErrors.{#SNMPINDEX}],5m)<2*0.8</p>|warning|
