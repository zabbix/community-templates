...
|Name|Description|Expression|Priority|
|----|-----------|----------|--------|
|CARD {#SNMPVALUE} {#SNMPINDEX} CPU too high!|<p>-</p>|<p>**Expression**: {SNMP Device GPON ZTE fw 1.2.5p3:cardcpu[{#SNMPINDEX}].avg(10m)}>80</p><p>**Recovery expression**: </p>|high|
|CARD {#SNMPVALUE} {#SNMPINDEX} MEMORY too high!|<p>-</p>|<p>**Expression**: {SNMP Device GPON ZTE fw 1.2.5p3:cardmem[{#SNMPINDEX}].avg(10m)}>85</p><p>**Recovery expression**: </p>|high|
|CARD {#SNMPVALUE} operational status changed|<p>-</p>|<p>**Expression**: {SNMP Device GPON ZTE fw 1.2.5p3:cardoperstat[{#SNMPINDEX}].last()}<>1</p><p>**Recovery expression**: </p>|high|
|CARD {#SNMPVALUE} standby status changed|<p>-</p>|<p>**Expression**: {SNMP Device GPON ZTE fw 1.2.5p3:cardstandby[{#SNMPINDEX}].last()}<>1 and {SNMP Device GPON ZTE fw 1.2.5p3:cardstandby[{#SNMPINDEX}].last()}<>2</p><p>**Recovery expression**: </p>|high|
|Interface {#SNMPVALUE} operational status changed|<p>-</p>|<p>**Expression**: {SNMP Device GPON ZTE fw 1.2.5p3:ifOperStatus[{#SNMPVALUE}].diff(0)}=1</p><p>**Recovery expression**: </p>|high|
|SIGNAL LOW rx 1310nm {#ONUDESC}|<p>-</p>|<p>**Expression**: {SNMP Device GPON ZTE fw 1.2.5p3:rx1310[{#SNMPINDEX}].last()}<=-30 and {SNMP Device GPON ZTE fw 1.2.5p3:rx1310[{#SNMPINDEX}].last()}<>-80</p><p>**Recovery expression**: </p>|information|
|SIGNAL LOW rx 1490nm {#ONUDESC}|<p>-</p>|<p>**Expression**: {SNMP Device GPON ZTE fw 1.2.5p3:rx1490[{#SNMPINDEX}].last()}<=6 and {SNMP Device GPON ZTE fw 1.2.5p3:rx1490[{#SNMPINDEX}].last()}<>131.07</p><p>**Recovery expression**: </p>|information|
...
|CARD {#SNMPVALUE} {#SNMPINDEX} CPU too high! (LLD)|<p>-</p>|<p>**Expression**: {SNMP Device GPON ZTE fw 1.2.5p3:cardcpu[{#SNMPINDEX}].avg(10m)}>80</p><p>**Recovery expression**: </p>|high|
|CARD {#SNMPVALUE} {#SNMPINDEX} MEMORY too high! (LLD)|<p>-</p>|<p>**Expression**: {SNMP Device GPON ZTE fw 1.2.5p3:cardmem[{#SNMPINDEX}].avg(10m)}>85</p><p>**Recovery expression**: </p>|high|
|CARD {#SNMPVALUE} operational status changed (LLD)|<p>-</p>|<p>**Expression**: {SNMP Device GPON ZTE fw 1.2.5p3:cardoperstat[{#SNMPINDEX}].last()}<>1</p><p>**Recovery expression**: </p>|high|
...
|Interface {#SNMPVALUE} operational status changed (LLD)|<p>-</p>|<p>**Expression**: {SNMP Device GPON ZTE fw 1.2.5p3:ifOperStatus[{#SNMPVALUE}].diff(0)}=1</p><p>**Recovery expression**: </p>|high|
