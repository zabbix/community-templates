...
|----|-----------|----------|--------|
|Error(s) was detected on {#SNMPVALUE}|<p>-</p>|<p>**Expression**: last(/KHP-BROCADE-FC-PORT/swFCPortRxCrcs[{#SNMPVALUE}])>0 or avg(/KHP-BROCADE-FC-PORT/swFCPortRxBadEofs[{#SNMPVALUE}],1s)>0 or avg(/KHP-BROCADE-FC-PORT/swFCPortRxEncOutFrs[{#SNMPVALUE}],1s)>0 or avg(/KHP-BROCADE-FC-PORT/swFCPortRxTooLongs[{#SNMPVALUE}],1s)>0 or avg(/KHP-BROCADE-FC-PORT/swFCPortRxTruncs[{#SNMPVALUE}],1s)>0</p><p>**Recovery expression**: </p>|average|
|Operational status {HOST.NAME} has changed on port {#SNMPVALUE}|<p>-</p>|<p>**Expression**: last(/KHP-BROCADE-FC-PORT/swFcPortAdmStatus[{#SNMPVALUE}],#2)<1 and last(/KHP-BROCADE-FC-PORT/swFCPortOpStatus[{#SNMPVALUE}],#2)<>1</p><p>**Recovery expression**: </p>|average|
|Error(s) was detected on {#SNMPVALUE} (LLD)|<p>-</p>|<p>**Expression**: last(/KHP-BROCADE-FC-PORT/swFCPortRxCrcs[{#SNMPVALUE}])>0 or avg(/KHP-BROCADE-FC-PORT/swFCPortRxBadEofs[{#SNMPVALUE}],1s)>0 or avg(/KHP-BROCADE-FC-PORT/swFCPortRxEncOutFrs[{#SNMPVALUE}],1s)>0 or avg(/KHP-BROCADE-FC-PORT/swFCPortRxTooLongs[{#SNMPVALUE}],1s)>0 or avg(/KHP-BROCADE-FC-PORT/swFCPortRxTruncs[{#SNMPVALUE}],1s)>0</p><p>**Recovery expression**: </p>|average|
|Operational status {HOST.NAME} has changed on port {#SNMPVALUE} (LLD)|<p>-</p>|<p>**Expression**: last(/KHP-BROCADE-FC-PORT/swFcPortAdmStatus[{#SNMPVALUE}],#2)<1 and last(/KHP-BROCADE-FC-PORT/swFCPortOpStatus[{#SNMPVALUE}],#2)<>1</p><p>**Recovery expression**: </p>|average|
