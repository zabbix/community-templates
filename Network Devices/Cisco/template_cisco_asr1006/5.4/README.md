...
|Power Supply "{#SNMPVALUE}" is failed|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_1006/cefcFRUPowerOperStatus["{#SNMPVALUE}","Power Supply"])=8 or last(/Cisco_ASR_1006/cefcFRUPowerOperStatus["{#SNMPVALUE}","Power Supply"])=12</p><p>**Recovery expression**: </p>|high|
...
|Power Supply "{#SNMPVALUE}" is failed (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_ASR_1006/cefcFRUPowerOperStatus["{#SNMPVALUE}","Power Supply"])=8 or last(/Cisco_ASR_1006/cefcFRUPowerOperStatus["{#SNMPVALUE}","Power Supply"])=12</p><p>**Recovery expression**: </p>|high|
