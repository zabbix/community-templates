...
|Name|Description|Expression|Priority|
|----|-----------|----------|--------|
|BGP Peer "{#SNMPINDEX}"->"{#SNMPVALUE}" State changed|<p>-</p>|<p>**Expression**: {Template_Cisco_2960:snmptrap["(bgpEstablished|bgpBackwardTransition|cbgpFsmStateChange).*bgpPeerState .{#SNMPINDEX}[[:space:]][a-zA-Z]+[[:space:]]"].nodata(10m)}=0</p><p>**Recovery expression**: </p>|average|
|BGP Peer "{#SNMPINDEX}"->"{#SNMPVALUE}" State changed|<p>-</p>|<p>**Expression**: {Template_Cisco_2960:snmptrap["(bgpBackwardTransition|cbgpFsmStateChange).*bgpPeerState .{#SNMPINDEX}[[:space:]][a-zA-Z]+[[:space:]]"].nodata(10m)}=0</p><p>**Recovery expression**: </p>|average|
|OSPF Interface "{#SNMPVALUE}" State has been changed|<p>-</p>|<p>**Expression**: {Template_Cisco_2960:snmptrap["ospfIfStateChange.+ospfIfIpAddress[[:space:]]{#SNMPVALUE}[[:space:]].+ospfIfState[[:space:]][a-zA-Z]+"].nodata(10m)}=0</p><p>**Recovery expression**: </p>|average|
|OSPF Neighbor {#SNMPVALUE} has been changed|<p>-</p>|<p>**Expression**: {Template_Cisco_2960:snmptrap["(ospfNbrStateChange).*ospfNbrIpAddr[[:space:]]{#SNMPVALUE}[[:space:]].*[[:space:]][a-zA-Z]+[[:space:]]$"].nodata(10m)}=0</p><p>**Recovery expression**: </p>|average|
|High CPU #{#SNMPINDEX} Usage|<p>-</p>|<p>**Expression**: {Template_Cisco_2960:cpmCPUTotal5minRev[{#SNMPINDEX}].last()}>95</p><p>**Recovery expression**: </p>|high|
|Status of FAN "{#SNMPVALUE}" is critical|<p>-</p>|<p>**Expression**: {Template_Cisco_2960:ciscoEnvMonFanState["{#SNMPVALUE}"].last()}=3</p><p>**Recovery expression**: </p>|average|
|Status of FAN "{#SNMPVALUE}" is non-operable|<p>-</p>|<p>**Expression**: {Template_Cisco_2960:ciscoEnvMonFanState["{#SNMPVALUE}"].last()}=2</p><p>**Recovery expression**: </p>|warning|
|Status of FAN "{#SNMPVALUE}" is not functioning|<p>-</p>|<p>**Expression**: {Template_Cisco_2960:ciscoEnvMonFanState["{#SNMPVALUE}"].last()}=6</p><p>**Recovery expression**: </p>|average|
|Status of FAN "{#SNMPVALUE}" is shutdown|<p>-</p>|<p>**Expression**: {Template_Cisco_2960:ciscoEnvMonFanState["{#SNMPVALUE}"].last()}=4</p><p>**Recovery expression**: </p>|high|
|High utilization of Memory Pool "{#SNMPVALUE}"|<p>-</p>|<p>**Expression**: {Template_Cisco_2960:ciscoMemoryPoolUsed["{#SNMPVALUE}"].last()}>{Template_Cisco_2960:ciscoMemoryPoolTotal["{#SNMPVALUE}"].last()}*0.9</p><p>**Recovery expression**: </p>|average|
|Status of Power Supply "{#SNMPVALUE}" is critical|<p>-</p>|<p>**Expression**: {Template_Cisco_2960:ciscoEnvMonSupplyState["{#SNMPVALUE}"].last()}=3</p><p>**Recovery expression**: </p>|average|
|Status of Power Supply "{#SNMPVALUE}" is non-operable|<p>-</p>|<p>**Expression**: {Template_Cisco_2960:ciscoEnvMonSupplyState["{#SNMPVALUE}"].last()}=2</p><p>**Recovery expression**: </p>|warning|
|Status of Power Supply "{#SNMPVALUE}" is not functioning|<p>-</p>|<p>**Expression**: {Template_Cisco_2960:ciscoEnvMonSupplyState["{#SNMPVALUE}"].last()}=6</p><p>**Recovery expression**: </p>|average|
|Status of Power Supply "{#SNMPVALUE}" is shutdown|<p>-</p>|<p>**Expression**: {Template_Cisco_2960:ciscoEnvMonSupplyState["{#SNMPVALUE}"].last()}=4</p><p>**Recovery expression**: </p>|high|
|OSPF Neighbor {#SNMPVALUE} has been changed (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_2960:snmptrap["(ospfNbrStateChange).*ospfNbrIpAddr[[:space:]]{#SNMPVALUE}[[:space:]].*[[:space:]][a-zA-Z]+[[:space:]]$"].nodata(10m)}=0</p><p>**Recovery expression**: </p>|average|
|High CPU #{#SNMPINDEX} Usage (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_2960:cpmCPUTotal5minRev[{#SNMPINDEX}].last()}>95</p><p>**Recovery expression**: </p>|high|
|High utilization of Memory Pool "{#SNMPVALUE}" (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_2960:ciscoMemoryPoolUsed["{#SNMPVALUE}"].last()}>{Template_Cisco_2960:ciscoMemoryPoolTotal["{#SNMPVALUE}"].last()}*0.9</p><p>**Recovery expression**: </p>|average|
|BGP Peer "{#SNMPINDEX}"->"{#SNMPVALUE}" State changed (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_2960:snmptrap["(bgpEstablished|bgpBackwardTransition|cbgpFsmStateChange).*bgpPeerState .{#SNMPINDEX}[[:space:]][a-zA-Z]+[[:space:]]"].nodata(10m)}=0</p><p>**Recovery expression**: </p>|average|
|BGP Peer "{#SNMPINDEX}"->"{#SNMPVALUE}" State changed (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_2960:snmptrap["(bgpBackwardTransition|cbgpFsmStateChange).*bgpPeerState .{#SNMPINDEX}[[:space:]][a-zA-Z]+[[:space:]]"].nodata(10m)}=0</p><p>**Recovery expression**: </p>|average|
|OSPF Interface "{#SNMPVALUE}" State has been changed (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_2960:snmptrap["ospfIfStateChange.+ospfIfIpAddress[[:space:]]{#SNMPVALUE}[[:space:]].+ospfIfState[[:space:]][a-zA-Z]+"].nodata(10m)}=0</p><p>**Recovery expression**: </p>|average|
|Status of FAN "{#SNMPVALUE}" is critical (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_2960:ciscoEnvMonFanState["{#SNMPVALUE}"].last()}=3</p><p>**Recovery expression**: </p>|average|
|Status of FAN "{#SNMPVALUE}" is non-operable (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_2960:ciscoEnvMonFanState["{#SNMPVALUE}"].last()}=2</p><p>**Recovery expression**: </p>|warning|
|Status of FAN "{#SNMPVALUE}" is not functioning (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_2960:ciscoEnvMonFanState["{#SNMPVALUE}"].last()}=6</p><p>**Recovery expression**: </p>|average|
|Status of FAN "{#SNMPVALUE}" is shutdown (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_2960:ciscoEnvMonFanState["{#SNMPVALUE}"].last()}=4</p><p>**Recovery expression**: </p>|high|
|Status of Power Supply "{#SNMPVALUE}" is critical (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_2960:ciscoEnvMonSupplyState["{#SNMPVALUE}"].last()}=3</p><p>**Recovery expression**: </p>|average|
|Status of Power Supply "{#SNMPVALUE}" is non-operable (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_2960:ciscoEnvMonSupplyState["{#SNMPVALUE}"].last()}=2</p><p>**Recovery expression**: </p>|warning|
|Status of Power Supply "{#SNMPVALUE}" is not functioning (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_2960:ciscoEnvMonSupplyState["{#SNMPVALUE}"].last()}=6</p><p>**Recovery expression**: </p>|average|
|Status of Power Supply "{#SNMPVALUE}" is shutdown (LLD)|<p>-</p>|<p>**Expression**: {Template_Cisco_2960:ciscoEnvMonSupplyState["{#SNMPVALUE}"].last()}=4</p><p>**Recovery expression**: </p>|high|
