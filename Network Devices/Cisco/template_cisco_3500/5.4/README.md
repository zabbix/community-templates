...
|Name|Description|Expression|Priority|
|----|-----------|----------|--------|
|BGP Peer "{#SNMPINDEX}"->"{#SNMPVALUE}" State changed|<p>-</p>|<p>**Expression**: nodata(/Cisco_3500/snmptrap["(bgpEstablished|bgpBackwardTransition|cbgpFsmStateChange).*bgpPeerState .{#SNMPINDEX}[[:space:]][a-zA-Z]+[[:space:]]"],10m)=0</p><p>**Recovery expression**: </p>|average|
|BGP Peer "{#SNMPINDEX}"->"{#SNMPVALUE}" State changed|<p>-</p>|<p>**Expression**: nodata(/Cisco_3500/snmptrap["(bgpBackwardTransition|cbgpFsmStateChange).*bgpPeerState .{#SNMPINDEX}[[:space:]][a-zA-Z]+[[:space:]]"],10m)=0</p><p>**Recovery expression**: </p>|average|
|OSPF Interface "{#SNMPVALUE}" State has been changed|<p>-</p>|<p>**Expression**: nodata(/Cisco_3500/snmptrap["ospfIfStateChange.+ospfIfIpAddress[[:space:]]{#SNMPVALUE}[[:space:]].+ospfIfState[[:space:]][a-zA-Z]+"],10m)=0</p><p>**Recovery expression**: </p>|average|
|OSPF Neighbor {#SNMPVALUE} has been changed|<p>-</p>|<p>**Expression**: nodata(/Cisco_3500/snmptrap["(ospfNbrStateChange).*ospfNbrIpAddr[[:space:]]{#SNMPVALUE}[[:space:]].*[[:space:]][a-zA-Z]+[[:space:]]$"],10m)=0</p><p>**Recovery expression**: </p>|average|
|High CPU #{#SNMPINDEX} Usage|<p>-</p>|<p>**Expression**: last(/Cisco_3500/cpmCPUTotal5minRev[{#SNMPINDEX}])>95</p><p>**Recovery expression**: </p>|high|
|Status of FAN "{#SNMPVALUE}" is critical|<p>-</p>|<p>**Expression**: last(/Cisco_3500/ciscoEnvMonFanState["{#SNMPVALUE}"])=3</p><p>**Recovery expression**: </p>|average|
|Status of FAN "{#SNMPVALUE}" is non-operable|<p>-</p>|<p>**Expression**: last(/Cisco_3500/ciscoEnvMonFanState["{#SNMPVALUE}"])=2</p><p>**Recovery expression**: </p>|warning|
|Status of FAN "{#SNMPVALUE}" is not functioning|<p>-</p>|<p>**Expression**: last(/Cisco_3500/ciscoEnvMonFanState["{#SNMPVALUE}"])=6</p><p>**Recovery expression**: </p>|average|
|Status of FAN "{#SNMPVALUE}" is shutdown|<p>-</p>|<p>**Expression**: last(/Cisco_3500/ciscoEnvMonFanState["{#SNMPVALUE}"])=4</p><p>**Recovery expression**: </p>|high|
|High utilization of Memory Pool "{#SNMPVALUE}"|<p>-</p>|<p>**Expression**: last(/Cisco_3500/ciscoMemoryPoolUsed["{#SNMPVALUE}"])>last(/Cisco_3500/ciscoMemoryPoolTotal["{#SNMPVALUE}"])*0.9</p><p>**Recovery expression**: </p>|average|
|Status of Power Supply "{#SNMPVALUE}" is critical|<p>-</p>|<p>**Expression**: last(/Cisco_3500/ciscoEnvMonSupplyState["{#SNMPVALUE}"])=3</p><p>**Recovery expression**: </p>|average|
|Status of Power Supply "{#SNMPVALUE}" is non-operable|<p>-</p>|<p>**Expression**: last(/Cisco_3500/ciscoEnvMonSupplyState["{#SNMPVALUE}"])=2</p><p>**Recovery expression**: </p>|warning|
|Status of Power Supply "{#SNMPVALUE}" is not functioning|<p>-</p>|<p>**Expression**: last(/Cisco_3500/ciscoEnvMonSupplyState["{#SNMPVALUE}"])=6</p><p>**Recovery expression**: </p>|average|
|Status of Power Supply "{#SNMPVALUE}" is shutdown|<p>-</p>|<p>**Expression**: last(/Cisco_3500/ciscoEnvMonSupplyState["{#SNMPVALUE}"])=4</p><p>**Recovery expression**: </p>|high|
|Status of Temperature "{#SNMPVALUE}" is critical|<p>-</p>|<p>**Expression**: last(/Cisco_3500/ciscoEnvMonTemperatureState["{#SNMPVALUE}"])=3</p><p>**Recovery expression**: </p>|average|
|Status of Temperature "{#SNMPVALUE}" is non-operable|<p>-</p>|<p>**Expression**: last(/Cisco_3500/ciscoEnvMonTemperatureState["{#SNMPVALUE}"])=2</p><p>**Recovery expression**: </p>|warning|
|Status of Temperature "{#SNMPVALUE}" is not functioning|<p>-</p>|<p>**Expression**: last(/Cisco_3500/ciscoEnvMonTemperatureState["{#SNMPVALUE}"])=6</p><p>**Recovery expression**: </p>|average|
|Status of Temperature "{#SNMPVALUE}" is shutdown|<p>-</p>|<p>**Expression**: last(/Cisco_3500/ciscoEnvMonTemperatureState["{#SNMPVALUE}"])=4</p><p>**Recovery expression**: </p>|high|
|OSPF Neighbor {#SNMPVALUE} has been changed (LLD)|<p>-</p>|<p>**Expression**: nodata(/Cisco_3500/snmptrap["(ospfNbrStateChange).*ospfNbrIpAddr[[:space:]]{#SNMPVALUE}[[:space:]].*[[:space:]][a-zA-Z]+[[:space:]]$"],10m)=0</p><p>**Recovery expression**: </p>|average|
|Status of Temperature "{#SNMPVALUE}" is critical (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_3500/ciscoEnvMonTemperatureState["{#SNMPVALUE}"])=3</p><p>**Recovery expression**: </p>|average|
|Status of Temperature "{#SNMPVALUE}" is non-operable (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_3500/ciscoEnvMonTemperatureState["{#SNMPVALUE}"])=2</p><p>**Recovery expression**: </p>|warning|
|Status of Temperature "{#SNMPVALUE}" is not functioning (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_3500/ciscoEnvMonTemperatureState["{#SNMPVALUE}"])=6</p><p>**Recovery expression**: </p>|average|
|Status of Temperature "{#SNMPVALUE}" is shutdown (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_3500/ciscoEnvMonTemperatureState["{#SNMPVALUE}"])=4</p><p>**Recovery expression**: </p>|high|
|OSPF Interface "{#SNMPVALUE}" State has been changed (LLD)|<p>-</p>|<p>**Expression**: nodata(/Cisco_3500/snmptrap["ospfIfStateChange.+ospfIfIpAddress[[:space:]]{#SNMPVALUE}[[:space:]].+ospfIfState[[:space:]][a-zA-Z]+"],10m)=0</p><p>**Recovery expression**: </p>|average|
|BGP Peer "{#SNMPINDEX}"->"{#SNMPVALUE}" State changed (LLD)|<p>-</p>|<p>**Expression**: nodata(/Cisco_3500/snmptrap["(bgpEstablished|bgpBackwardTransition|cbgpFsmStateChange).*bgpPeerState .{#SNMPINDEX}[[:space:]][a-zA-Z]+[[:space:]]"],10m)=0</p><p>**Recovery expression**: </p>|average|
|BGP Peer "{#SNMPINDEX}"->"{#SNMPVALUE}" State changed (LLD)|<p>-</p>|<p>**Expression**: nodata(/Cisco_3500/snmptrap["(bgpBackwardTransition|cbgpFsmStateChange).*bgpPeerState .{#SNMPINDEX}[[:space:]][a-zA-Z]+[[:space:]]"],10m)=0</p><p>**Recovery expression**: </p>|average|
|Status of Power Supply "{#SNMPVALUE}" is critical (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_3500/ciscoEnvMonSupplyState["{#SNMPVALUE}"])=3</p><p>**Recovery expression**: </p>|average|
|Status of Power Supply "{#SNMPVALUE}" is non-operable (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_3500/ciscoEnvMonSupplyState["{#SNMPVALUE}"])=2</p><p>**Recovery expression**: </p>|warning|
|Status of Power Supply "{#SNMPVALUE}" is not functioning (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_3500/ciscoEnvMonSupplyState["{#SNMPVALUE}"])=6</p><p>**Recovery expression**: </p>|average|
|Status of Power Supply "{#SNMPVALUE}" is shutdown (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_3500/ciscoEnvMonSupplyState["{#SNMPVALUE}"])=4</p><p>**Recovery expression**: </p>|high|
|High utilization of Memory Pool "{#SNMPVALUE}" (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_3500/ciscoMemoryPoolUsed["{#SNMPVALUE}"])>last(/Cisco_3500/ciscoMemoryPoolTotal["{#SNMPVALUE}"])*0.9</p><p>**Recovery expression**: </p>|average|
|Status of FAN "{#SNMPVALUE}" is critical (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_3500/ciscoEnvMonFanState["{#SNMPVALUE}"])=3</p><p>**Recovery expression**: </p>|average|
|Status of FAN "{#SNMPVALUE}" is non-operable (LLD)|<p>-</p>|<p>**Expression**: last(/Cisco_3500/ciscoEnvMonFanState["{#SNMPVALUE}"])=2</p><p>**Recovery expression**: </p>|warning|
