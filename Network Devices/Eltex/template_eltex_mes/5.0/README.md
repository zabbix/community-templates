...
|----|-----------|----------|--------|
|Error IN {HOST.NAME} interface {#SNMPVALUE}|<p>-</p>|<p>**Expression**: {Eltex MES SNMPv2:ifInErrors[{#SNMPVALUE}].last()}>0</p><p>**Recovery expression**: </p>|warning|
|Error OUT {HOST.NAME} interface {#SNMPVALUE}|<p>-</p>|<p>**Expression**: {Eltex MES SNMPv2:ifOutErrors[{#SNMPVALUE}].last()}>0</p><p>**Recovery expression**: </p>|warning|
|Operational status was changed on {HOST.NAME} interface {#SNMPVALUE}|<p>-</p>|<p>**Expression**: {Eltex MES SNMPv2:ifOperStatus[{#SNMPVALUE}].diff(0)}=1</p><p>**Recovery expression**: </p>|information|
|Utilization > 50% IN {HOST.NAME} interface {#SNMPVALUE} ({#IFNAME})|<p>-</p>|<p>**Expression**: ({Eltex MES SNMPv2:ifHCInOctets[{#SNMPVALUE}].avg(5m)}*0.000001)>({Eltex MES SNMPv2:speed_on_[{#SNMPVALUE}].last()}/2) or ({Eltex MES SNMPv2:ifHCOutOctets[{#SNMPVALUE}].avg(5m)}*0.000001)>({Eltex MES SNMPv2:speed_on_[{#SNMPVALUE}].last()}/2)</p><p>**Recovery expression**: </p>|warning|
|Затухание на SFP порту {#SNMPVALUE}|<p>Потери мощности на оптической линии.</p>|<p>**Expression**: {Eltex MES SNMPv2:rlPhyTestGetResult.InPow[{#SNMPVALUE}].avg(5m)}<({Eltex MES SNMPv2:rlPhyTestGetResult.OutPow[{#SNMPVALUE}].avg(5m)}*2)</p><p>**Recovery expression**: </p>|average|
|Error IN {HOST.NAME} interface {#SNMPVALUE} (LLD)|<p>-</p>|<p>**Expression**: {Eltex MES SNMPv2:ifInErrors[{#SNMPVALUE}].last()}>0</p><p>**Recovery expression**: </p>|warning|
|Error OUT {HOST.NAME} interface {#SNMPVALUE} (LLD)|<p>-</p>|<p>**Expression**: {Eltex MES SNMPv2:ifOutErrors[{#SNMPVALUE}].last()}>0</p><p>**Recovery expression**: </p>|warning|
|Operational status was changed on {HOST.NAME} interface {#SNMPVALUE} (LLD)|<p>-</p>|<p>**Expression**: {Eltex MES SNMPv2:ifOperStatus[{#SNMPVALUE}].diff(0)}=1</p><p>**Recovery expression**: </p>|information|
|Utilization > 50% IN {HOST.NAME} interface {#SNMPVALUE} ({#IFNAME}) (LLD)|<p>-</p>|<p>**Expression**: ({Eltex MES SNMPv2:ifHCInOctets[{#SNMPVALUE}].avg(5m)}*0.000001)>({Eltex MES SNMPv2:speed_on_[{#SNMPVALUE}].last()}/2) or ({Eltex MES SNMPv2:ifHCOutOctets[{#SNMPVALUE}].avg(5m)}*0.000001)>({Eltex MES SNMPv2:speed_on_[{#SNMPVALUE}].last()}/2)</p><p>**Recovery expression**: </p>|warning|
|Затухание на SFP порту {#SNMPVALUE} (LLD)|<p>Потери мощности на оптической линии.</p>|<p>**Expression**: {Eltex MES SNMPv2:rlPhyTestGetResult.InPow[{#SNMPVALUE}].avg(5m)}<({Eltex MES SNMPv2:rlPhyTestGetResult.OutPow[{#SNMPVALUE}].avg(5m)}*2)</p><p>**Recovery expression**: </p>|average|
