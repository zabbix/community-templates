...
|----|-----------|----------|--------|
|Состояние NTE [{#SNMPVALUE}] (OLT:{ITEM.VALUE2}/{ITEM.VALUE3}) - "Unconfigured" (Уровень:{ITEM.LASTVALUE4})|<p>-</p>|<p>**Expression**: {Eltex LTE-8X:StateState.[{#SNMPINDEX}].last()}=14 and {Eltex LTE-8X:StateOLTID.[{#SNMPINDEX}].last()}>=0 and {Eltex LTE-8X:StateOLTPort.[{#SNMPINDEX}].last()}>=0 and {Eltex LTE-8X:LaserPower.dBm[{#SNMPINDEX}].last()}>-35</p><p>**Recovery expression**: </p>|information|
|Состояние NTE [{#SNMPVALUE}]  (OLT:{ITEM.VALUE3}/{ITEM.VALUE4} ID:{ITEM.VALUE2}) - "Blocked"|<p>-</p>|<p>**Expression**: {Eltex LTE-8X:StateState.[{#SNMPINDEX}].last()}=12 and {Eltex LTE-8X:StateID.[{#SNMPINDEX}].last()}>=0 and {Eltex LTE-8X:StateOLTID.[{#SNMPINDEX}].last()}>=0 and {Eltex LTE-8X:StateOLTPort.[{#SNMPINDEX}].last()}>=0</p><p>**Recovery expression**: </p>|average|
|Уровень ONT [{#SNMPVALUE}] {ITEM.LASTVALUE1} (OLT:{ITEM.VALUE3}/{ITEM.VALUE4} ID:{ITEM.VALUE2}) !|<p>-</p>|<p>**Expression**: {Eltex LTE-8X:LaserPower.dBm[{#SNMPINDEX}].max(300)}<-29 and {Eltex LTE-8X:StateID.[{#SNMPINDEX}].last()}>=0 and {Eltex LTE-8X:StateOLTID.[{#SNMPINDEX}].last()}>=0 and {Eltex LTE-8X:StateOLTPort.[{#SNMPINDEX}].last()}>=0</p><p>**Recovery expression**: </p>|average|
|Состояние NTE [{#SNMPVALUE}] (OLT:{ITEM.VALUE2}/{ITEM.VALUE3}) - "Unconfigured" (Уровень:{ITEM.LASTVALUE4}) (LLD)|<p>-</p>|<p>**Expression**: {Eltex LTE-8X:StateState.[{#SNMPINDEX}].last()}=14 and {Eltex LTE-8X:StateOLTID.[{#SNMPINDEX}].last()}>=0 and {Eltex LTE-8X:StateOLTPort.[{#SNMPINDEX}].last()}>=0 and {Eltex LTE-8X:LaserPower.dBm[{#SNMPINDEX}].last()}>-35</p><p>**Recovery expression**: </p>|information|
|Состояние NTE [{#SNMPVALUE}]  (OLT:{ITEM.VALUE3}/{ITEM.VALUE4} ID:{ITEM.VALUE2}) - "Blocked" (LLD)|<p>-</p>|<p>**Expression**: {Eltex LTE-8X:StateState.[{#SNMPINDEX}].last()}=12 and {Eltex LTE-8X:StateID.[{#SNMPINDEX}].last()}>=0 and {Eltex LTE-8X:StateOLTID.[{#SNMPINDEX}].last()}>=0 and {Eltex LTE-8X:StateOLTPort.[{#SNMPINDEX}].last()}>=0</p><p>**Recovery expression**: </p>|average|
|Уровень ONT [{#SNMPVALUE}] {ITEM.LASTVALUE1} (OLT:{ITEM.VALUE3}/{ITEM.VALUE4} ID:{ITEM.VALUE2}) ! (LLD)|<p>-</p>|<p>**Expression**: {Eltex LTE-8X:LaserPower.dBm[{#SNMPINDEX}].max(300)}<-29 and {Eltex LTE-8X:StateID.[{#SNMPINDEX}].last()}>=0 and {Eltex LTE-8X:StateOLTID.[{#SNMPINDEX}].last()}>=0 and {Eltex LTE-8X:StateOLTPort.[{#SNMPINDEX}].last()}>=0</p><p>**Recovery expression**: </p>|average|
