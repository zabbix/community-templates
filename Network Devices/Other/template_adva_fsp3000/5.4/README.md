...
|----|-----------|----------|--------|
|{HOST.NAME}  High Temperature on {#SNMPVALUE2}|<p>-</p>|<p>**Expression**: last(/Adva SNMP Autodiscovery/faeqptPhysInstValueTemp[{#SNMPVALUE},{#SNMPVALUE2}])>75</p><p>**Recovery expression**: </p>|warning|
|{HOST.NAME}  operational state problem on {#SNMPVALUE2}|<p>-</p>|<p>**Expression**: last(/Adva SNMP Autodiscovery/famoduleOperState[{#SNMPVALUE},{#SNMPVALUE2}])>1</p><p>**Recovery expression**: </p>|warning|
|{HOST.NAME} Operational state problem on   {#SNMPVALUE}|<p>-</p>|<p>**Expression**: last(/Adva SNMP Autodiscovery/faentityStateOper[{#SNMPVALUE}])<>1</p><p>**Recovery expression**: </p>|warning|
|{HOST.NAME}  Input Power too high on  {#SNMPVALUE}|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmOptInputPwrReceivedTooHi.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME}  Input Power too low on  {#SNMPVALUE}|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmOptInputPwrReceivedTooL.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME}  Laser near to end of Life  on {#SNMPVALUE}|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmLaserEndOfLi.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|disaster|
|{HOST.NAME}  Loss of signal on  {#SNMPVALUE}|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmLossOfSign.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} Output Power too high on  {#SNMPVALUE}|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmOptOutputPowerTransTooHi.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} Output Power too low on  {#SNMPVALUE}|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmOptOutputPowerTransTooL.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME}  operational state problem on {#SNMPVALUE2}|<p>-</p>|<p>**Expression**: last(/Adva SNMP Autodiscovery/FanOperState[{#SNMPVALUE},{#SNMPVALUE2}])<>1</p><p>**Recovery expression**: </p>|warning|
|{HOST.NAME}  Input Power too high on  {#SNMPVALUE}|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmOptInputPwrReceivedTooHigh.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME}  Input Power too low on  {#SNMPVALUE}|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmOptInputPwrReceivedTooLow.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME}  Laser near to end of Life  on {#SNMPVALUE}|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmLaserEndOfLife.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|disaster|
|{HOST.NAME}  Loss of signal on  {#SNMPVALUE}|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmLossOfSignal.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} operational state problem on   {#SNMPVALUE}|<p>-</p>|<p>**Expression**: last(/Adva SNMP Autodiscovery/cpentityStateOper[{#SNMPVALUE}])<>1</p><p>**Recovery expression**: </p>|average|
|{HOST.NAME} Output Power too high on  {#SNMPVALUE}|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmOptOutputPowerTransTooHigh.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} Output Power too low on  {#SNMPVALUE}|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmOptOutputPowerTransTooLow.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME}  operational state problem on {#SNMPVALUE}|<p>-</p>|<p>**Expression**: last(/Adva SNMP Autodiscovery/npentityStateOper[{#SNMPVALUE}])<>1</p><p>**Recovery expression**: </p>|warning|
|{HOST.NAME}  Input Power too high on  {#SNMPVALUE}|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmOptInputPwrReceivedTooHig.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME}  Input Power too low on  {#SNMPVALUE}|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmOptInputPwrReceivedTooLo.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME}  Laser near to end of Life  on {#SNMPVALUE}|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmLaserEndOfLif.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|disaster|
|{HOST.NAME}  Loss of signal on  {#SNMPVALUE}|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmLossOfSigna.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} Output Power too high on  {#SNMPVALUE}|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmOptOutputPowerTransTooHig.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} Output Power too low on  {#SNMPVALUE}|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmOptOutputPowerTransTooLo.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME}  operational state problem on {#SNMPVALUE2}|<p>-</p>|<p>**Expression**: last(/Adva SNMP Autodiscovery/ncmoduleOperState[{#SNMPVALUE},{#SNMPVALUE2}])<>1</p><p>**Recovery expression**: </p>|warning|
|{HOSTNAME}  High Temperature on {#SNMPVALUE2}|<p>-</p>|<p>**Expression**: last(/Adva SNMP Autodiscovery/nceqptPhysInstValueTemp[{#SNMPVALUE},{#SNMPVALUE2}])>75</p><p>**Recovery expression**: </p>|warning|
|{HOST.NAME}  High Temperature on {#SNMPVALUE2}|<p>-</p>|<p>**Expression**: last(/Adva SNMP Autodiscovery/5weqptPhysInstValueTemp[{#SNMPVALUE},{#SNMPVALUE2}])>75</p><p>**Recovery expression**: </p>|warning|
|{HOST.NAME}  operational state problem on {#SNMPVALUE2}|<p>-</p>|<p>**Expression**: last(/Adva SNMP Autodiscovery/5wmoduleOperState[{#SNMPVALUE},{#SNMPVALUE2}])<>1</p><p>**Recovery expression**: </p>|warning|
|{HOST.NAME}  High Temperature on {#SNMPVALUE2}|<p>-</p>|<p>**Expression**: last(/Adva SNMP Autodiscovery/pseqptPhysInstValueTemp[{#SNMPVALUE},{#SNMPVALUE2}])>75</p><p>**Recovery expression**: </p>|warning|
|{HOST.NAME} operation state problem on {#SNMPVALUE2}|<p>-</p>|<p>**Expression**: last(/Adva SNMP Autodiscovery/psmoduleOperState[{#SNMPVALUE},{#SNMPVALUE2}])<>1</p><p>**Recovery expression**: </p>|warning|
|{HOST.NAME}  High Temperature on {#SNMPVALUE2}|<p>-</p>|<p>**Expression**: last(/Adva SNMP Autodiscovery/sceqptPhysInstValueTemp[{#SNMPVALUE},{#SNMPVALUE2}])>75</p><p>**Recovery expression**: </p>|warning|
|{HOST.NAME}  operational state problem on {#SNMPVALUE2}|<p>-</p>|<p>**Expression**: last(/Adva SNMP Autodiscovery/scmoduleOperState[{#SNMPVALUE},{#SNMPVALUE2}])<>1</p><p>**Recovery expression**: </p>|warning|
|{HOST.NAME}  Input Power too high on  {#SNMPVALUE} (LLD)|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmOptInputPwrReceivedTooHigh.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME}  Input Power too low on  {#SNMPVALUE} (LLD)|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmOptInputPwrReceivedTooLow.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME}  Laser near to end of Life  on {#SNMPVALUE} (LLD)|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmLaserEndOfLife.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|disaster|
|{HOST.NAME}  Loss of signal on  {#SNMPVALUE} (LLD)|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmLossOfSignal.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} operational state problem on   {#SNMPVALUE} (LLD)|<p>-</p>|<p>**Expression**: last(/Adva SNMP Autodiscovery/cpentityStateOper[{#SNMPVALUE}])<>1</p><p>**Recovery expression**: </p>|average|
|{HOST.NAME} Output Power too high on  {#SNMPVALUE} (LLD)|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmOptOutputPowerTransTooHigh.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} Output Power too low on  {#SNMPVALUE} (LLD)|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmOptOutputPowerTransTooLow.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME}  High Temperature on {#SNMPVALUE2} (LLD)|<p>-</p>|<p>**Expression**: last(/Adva SNMP Autodiscovery/faeqptPhysInstValueTemp[{#SNMPVALUE},{#SNMPVALUE2}])>75</p><p>**Recovery expression**: </p>|warning|
|{HOST.NAME}  operational state problem on {#SNMPVALUE2} (LLD)|<p>-</p>|<p>**Expression**: last(/Adva SNMP Autodiscovery/famoduleOperState[{#SNMPVALUE},{#SNMPVALUE2}])>1</p><p>**Recovery expression**: </p>|warning|
|{HOST.NAME} Operational state problem on   {#SNMPVALUE} (LLD)|<p>-</p>|<p>**Expression**: last(/Adva SNMP Autodiscovery/faentityStateOper[{#SNMPVALUE}])<>1</p><p>**Recovery expression**: </p>|warning|
|{HOST.NAME}  Input Power too high on  {#SNMPVALUE} (LLD)|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmOptInputPwrReceivedTooHi.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME}  Input Power too low on  {#SNMPVALUE} (LLD)|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmOptInputPwrReceivedTooL.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME}  Laser near to end of Life  on {#SNMPVALUE} (LLD)|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmLaserEndOfLi.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|disaster|
|{HOST.NAME}  Loss of signal on  {#SNMPVALUE} (LLD)|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmLossOfSign.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} Output Power too high on  {#SNMPVALUE} (LLD)|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmOptOutputPowerTransTooHi.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} Output Power too low on  {#SNMPVALUE} (LLD)|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmOptOutputPowerTransTooL.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME}  High Temperature on {#SNMPVALUE2} (LLD)|<p>-</p>|<p>**Expression**: last(/Adva SNMP Autodiscovery/pseqptPhysInstValueTemp[{#SNMPVALUE},{#SNMPVALUE2}])>75</p><p>**Recovery expression**: </p>|warning|
|{HOST.NAME} operation state problem on {#SNMPVALUE2} (LLD)|<p>-</p>|<p>**Expression**: last(/Adva SNMP Autodiscovery/psmoduleOperState[{#SNMPVALUE},{#SNMPVALUE2}])<>1</p><p>**Recovery expression**: </p>|warning|
|{HOST.NAME}  High Temperature on {#SNMPVALUE2} (LLD)|<p>-</p>|<p>**Expression**: last(/Adva SNMP Autodiscovery/5weqptPhysInstValueTemp[{#SNMPVALUE},{#SNMPVALUE2}])>75</p><p>**Recovery expression**: </p>|warning|
|{HOST.NAME}  operational state problem on {#SNMPVALUE2} (LLD)|<p>-</p>|<p>**Expression**: last(/Adva SNMP Autodiscovery/5wmoduleOperState[{#SNMPVALUE},{#SNMPVALUE2}])<>1</p><p>**Recovery expression**: </p>|warning|
|{HOST.NAME}  operational state problem on {#SNMPVALUE} (LLD)|<p>-</p>|<p>**Expression**: last(/Adva SNMP Autodiscovery/npentityStateOper[{#SNMPVALUE}])<>1</p><p>**Recovery expression**: </p>|warning|
|{HOST.NAME}  Input Power too high on  {#SNMPVALUE} (LLD)|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmOptInputPwrReceivedTooHig.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME}  Input Power too low on  {#SNMPVALUE} (LLD)|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmOptInputPwrReceivedTooLo.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME}  Laser near to end of Life  on {#SNMPVALUE} (LLD)|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmLaserEndOfLif.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|disaster|
|{HOST.NAME}  Loss of signal on  {#SNMPVALUE} (LLD)|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmLossOfSigna.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} Output Power too high on  {#SNMPVALUE} (LLD)|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmOptOutputPowerTransTooHig.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} Output Power too low on  {#SNMPVALUE} (LLD)|<p>-</p>|<p>**Expression**: find(/Adva SNMP Autodiscovery/snmptrap["ADVA-FSPR7-MIB::alarmOptOutputPowerTransTooLo.* object:{#SNMPVALUE}"],,"like","severity:6")=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME}  operational state problem on {#SNMPVALUE2} (LLD)|<p>-</p>|<p>**Expression**: last(/Adva SNMP Autodiscovery/FanOperState[{#SNMPVALUE},{#SNMPVALUE2}])<>1</p><p>**Recovery expression**: </p>|warning|
|{HOST.NAME}  operational state problem on {#SNMPVALUE2} (LLD)|<p>-</p>|<p>**Expression**: last(/Adva SNMP Autodiscovery/ncmoduleOperState[{#SNMPVALUE},{#SNMPVALUE2}])<>1</p><p>**Recovery expression**: </p>|warning|
|{HOSTNAME}  High Temperature on {#SNMPVALUE2} (LLD)|<p>-</p>|<p>**Expression**: last(/Adva SNMP Autodiscovery/nceqptPhysInstValueTemp[{#SNMPVALUE},{#SNMPVALUE2}])>75</p><p>**Recovery expression**: </p>|warning|
|{HOST.NAME}  High Temperature on {#SNMPVALUE2} (LLD)|<p>-</p>|<p>**Expression**: last(/Adva SNMP Autodiscovery/sceqptPhysInstValueTemp[{#SNMPVALUE},{#SNMPVALUE2}])>75</p><p>**Recovery expression**: </p>|warning|
|{HOST.NAME}  operational state problem on {#SNMPVALUE2} (LLD)|<p>-</p>|<p>**Expression**: last(/Adva SNMP Autodiscovery/scmoduleOperState[{#SNMPVALUE},{#SNMPVALUE2}])<>1</p><p>**Recovery expression**: </p>|warning|
