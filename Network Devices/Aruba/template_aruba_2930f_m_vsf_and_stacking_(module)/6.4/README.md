...
|Stacking Admin Status|<p>-</p>|`SNMP agent`|hpStackSwitchAdminStatus[{#SNMPINDEX}]<p>Update: 1m</p><p>LLD</p>|
|Stacking Oper Status|<p>-</p>|`SNMP agent`|hpStackSwitchOperStatus[{#SNMPINDEX}]<p>Update: 1m</p><p>LLD</p>|
...
|Stacking Admin Status disabled|<p>-</p>|<p>**Expression**: last(/HPE_Module Aruba 2930 VSF or Stacking/hpStackSwitchAdminStatus[{#SNMPINDEX}])=2</p><p>**Recovery expression**: </p>|high|
|Stacking Oper Status not active|<p>-</p>|<p>**Expression**: last(/HPE_Module Aruba 2930 VSF or Stacking/hpStackSwitchAdminStatus[{#SNMPINDEX}])<>2</p><p>**Recovery expression**: </p>|high|
...
|Stacking Admin Status disabled (LLD)|<p>-</p>|<p>**Expression**: last(/HPE_Module Aruba 2930 VSF or Stacking/hpStackSwitchAdminStatus[{#SNMPINDEX}])=2</p><p>**Recovery expression**: </p>|high|
|Stacking Oper Status not active (LLD)|<p>-</p>|<p>**Expression**: last(/HPE_Module Aruba 2930 VSF or Stacking/hpStackSwitchOperStatus[{#SNMPINDEX}])<>2</p><p>**Recovery expression**: </p>|high|
