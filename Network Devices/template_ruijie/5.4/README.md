...
|----|-----------|----------|--------|
|UE {#NUMBER} RB ERROR|<p>-</p>|<p>**Expression**: find(/Ruijie BBU/ue.dl.rb[{#NUMBER}],,"regexp","FAIL")=1</p><p>**Recovery expression**: find(/Ruijie BBU/ue.dl.rb[{#NUMBER}],,"regexp","PASS")=1</p>|average|
|UE {#NUMBER} RB ERROR (LLD)|<p>-</p>|<p>**Expression**: find(/Ruijie BBU/ue.dl.rb[{#NUMBER}],,"regexp","FAIL")=1</p><p>**Recovery expression**: find(/Ruijie BBU/ue.dl.rb[{#NUMBER}],,"regexp","PASS")=1</p>|average|
