...
|----|-----------|----------|--------|
|Livewire Audio Desination Gain for Ch.{#SNMPINDEX} was changed|<p>-</p>|<p>**Expression**: (last(/SNMP Telos ZIPStream-X2/dstAudioGain[{#SNMPINDEX}],#1)<>last(/SNMP Telos ZIPStream-X2/dstAudioGain[{#SNMPINDEX}],#2))=1</p><p>**Recovery expression**: </p>|information|
|Livewire Destination address for Ch.{#SNMPINDEX} was changed|<p>-</p>|<p>**Expression**: (last(/SNMP Telos ZIPStream-X2/dstMediaAddress[{#SNMPINDEX}],#1)<>last(/SNMP Telos ZIPStream-X2/dstMediaAddress[{#SNMPINDEX}],#2))=1</p><p>**Recovery expression**: </p>|information|
|Livewire Audio Gain for Ch.{#SNMPINDEX} was changed|<p>-</p>|<p>**Expression**: (last(/SNMP Telos ZIPStream-X2/srcAudioGain[{#SNMPINDEX}],#1)<>last(/SNMP Telos ZIPStream-X2/srcAudioGain[{#SNMPINDEX}],#2))=1</p><p>**Recovery expression**: </p>|information|
|Livewire Source address for Ch.{#SNMPINDEX} was changed|<p>-</p>|<p>**Expression**: (last(/SNMP Telos ZIPStream-X2/srcMediaAddress[{#SNMPINDEX}],#1)<>last(/SNMP Telos ZIPStream-X2/srcMediaAddress[{#SNMPINDEX}],#2))=1</p><p>**Recovery expression**: </p>|information|
|Livewire Source port {#SNMPINDEX} disabled|<p>-</p>|<p>**Expression**: last(/SNMP Telos ZIPStream-X2/srcEnable[{#SNMPINDEX}],#2)=2</p><p>**Recovery expression**: </p>|information|
|Livewire Audio Gain for Ch.{#SNMPINDEX} was changed (LLD)|<p>-</p>|<p>**Expression**: (last(/SNMP Telos ZIPStream-X2/srcAudioGain[{#SNMPINDEX}],#1)<>last(/SNMP Telos ZIPStream-X2/srcAudioGain[{#SNMPINDEX}],#2))=1</p><p>**Recovery expression**: </p>|information|
|Livewire Source address for Ch.{#SNMPINDEX} was changed (LLD)|<p>-</p>|<p>**Expression**: (last(/SNMP Telos ZIPStream-X2/srcMediaAddress[{#SNMPINDEX}],#1)<>last(/SNMP Telos ZIPStream-X2/srcMediaAddress[{#SNMPINDEX}],#2))=1</p><p>**Recovery expression**: </p>|information|
|Livewire Source port {#SNMPINDEX} disabled (LLD)|<p>-</p>|<p>**Expression**: last(/SNMP Telos ZIPStream-X2/srcEnable[{#SNMPINDEX}],#2)=2</p><p>**Recovery expression**: </p>|information|
|Livewire Audio Desination Gain for Ch.{#SNMPINDEX} was changed (LLD)|<p>-</p>|<p>**Expression**: (last(/SNMP Telos ZIPStream-X2/dstAudioGain[{#SNMPINDEX}],#1)<>last(/SNMP Telos ZIPStream-X2/dstAudioGain[{#SNMPINDEX}],#2))=1</p><p>**Recovery expression**: </p>|information|
|Livewire Destination address for Ch.{#SNMPINDEX} was changed (LLD)|<p>-</p>|<p>**Expression**: (last(/SNMP Telos ZIPStream-X2/dstMediaAddress[{#SNMPINDEX}],#1)<>last(/SNMP Telos ZIPStream-X2/dstMediaAddress[{#SNMPINDEX}],#2))=1</p><p>**Recovery expression**: </p>|information|
