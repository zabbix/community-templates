...
|----|-----------|----------|--------|
|Free disk space is less than 10% on volume {#SNMPINDEX}|<p>-</p>|<p>**Expression**: {Template SNMP OS ESXi:hrStorageUsedBlocks[{#SNMPINDEX}].last(0)} / {Template SNMP OS ESXi:hrStorageSizeBlocks[{#SNMPINDEX}].last(0)} > 0.9</p><p>**Recovery expression**: </p>|average|
|Free disk space is less than 20% on volume {#SNMPINDEX}|<p>-</p>|<p>**Expression**: {Template SNMP OS ESXi:hrStorageUsedBlocks[{#SNMPINDEX}].last(0)} / {Template SNMP OS ESXi:hrStorageSizeBlocks[{#SNMPINDEX}].last(0)} > 0.8</p><p>**Recovery expression**: </p>|warning|
|Available Memory is less than 10% on $1|<p>-</p>|<p>**Expression**: {Template SNMP OS ESXi:hrMemoryUsed[{#SNMPINDEX}].last(0)} / {Template SNMP OS ESXi:hrMemoryTotal[{#SNMPINDEX}].last(0)} > 0.9</p><p>**Recovery expression**: </p>|high|
...
|Free disk space is less than 10% on volume {#SNMPINDEX} (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP OS ESXi:hrStorageUsedBlocks[{#SNMPINDEX}].last(0)} / {Template SNMP OS ESXi:hrStorageSizeBlocks[{#SNMPINDEX}].last(0)} > 0.9</p><p>**Recovery expression**: </p>|average|
|Free disk space is less than 20% on volume {#SNMPINDEX} (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP OS ESXi:hrStorageUsedBlocks[{#SNMPINDEX}].last(0)} / {Template SNMP OS ESXi:hrStorageSizeBlocks[{#SNMPINDEX}].last(0)} > 0.8</p><p>**Recovery expression**: </p>|warning|
|Available Memory is less than 10% on $1 (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP OS ESXi:hrMemoryUsed[{#SNMPINDEX}].last(0)} / {Template SNMP OS ESXi:hrMemoryTotal[{#SNMPINDEX}].last(0)} > 0.9</p><p>**Recovery expression**: </p>|high|
