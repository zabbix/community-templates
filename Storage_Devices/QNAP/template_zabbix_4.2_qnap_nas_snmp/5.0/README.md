...
|Temperature of {#SNMPVALUE} on {HOST.NAME} is over {$HD_TEMPERATURE_WARNING} for 2min|<p>-</p>|<p>**Expression**: {Template SNMP QNAP NAS:HdTemperatureEX[{#SNMPINDEX}].min(2m)}>40</p><p>**Recovery expression**: </p>|information|
