...
|Modelo|<p>-</p>|`SNMP agent`|enterprises.11369.10.1.1.0<p>Update: 30</p>|
...
|Capacidade do disco 1|<p>-</p>|`SNMP agent`|enterprises.11369.3.1<p>Update: 30</p>|
...
|Status do RAID|<p>-</p>|`SNMP agent`|enterprises.11369<p>Update: 30</p>|
...
|Capacidade do disco 4|<p>-</p>|`SNMP agent`|enterprises.11369.3.4<p>Update: 30</p>|
|Status do disco 4|<p>-</p>|`SNMP agent`|enterprises.11369.4.4<p>Update: 30</p>|
|Capacidade do disco 2|<p>-</p>|`SNMP agent`|enterprises.11369.3.2<p>Update: 30</p>|
...
|Status do disco 2|<p>-</p>|`SNMP agent`|enterprises.11369.4.2<p>Update: 30</p>|
|Upload interface lo|<p>-</p>|`SNMP agent`|ifOutOctets.1<p>Update: 30</p>|
|Tipo de RAID|<p>-</p>|`SNMP agent`|enterprises.11369.10.4.2.0<p>Update: 30</p>|
|Status do disco 3|<p>-</p>|`SNMP agent`|enterprises.11369.4.3<p>Update: 30</p>|
...
|Capacidade do disco 3|<p>-</p>|`SNMP agent`|enterprises.11369.3.3<p>Update: 30</p>|
...
|Status do disco 1|<p>-</p>|`SNMP agent`|enterprises.11369.4.1<p>Update: 30</p>|
