...
|----|-----------|----------|--------|
|nevisInstanceAdminStatus|<p>-</p>|<p>**Expression**: min(/Nevis/nevisinstanceAdminStatus[{#SNMPINDEX}],5s)=0</p><p>**Recovery expression**: </p>|average|
|nevisInstanceAuthStatus|<p>-</p>|<p>**Expression**: min(/Nevis/nevisinstanceAuthStatus[{#SNMPINDEX}],5s)=0</p><p>**Recovery expression**: </p>|average|
|nevisInstanceFailoverStatus|<p>-</p>|<p>**Expression**: min(/Nevis/nevisinstanceProxyFOStatus[{#SNMPINDEX}],5s)=0</p><p>**Recovery expression**: </p>|average|
|nevisInstanceProxyStatus|<p>-</p>|<p>**Expression**: min(/Nevis/nevisinstanceProxyStatus[{#SNMPINDEX}],5m)=0</p><p>**Recovery expression**: </p>|average|
|nevisInstanceAdminStatus (LLD)|<p>-</p>|<p>**Expression**: min(/Nevis/nevisinstanceAdminStatus[{#SNMPINDEX}],5s)=0</p><p>**Recovery expression**: </p>|average|
|nevisInstanceAuthStatus (LLD)|<p>-</p>|<p>**Expression**: min(/Nevis/nevisinstanceAuthStatus[{#SNMPINDEX}],5s)=0</p><p>**Recovery expression**: </p>|average|
|nevisInstanceFailoverStatus (LLD)|<p>-</p>|<p>**Expression**: min(/Nevis/nevisinstanceProxyFOStatus[{#SNMPINDEX}],5s)=0</p><p>**Recovery expression**: </p>|average|
|nevisInstanceProxyStatus (LLD)|<p>-</p>|<p>**Expression**: min(/Nevis/nevisinstanceProxyStatus[{#SNMPINDEX}],5m)=0</p><p>**Recovery expression**: </p>|average|
