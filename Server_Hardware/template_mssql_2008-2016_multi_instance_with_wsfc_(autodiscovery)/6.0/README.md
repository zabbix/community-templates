...
|----|-----------|----------|--------|
|Errors in {#INST} ERRORLOG|<p>-</p>|<p>**Expression**: sum(/App MSSQL 2008-2016 WSFC/log.count[{#ERRORLOG},Error|Failed,"UTF-16"],5m)>0</p><p>**Recovery expression**: </p>|warning|
|SQL Agent {#INST} Service state is not running|<p>-</p>|<p>**Expression**: last(/App MSSQL 2008-2016 WSFC/service_state[SQLAgent${#INST}])>0 and last(/App MSSQL 2008-2016 WSFC/service_state[SQLAgent${#INST}])<255</p><p>**Recovery expression**: </p>|high|
|SQL Server {#INST} Service state is not running|<p>-</p>|<p>**Expression**: last(/App MSSQL 2008-2016 WSFC/service_state[MSSQL${#INST}])>0 and last(/App MSSQL 2008-2016 WSFC/service_state[MSSQL${#INST}])<255</p><p>**Recovery expression**: </p>|high|
|SQL Agent {#INST} Service state is not running (LLD)|<p>-</p>|<p>**Expression**: last(/App MSSQL 2008-2016 WSFC/service_state[SQLAgent${#INST}])>0 and last(/App MSSQL 2008-2016 WSFC/service_state[SQLAgent${#INST}])<255</p><p>**Recovery expression**: </p>|high|
|SQL Server {#INST} Service state is not running (LLD)|<p>-</p>|<p>**Expression**: last(/App MSSQL 2008-2016 WSFC/service_state[MSSQL${#INST}])>0 and last(/App MSSQL 2008-2016 WSFC/service_state[MSSQL${#INST}])<255</p><p>**Recovery expression**: </p>|high|
|Errors in {#INST} ERRORLOG (LLD)|<p>-</p>|<p>**Expression**: sum(/App MSSQL 2008-2016 WSFC/log.count[{#ERRORLOG},Error|Failed,"UTF-16"],5m)>0</p><p>**Recovery expression**: </p>|warning|
