...
|----|-----------|----------|--------|
|cpu [{#SNMPVALUE}] status critical|<p>-</p>|<p>**Expression**: last(/Huawei Server iBMC/huawei-server[cpuStatus.{#SNMPVALUE}])=4</p><p>**Recovery expression**: </p>|disaster|
|cpu [{#SNMPVALUE}] status major|<p>-</p>|<p>**Expression**: last(/Huawei Server iBMC/huawei-server[cpuStatus.{#SNMPVALUE}])=3</p><p>**Recovery expression**: </p>|high|
|cpu [{#SNMPVALUE}] status minor|<p>-</p>|<p>**Expression**: last(/Huawei Server iBMC/huawei-server[cpuStatus.{#SNMPVALUE}])=2</p><p>**Recovery expression**: </p>|warning|
|fan  [{#SNMPVALUE}] status critical|<p>-</p>|<p>**Expression**: last(/Huawei Server iBMC/huawei-server[fanStatus.{#SNMPVALUE}])=4</p><p>**Recovery expression**: </p>|disaster|
|fan [{#SNMPVALUE}] status major|<p>-</p>|<p>**Expression**: last(/Huawei Server iBMC/huawei-server[fanStatus.{#SNMPVALUE}])=3</p><p>**Recovery expression**: </p>|high|
|fan  [{#SNMPVALUE}] status minor|<p>-</p>|<p>**Expression**: last(/Huawei Server iBMC/huawei-server[fanStatus.{#SNMPVALUE}])=2</p><p>**Recovery expression**: </p>|warning|
|hardDisk [{#SNMPVALUE}] status critical|<p>-</p>|<p>**Expression**: last(/Huawei Server iBMC/huawei-server[hardDiskFwState.{#SNMPVALUE}])=4</p><p>**Recovery expression**: </p>|disaster|
|hardDisk [{#SNMPVALUE}] status major|<p>-</p>|<p>**Expression**: last(/Huawei Server iBMC/huawei-server[hardDiskFwState.{#SNMPVALUE}])=3</p><p>**Recovery expression**: </p>|high|
|hardDisk [{#SNMPVALUE}] status minor|<p>-</p>|<p>**Expression**: last(/Huawei Server iBMC/huawei-server[hardDiskFwState.{#SNMPVALUE}])=2</p><p>**Recovery expression**: </p>|warning|
|memory [{#SNMPVALUE}] status critical|<p>-</p>|<p>**Expression**: last(/Huawei Server iBMC/huawei-server[memoryStatus.{#SNMPVALUE}])=4</p><p>**Recovery expression**: </p>|disaster|
|memory [{#SNMPVALUE}] status major|<p>-</p>|<p>**Expression**: last(/Huawei Server iBMC/huawei-server[memoryStatus.{#SNMPVALUE}])=3</p><p>**Recovery expression**: </p>|high|
|memory [{#SNMPVALUE}] status minor|<p>-</p>|<p>**Expression**: last(/Huawei Server iBMC/huawei-server[memoryStatus.{#SNMPVALUE}])=2</p><p>**Recovery expression**: </p>|warning|
|powerSupply [{#SNMPVALUE}] status critical|<p>-</p>|<p>**Expression**: last(/Huawei Server iBMC/huawei-server[powerSupplyStatus.{#SNMPVALUE}])=4</p><p>**Recovery expression**: </p>|disaster|
|powerSupply [{#SNMPVALUE}] status major|<p>-</p>|<p>**Expression**: last(/Huawei Server iBMC/huawei-server[powerSupplyStatus.{#SNMPVALUE}])=3</p><p>**Recovery expression**: </p>|high|
|powerSupply  [{#SNMPVALUE}] status minor|<p>-</p>|<p>**Expression**: last(/Huawei Server iBMC/huawei-server[powerSupplyStatus.{#SNMPVALUE}])=2</p><p>**Recovery expression**: </p>|warning|
|[{#DEVICENAME}] is too high|<p>-</p>|<p>**Expression**: last(/Huawei Server iBMC/huawei-server[temperatureReading.{#SNMPVALUE}])>=75</p><p>**Recovery expression**: </p>|high|
|cpu [{#SNMPVALUE}] status critical (LLD)|<p>-</p>|<p>**Expression**: last(/Huawei Server iBMC/huawei-server[cpuStatus.{#SNMPVALUE}])=4</p><p>**Recovery expression**: </p>|disaster|
|cpu [{#SNMPVALUE}] status major (LLD)|<p>-</p>|<p>**Expression**: last(/Huawei Server iBMC/huawei-server[cpuStatus.{#SNMPVALUE}])=3</p><p>**Recovery expression**: </p>|high|
|cpu [{#SNMPVALUE}] status minor (LLD)|<p>-</p>|<p>**Expression**: last(/Huawei Server iBMC/huawei-server[cpuStatus.{#SNMPVALUE}])=2</p><p>**Recovery expression**: </p>|warning|
|memory [{#SNMPVALUE}] status critical (LLD)|<p>-</p>|<p>**Expression**: last(/Huawei Server iBMC/huawei-server[memoryStatus.{#SNMPVALUE}])=4</p><p>**Recovery expression**: </p>|disaster|
|memory [{#SNMPVALUE}] status major (LLD)|<p>-</p>|<p>**Expression**: last(/Huawei Server iBMC/huawei-server[memoryStatus.{#SNMPVALUE}])=3</p><p>**Recovery expression**: </p>|high|
|memory [{#SNMPVALUE}] status minor (LLD)|<p>-</p>|<p>**Expression**: last(/Huawei Server iBMC/huawei-server[memoryStatus.{#SNMPVALUE}])=2</p><p>**Recovery expression**: </p>|warning|
|[{#DEVICENAME}] is too high (LLD)|<p>-</p>|<p>**Expression**: last(/Huawei Server iBMC/huawei-server[temperatureReading.{#SNMPVALUE}])>=75</p><p>**Recovery expression**: </p>|high|
|hardDisk [{#SNMPVALUE}] status critical (LLD)|<p>-</p>|<p>**Expression**: last(/Huawei Server iBMC/huawei-server[hardDiskFwState.{#SNMPVALUE}])=4</p><p>**Recovery expression**: </p>|disaster|
|hardDisk [{#SNMPVALUE}] status major (LLD)|<p>-</p>|<p>**Expression**: last(/Huawei Server iBMC/huawei-server[hardDiskFwState.{#SNMPVALUE}])=3</p><p>**Recovery expression**: </p>|high|
|hardDisk [{#SNMPVALUE}] status minor (LLD)|<p>-</p>|<p>**Expression**: last(/Huawei Server iBMC/huawei-server[hardDiskFwState.{#SNMPVALUE}])=2</p><p>**Recovery expression**: </p>|warning|
|fan  [{#SNMPVALUE}] status critical (LLD)|<p>-</p>|<p>**Expression**: last(/Huawei Server iBMC/huawei-server[fanStatus.{#SNMPVALUE}])=4</p><p>**Recovery expression**: </p>|disaster|
|fan [{#SNMPVALUE}] status major (LLD)|<p>-</p>|<p>**Expression**: last(/Huawei Server iBMC/huawei-server[fanStatus.{#SNMPVALUE}])=3</p><p>**Recovery expression**: </p>|high|
|fan  [{#SNMPVALUE}] status minor (LLD)|<p>-</p>|<p>**Expression**: last(/Huawei Server iBMC/huawei-server[fanStatus.{#SNMPVALUE}])=2</p><p>**Recovery expression**: </p>|warning|
|powerSupply [{#SNMPVALUE}] status critical (LLD)|<p>-</p>|<p>**Expression**: last(/Huawei Server iBMC/huawei-server[powerSupplyStatus.{#SNMPVALUE}])=4</p><p>**Recovery expression**: </p>|disaster|
|powerSupply [{#SNMPVALUE}] status major (LLD)|<p>-</p>|<p>**Expression**: last(/Huawei Server iBMC/huawei-server[powerSupplyStatus.{#SNMPVALUE}])=3</p><p>**Recovery expression**: </p>|high|
|powerSupply  [{#SNMPVALUE}] status minor (LLD)|<p>-</p>|<p>**Expression**: last(/Huawei Server iBMC/huawei-server[powerSupplyStatus.{#SNMPVALUE}])=2</p><p>**Recovery expression**: </p>|warning|
