...
|----|-----------|----------|--------|
|Server {HOSTNAME} Problem with FAN {#FAN}|<p>-</p>|<p>**Expression**: last(/Dell iDrac SNMPV2/FanStatus.[{#SNMPINDEX}])<>3</p><p>**Recovery expression**: </p>|average|
|Server {HOST.NAME} Problem with memory in slot {#MEM}|<p>-</p>|<p>**Expression**: last(/Dell iDrac SNMPV2/MemStatus.[{#SNMPINDEX}])<>3</p><p>**Recovery expression**: </p>|high|
|Server {#HOSTNAME} Connection Status has changed on NIC {#NETIF}|<p>-</p>|<p>**Expression**: (last(/Dell iDrac SNMPV2/NetConnStatus.[{#SNMPINDEX}],#1)<>last(/Dell iDrac SNMPV2/NetConnStatus.[{#SNMPINDEX}],#2))=1</p><p>**Recovery expression**: </p>|warning|
|Server {HOST.NAME} Error on NIC {#NETIF}|<p>-</p>|<p>**Expression**: last(/Dell iDrac SNMPV2/NetStatus.[{#SNMPINDEX}])<>3</p><p>**Recovery expression**: </p>|high|
|Server {HOST.NAME} Error on PSU {#POWER}|<p>-</p>|<p>**Expression**: last(/Dell iDrac SNMPV2/PowerSupplySensorState.[{#SNMPINDEX}])<>1</p><p>**Recovery expression**: </p>|high|
|Server {HOST.NAME} Error on Processor {#SNMPINDEX}|<p>-</p>|<p>**Expression**: (last(/Dell iDrac SNMPV2/ProcStatus.[{#SNMPINDEX}])<>3 and last(/Dell iDrac SNMPV2/ProcStatus.[{#SNMPINDEX}])<>2) or (last(/Dell iDrac SNMPV2/ProcStatus.[{#SNMPINDEX}])<>2 and last(/Dell iDrac SNMPV2/ProcStatus.[{#SNMPINDEX}])=2)</p><p>**Recovery expression**: </p>|high|
|Server {HOST.NAME} Problem with Temperature Sensor {#TEMP}|<p>-</p>|<p>**Expression**: last(/Dell iDrac SNMPV2/TempStatus.[{#SNMPINDEX}])<>3</p><p>**Recovery expression**: </p>|high|
|Server {HOST.NAME} Error on Voltage Sensor {#VOLTAGE}|<p>-</p>|<p>**Expression**: last(/Dell iDrac SNMPV2/VoltageStatus.[{#SNMPINDEX}])<>3</p><p>**Recovery expression**: </p>|average|
|Server {HOST.NAME} Volume {#VOLNAME} Error|<p>-</p>|<p>**Expression**: last(/Dell iDrac SNMPV2/VolumeDiskState.[{#SNMPINDEX}])<>2</p><p>**Recovery expression**: </p>|high|
|Server {HOST.NAME} Error on PSU {#POWER} (LLD)|<p>-</p>|<p>**Expression**: last(/Dell iDrac SNMPV2/PowerSupplySensorState.[{#SNMPINDEX}])<>1</p><p>**Recovery expression**: </p>|high|
|Server {HOSTNAME} Problem with FAN {#FAN} (LLD)|<p>-</p>|<p>**Expression**: last(/Dell iDrac SNMPV2/FanStatus.[{#SNMPINDEX}])<>3</p><p>**Recovery expression**: </p>|average|
|Server {HOST.NAME} Problem with memory in slot {#MEM} (LLD)|<p>-</p>|<p>**Expression**: last(/Dell iDrac SNMPV2/MemStatus.[{#SNMPINDEX}])<>3</p><p>**Recovery expression**: </p>|high|
|Server {HOST.NAME} Volume {#VOLNAME} Error (LLD)|<p>-</p>|<p>**Expression**: last(/Dell iDrac SNMPV2/VolumeDiskState.[{#SNMPINDEX}])<>2</p><p>**Recovery expression**: </p>|high|
|Server {HOST.NAME} Error on Voltage Sensor {#VOLTAGE} (LLD)|<p>-</p>|<p>**Expression**: last(/Dell iDrac SNMPV2/VoltageStatus.[{#SNMPINDEX}])<>3</p><p>**Recovery expression**: </p>|average|
|Server {HOST.NAME} Problem with Temperature Sensor {#TEMP} (LLD)|<p>-</p>|<p>**Expression**: last(/Dell iDrac SNMPV2/TempStatus.[{#SNMPINDEX}])<>3</p><p>**Recovery expression**: </p>|high|
|Server {HOST.NAME} Error on Processor {#SNMPINDEX} (LLD)|<p>-</p>|<p>**Expression**: (last(/Dell iDrac SNMPV2/ProcStatus.[{#SNMPINDEX}])<>3 and last(/Dell iDrac SNMPV2/ProcStatus.[{#SNMPINDEX}])<>2) or (last(/Dell iDrac SNMPV2/ProcStatus.[{#SNMPINDEX}])<>2 and last(/Dell iDrac SNMPV2/ProcStatus.[{#SNMPINDEX}])=2)</p><p>**Recovery expression**: </p>|high|
|Server {#HOSTNAME} Connection Status has changed on NIC {#NETIF} (LLD)|<p>-</p>|<p>**Expression**: (last(/Dell iDrac SNMPV2/NetConnStatus.[{#SNMPINDEX}],#1)<>last(/Dell iDrac SNMPV2/NetConnStatus.[{#SNMPINDEX}],#2))=1</p><p>**Recovery expression**: </p>|warning|
|Server {HOST.NAME} Error on NIC {#NETIF} (LLD)|<p>-</p>|<p>**Expression**: last(/Dell iDrac SNMPV2/NetStatus.[{#SNMPINDEX}])<>3</p><p>**Recovery expression**: </p>|high|
