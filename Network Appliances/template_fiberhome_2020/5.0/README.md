...
|----|-----------|----------|--------|
|Slot #SNMPINDEX CPU is HIGH|<p>-</p>|<p>**Expression**: {SNMP OLT FiberHome:cardCpuUtil.["{#SNMPINDEX}"].last()}>80</p><p>**Recovery expression**: {SNMP OLT FiberHome:cardCpuUtil.["{#SNMPINDEX}"].last()}<80</p>|high|
|Slot  #SNMPINDEX is Down|<p>-</p>|<p>**Expression**: {SNMP OLT FiberHome:cardStatus.["{#SNMPINDEX}"].last()}=0</p><p>**Recovery expression**: </p>|disaster|
|Slot #SNMPINDEX MEM is HIGH|<p>-</p>|<p>**Expression**: {SNMP OLT FiberHome:cardMemUtil.["{#SNMPINDEX}"].last()}>80</p><p>**Recovery expression**: {SNMP OLT FiberHome:cardMemUtil.["{#SNMPINDEX}"].last()}<80</p>|high|
|ONU Sinal is low ({ITEM.LASTVALUE}) on {#SNMPVALUE}|<p>-</p>|<p>**Expression**: {SNMP OLT FiberHome:onuPonRXOpticalPower.["{#SNMPINDEX}"].avg(10m)}<=-25</p><p>**Recovery expression**: {SNMP OLT FiberHome:onuPonRXOpticalPower.["{#SNMPINDEX}"].avg(10m)}>-25</p>|warning|
|ONU Sinal is low ({ITEM.LASTVALUE}) on {#SNMPVALUE} (LLD)|<p>-</p>|<p>**Expression**: {SNMP OLT FiberHome:onuPonRXOpticalPower.["{#SNMPINDEX}"].avg(10m)}<=-25</p><p>**Recovery expression**: {SNMP OLT FiberHome:onuPonRXOpticalPower.["{#SNMPINDEX}"].avg(10m)}>-25</p>|warning|
|Slot #SNMPINDEX CPU is HIGH (LLD)|<p>-</p>|<p>**Expression**: {SNMP OLT FiberHome:cardCpuUtil.["{#SNMPINDEX}"].last()}>80</p><p>**Recovery expression**: {SNMP OLT FiberHome:cardCpuUtil.["{#SNMPINDEX}"].last()}<80</p>|high|
|Slot  #SNMPINDEX is Down (LLD)|<p>-</p>|<p>**Expression**: {SNMP OLT FiberHome:cardStatus.["{#SNMPINDEX}"].last()}=0</p><p>**Recovery expression**: </p>|disaster|
|Slot #SNMPINDEX MEM is HIGH (LLD)|<p>-</p>|<p>**Expression**: {SNMP OLT FiberHome:cardMemUtil.["{#SNMPINDEX}"].last()}>80</p><p>**Recovery expression**: {SNMP OLT FiberHome:cardMemUtil.["{#SNMPINDEX}"].last()}<80</p>|high|
