...
|----|-----------|----------|--------|
|Firewall processor usage {HOST.NAME} it's too high!|<p>-</p>|<p>**Expression**: {SNMP_FIREWALL_KERIO_CONTROL_LLD_VERSAO-1.0:fgHaStatsCpuUsage.[{#SNMPVALUE}].last()}>50</p><p>**Recovery expression**: </p>|high|
|Firewall memory usage {HOST.NAME} it's too high!|<p>-</p>|<p>**Expression**: {SNMP_FIREWALL_KERIO_CONTROL_LLD_VERSAO-1.0:fgHaStatsMemUsage.[{#SNMPVALUE}].last()}>1000</p><p>**Recovery expression**: </p>|high|
|The Network Interface {#SNMPVALUE} It is out!|<p>-</p>|<p>**Expression**: {SNMP_FIREWALL_KERIO_CONTROL_LLD_VERSAO-1.0:ifAdminStatus.[{#SNMPVALUE}].last()}<>1</p><p>**Recovery expression**: </p>|disaster|
|Firewall processor usage {HOST.NAME} it's too high! (LLD)|<p>-</p>|<p>**Expression**: {SNMP_FIREWALL_KERIO_CONTROL_LLD_VERSAO-1.0:fgHaStatsCpuUsage.[{#SNMPVALUE}].last()}>50</p><p>**Recovery expression**: </p>|high|
|The Network Interface {#SNMPVALUE} It is out! (LLD)|<p>-</p>|<p>**Expression**: {SNMP_FIREWALL_KERIO_CONTROL_LLD_VERSAO-1.0:ifAdminStatus.[{#SNMPVALUE}].last()}<>1</p><p>**Recovery expression**: </p>|disaster|
|Firewall memory usage {HOST.NAME} it's too high! (LLD)|<p>-</p>|<p>**Expression**: {SNMP_FIREWALL_KERIO_CONTROL_LLD_VERSAO-1.0:fgHaStatsMemUsage.[{#SNMPVALUE}].last()}>1000</p><p>**Recovery expression**: </p>|high|
