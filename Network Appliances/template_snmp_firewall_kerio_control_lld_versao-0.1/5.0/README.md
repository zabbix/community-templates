...
|----|-----------|----------|--------|
|O uso processador do firewall {HOST.NAME} esta muito alta!|<p>-</p>|<p>**Expression**: {SNMP_FIREWALL_KERIO_CONTROL_LLD_VERSAO-1.0:fgHaStatsCpuUsage.[{#SNMPVALUE}].last()}>50</p><p>**Recovery expression**: </p>|high|
|O uso memoria do firewall {HOST.NAME} esta muito alta!|<p>-</p>|<p>**Expression**: {SNMP_FIREWALL_KERIO_CONTROL_LLD_VERSAO-1.0:fgHaStatsMemUsage.[{#SNMPVALUE}].last()}>1000</p><p>**Recovery expression**: </p>|high|
|A Interface de rede {#SNMPVALUE} esta Fora!|<p>-</p>|<p>**Expression**: {SNMP_FIREWALL_KERIO_CONTROL_LLD_VERSAO-1.0:ifAdminStatus.[{#SNMPVALUE}].last()}<>1</p><p>**Recovery expression**: </p>|disaster|
|O uso processador do firewall {HOST.NAME} esta muito alta! (LLD)|<p>-</p>|<p>**Expression**: {SNMP_FIREWALL_KERIO_CONTROL_LLD_VERSAO-1.0:fgHaStatsCpuUsage.[{#SNMPVALUE}].last()}>50</p><p>**Recovery expression**: </p>|high|
|O uso memoria do firewall {HOST.NAME} esta muito alta! (LLD)|<p>-</p>|<p>**Expression**: {SNMP_FIREWALL_KERIO_CONTROL_LLD_VERSAO-1.0:fgHaStatsMemUsage.[{#SNMPVALUE}].last()}>1000</p><p>**Recovery expression**: </p>|high|
|A Interface de rede {#SNMPVALUE} esta Fora! (LLD)|<p>-</p>|<p>**Expression**: {SNMP_FIREWALL_KERIO_CONTROL_LLD_VERSAO-1.0:ifAdminStatus.[{#SNMPVALUE}].last()}<>1</p><p>**Recovery expression**: </p>|disaster|
